		...
		<div class='divEditArea'>
			...
			<div class='trField cb' runat='server'  id='trCodigo' visible='<%$Settings: visible, Condicao.Codigo, true %>' >
				...
				<div class='tdField fl'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqCodigo' Enabled='<%$Settings: Required, Condicao.Codigo, false %>' Display='None' ErrorMessage='C&oacute;digo &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtCodigo' />
				</div>
			</div>
			<div class='trField cb' runat='server'  id='trCondicao' visible='<%$Settings: visible, Condicao.Condicao, true %>' >
				...
				<div class='tdField fl'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqCondicao' Enabled='<%$Settings: Required, Condicao.Condicao, false %>' Display='None' ErrorMessage='Condi&ccedil&atilde;o &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtCondicao' />
				</div>
			</div>
