<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Motivos.aspx.vb" Inherits="Pages.Cadastros.Motivos" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDMotivo" DataNavigateUrlFormatString="Motivo.aspx?IDMotivo={0}" DataTextField="Codigo" HeaderText="C&oacute;digo" SortExpression="Codigo"  />
