...
Namespace Pages.Cadastros
    ...
    Partial Public Class Permissoes
        Inherits XMWebPage
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                RecuperaFiltro(txtFiltro, Paginate1, Letras1)
                BindGrid()
            End If
        End Sub

        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(ViewState("Filtro"), Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
            ...
            GravaFiltro(txtFiltro, Paginate1, Letras1)
        End Sub
