	    ...
	    <ContentTemplate>
			<div class='Filtro'>
		        ...
		        <div class='FiltroItem'>Vendedor<br>
		            <asp:DropDownList runat="server" ID="cboIDVendedor" DataTextField="Vendedor" 
                        DataValueField="IDVendedor" Height="17px" Width="89px" />
		        </div>
                <div class='FiltroItem'>Linha de Negocios<br>
		           <asp:DropDownList ID='cboLinhaNegocio' runat="server" 
                        DataTextField="LinhaNegocio" DataValueField="IdLinhaNegocio" Height="16px" 
                        Width="94px"/>
		        </div>
