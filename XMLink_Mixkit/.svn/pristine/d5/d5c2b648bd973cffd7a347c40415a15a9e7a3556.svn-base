    ...
    Partial Public Class Clientes
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                cboLinhaNegocio.Items.Insert(0, New ListItem("TODOS...", 0))
                lng = Nothing

                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, cboIDVendedor)
                BindGrid()
            End If			
        End Sub
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDVendedor.SelectedValue, cboLinhaNegocio.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, cboIDVendedor)
		End Sub
