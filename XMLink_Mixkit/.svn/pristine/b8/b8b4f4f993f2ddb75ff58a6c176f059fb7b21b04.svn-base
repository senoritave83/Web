<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Justificativas.aspx.vb" Inherits="Pages.Cadastros.Justificativas" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDJustificativa" DataNavigateUrlFormatString="Justificativa.aspx?IDJustificativa={0}" DataTextField="Codigo" HeaderText="C&oacute;digo" SortExpression="Codigo"  />
						<asp:BoundField HeaderText="Justificativa" DataField="Justificativa" SortExpression="Justificativa" />
					</columns>
					<EmptyDataTemplate>
				        <div class='GridHeader'>&nbsp;</div>					    
					    <div class='divEmptyRow'>
							<asp:Label runat='server' ID='lblNaoEncontrados'>
								N&atilde;o h&aacute; Justificativas com o filtro selecionado!
							</asp:Label>
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
