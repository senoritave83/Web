...
#Region "Metodos"
        ...
        Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            m_decSubTotal = dr.GetValue(dr.GetOrdinal("SubTotal"))
            m_decTotal = dr.GetValue(dr.GetOrdinal("Total"))
            m_blnIsNew = False
        End Sub
