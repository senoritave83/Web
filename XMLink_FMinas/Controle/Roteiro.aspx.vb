...
Namespace Pages.Roteiros
    ...
    Partial Public Class Roteiro
        ...
        Protected Sub ProcurarClientes()
            ...
            Dim ret As PaginateResult = loj.Listar(txtProcurarLoja.Text, "", Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
