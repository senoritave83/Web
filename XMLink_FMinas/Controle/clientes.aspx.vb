...
Partial Class Roteiros_clientes
    ...
    Public Sub BindGrid()
        Dim ret As IPaginaResult = cls.Listar(ViewState("Filtro"), 0, cboUF.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
