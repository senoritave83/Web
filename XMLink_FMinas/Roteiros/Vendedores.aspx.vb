    ...
    Partial Public Class Vendedores
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                cboIDGrupo.DataSource = grp.Listar()
                cboIDGrupo.DataBind()
                cboIDGrupo.Items.Insert(0, New ListItem("TODOS", "0"))
                grp = Nothing

                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, cboIDGrupo)
                BindGrid()
            End If			
        End Sub

        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(ViewState("Filtro"), cboIDGrupo.SelectedValue, SortExpression, SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, cboIDGrupo)
		End Sub
