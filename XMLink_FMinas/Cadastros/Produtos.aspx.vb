...
Namespace Pages.Cadastros
    ...
    Partial Public Class Produtos
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDCategoria.SelectedValue, rbProdAtivos.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
