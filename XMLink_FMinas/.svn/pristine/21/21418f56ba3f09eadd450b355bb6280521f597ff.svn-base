		...
		<div class='divEditArea'>
			...
			<div class='trField cb' runat='server'  id='trCodigo' visible='<%$Settings: visible, FormaPagamento.Codigo, true %>' >
				...
				<div class='tdField fl'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqCodigo' Enabled='<%$Settings: Required, FormaPagamento.Codigo, true %>' Display='None' ErrorMessage='C&oacute;digo &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtCodigo' />
				</div>
			</div>
			<div class='trField cb' runat='server'  id='trFormaPagamento' visible='<%$Settings: visible, FormaPagamento.FormaPagamento, true %>' >
				...
				<div class='tdField fl'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqFormaPagamento' Enabled='<%$Settings: Required, FormaPagamento.FormaPagamento, true %>' Display='None' ErrorMessage='FormaPagamento &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtFormaPagamento' />
				</div>
			</div>
			<div class='trField cb' runat='server'  id='trCorrecao' visible='<%$Settings: visible, FormaPagamento.Correcao, true %>' >
				...
				<div class='tdField fl'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqCorrecao' Enabled='<%$Settings: Required, FormaPagamento.Correcao, false %>' Display='None' ErrorMessage='Corre&ccedil&atilde;o &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtCorrecao' />
				</div>
			</div>
