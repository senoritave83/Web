    ...
    Partial Public Class Roteiro
        ...
        Protected Sub btnGravar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGravar.Click
            ...
            If cls.isValid Then
                cls.Update()
                Inflate()
                MostraGravado("~/roteiros/Roteiro.aspx?idroteiro=" & cls.IDRoteiro & "&idvendedor=" & cls.IDVendedor)
            End If
        ...
        Protected Sub ProcurarClientes()
            ...
            Dim ret As PaginateResult = loj.Listar(txtProcurarLoja.Text, "", 0, "", False, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
