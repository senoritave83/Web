	...
	<asp:UpdatePanel ID="updFiltro" runat="server">
	    <ContentTemplate>
			<div class='Filtro'>
                ...
                <div class='FiltroItem'>
                    <asp:RadioButtonList runat="server" ID="rbProdAtivos" Font-Bold="true">
                        <asp:ListItem Text="Todos" Value="2" />
                        <asp:ListItem Text="Ativos" Value="1" Selected="True" />
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDProduto" DataNavigateUrlFormatString="Produto.aspx?IDProduto={0}" DataTextField="Codigo" HeaderText="C&oacute;digo" SortExpression="Codigo"  />
