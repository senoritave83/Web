...
Namespace Classes
    ...
    #Region "Metodos"
		...
		Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            m_strFilial = dr.GetString(dr.GetOrdinal("CodigoFilial"))
		...
		Public Sub Update()
            ...
            cmd.Parameters.Add("@FILIAL", SqlDbType.VarChar, 20).Value = m_strFilial
        ...
        Public Function Listafilial(Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object

            Dim cmd As New SqlCommand()
            cmd.CommandText = PREFIXO & "LS_FILIAL"
            cmd.CommandType = CommandType.StoredProcedure
            Return ExecuteCommand(cmd, vReturnType)
        ...
        Public Function Listar(ByVal vFilter As String, ByVal vUF As String, ByVal vOrder As String, ByVal vDescending As Boolean, ByVal vPage As Integer, ByVal vPageSize As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As PaginateResult
