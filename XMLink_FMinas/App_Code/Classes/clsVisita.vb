...
Namespace Classes
	...
	#Region "Properties" 
        ...
        Public Overridable ReadOnly Property CodigoCliente() As Integer
            Get
    ...
    #Region "Metodos"
        ...
        Public Function Listar(ByVal vCliente As String, ByVal vVendedor As String, ByVal vDataInicial As String, ByVal vDataFinal As String, ByVal vIDJustificativa As Integer, ByVal vUF As String, ByVal vOrder As String, ByVal vDescending As Boolean, ByVal vPage As Integer, ByVal vPageSize As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As PaginateResult
