...
Namespace Pages.Cadastros
    ...
    Partial Public Class CatalogoProduto
        ...
        Protected Const SECAO As String = "Cadastro de Catálogo de Produtos"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                If clsProd.Load(ViewState(VW_IDPRODUTO)) Then
                    lblProduto.Text = clsProd.Descricao
        ...
        Protected Sub Checked_Change(ByVal source As Object, ByVal e As EventArgs)
            ...
            Dim idfoto As String = (rptFotos.DataKeys(di.ItemIndex).ToString())
        ...
        Protected Sub rptFotos_ItemCommand1(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs) Handles rptFotos.ItemCommand
            ...
            If e.CommandName = "Apagar" Then
                ...
                Dim vIdProdutoFoto As String = vArgs(1)
        ...
        Protected Sub btnProcurar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcurar.Click
            cls.DescricaoProduto = txtProcurarProduto.Text
