...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class='EditArea'>
		<table id='tblEditArea'>
			...
			<tr class='trField'>
				<td class='tdFieldHeader' style="vertical-align:top;">
				    Grupos
				</td>
				<td class='tdField'>
			        <asp:CheckBoxList runat='server' ID='chkGrupos' DataTextField='Grupo' DataValueField='IDGrupo' />
			    </td>
				<td class='tdFieldHeader' colspan='2' style="width:200px;vertical-align:top;">
