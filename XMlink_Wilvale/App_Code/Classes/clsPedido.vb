...
Namespace Classes
	...
	#Region "Declarations" 
        ...
        Protected m_intTotalItens As Integer
	...
	#Region "Properties" 
        ...
        Public ReadOnly Property TotalItens() As Integer
            Get
                Return m_intTotalItens
            End Get
        End Property
        ...
        Public ReadOnly Property Desconto() As Single
            Get
                If m_decSubTotal <> 0 Then
                    Return (m_decSubTotal - m_decTotal) / m_decSubTotal
                Else
                    Return 0
                End If
            End Get
        ...
        Public ReadOnly Property IDStatusPedido() As Byte
            Get
    ...
    #Region "Metodos"
		...
		Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            m_intTotalItens = dr.GetInt32(dr.GetOrdinal("TotalItens"))
            m_blnIsNew = False
        End Sub
