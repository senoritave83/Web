...
#Region "Declarations"
        Protected m_intIDProdutoFoto As String
...
#Region "Properties"
        Public Overridable ReadOnly Property IDProdutoFoto As String
            Get
...
#Region "Metodos"
        ...
        Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            m_intIDProdutoFoto = dr.GetString(dr.GetOrdinal("IDProdutoFoto"))
        ...
        Public Sub Update()
            ...
            cmd.Parameters.Add("@IDPRODUTOFOTO", SqlDbType.VarChar, 40).Value = m_intIDProdutoFoto
        ...
        Public Function Load(ByVal vIDProduto As Integer, Optional ByVal vIDProdutoFoto As String = "") As Boolean
            ...
            cmd.Parameters.Add("@IDPRODUTOFOTO", SqlDbType.VarChar, 40).Value = vIDProdutoFoto
        ...
        ''' </summary>
        Public Sub Delete(ByVal vIDProdutoFoto As String, ByVal vIDProduto As Integer)
        ...
        Public Function NovaFoto(ByVal vIDProduto As Integer, ByVal vExtension As String) As Object
            ...
            'cmd.Parameters.Add("@COMENTARIO", SqlDbType.VarChar, 10).Value = vExtension
