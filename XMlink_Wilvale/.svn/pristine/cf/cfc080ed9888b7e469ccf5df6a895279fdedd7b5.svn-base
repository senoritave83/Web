...
Namespace Classes
	...
	#Region "Declarations" 
        ...
        Protected m_dblTabelaPreco As Double
...
#Region "Properties"
        ...
        Public Overridable Property TabelaPreco() As Double
            Get
                Return m_dblTabelaPreco
            End Get
            Set(ByVal Value As Double)
                m_dblTabelaPreco = Value
            End Set
        End Property
...
#Region "Metodos"
        ...
        Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            If dr.IsDBNull(dr.GetOrdinal("TabelaPreco")) Then
                m_dblTabelaPreco = 0
            Else
                m_dblTabelaPreco = dr.GetDouble(dr.GetOrdinal("TabelaPreco"))
            End If
        ...
        Public Sub Update()
            ...
            cmd.Parameters.Add("@TABELAPRECO", SqlDbType.Real).Value = m_dblTabelaPreco
        ...
        Public Function Listar(ByVal vFilter As String, ByVal vAtivo As Byte, ByVal vUF As String, ByVal vOrder As String, ByVal vDescending As Boolean, ByVal vPage As Integer, ByVal vPageSize As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As PaginateResult
