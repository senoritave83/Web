...
Namespace Pages.Pedidos
    ...
    Partial Public Class Pedidos
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(txtFiltro.Text, txtVendedor.Text, txtCliente.Text, txtDataEmissaoInicial.Text, txtDataEmissaoFinal.Text, cboIDStatus.SelectedValue, SortExpression, SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
