		...
		<table id='tblEditArea'>
			...
			<tr class='trField'>
				...
				<td class='tdField'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqCNPJ' Display='None' ErrorMessage='CNPJ &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtCNPJ' />
				</td>
			</tr>
			<tr class='trField'>
				<td class='tdFieldHeader'>
				...
				<td class='tdField' colspan='3'>
					<asp:TextBox runat='server' ID='txtCliente' MaxLength='100' Width='100%' />
			...
			<tr class='trField'>
				...
				<td class='tdField'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqDescontoMax' Display='None' ErrorMessage='Desconto m&aacute;ximo &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtDescontoMax' />
