...
#End Region
        ...
        Public Function ExportarPedido(ByVal vFiltro As String) As IDataReader
        ...
        Public Function ProcessarArquivo(ByVal vArquivo As String, ByVal vPath As String) As Boolean
            ...
            Dim dts As New XMSistemas.Data.Import.XMDataImport(GetConnectionString(), Me.User.IDEmpresa, vPath, vPath & "dts.log")
            Dim p_Result As Boolean = False

            Dim dr As IDataReader = GetDadosArquivo(vArquivo)
            Dim intIDTipo As Integer
