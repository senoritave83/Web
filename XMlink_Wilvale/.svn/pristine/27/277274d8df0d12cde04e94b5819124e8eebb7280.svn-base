...
Namespace Pages.Cadastros
    ...
    Partial Public Class SituacaoPedidos
        Inherits XMWebPage
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, drpIdStatus.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
