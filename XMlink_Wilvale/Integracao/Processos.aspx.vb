    ...
    Partial Public Class Processos
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                '***************************************************************
                If Not VerificaPermissao(Secao, "Importação de Arquivos") Then
                ...
                Do While dr.Read
                    If VerificaPermissao(Secao, "Importação de Arquivos - " & dr.GetString(dr.GetOrdinal("Tipo"))) Then
                ...
                btnEnviar.Enabled = VerificaPermissao(Secao, "Enviar Arquivo")
                GridView1.Columns.Item(5).Visible = VerificaPermissao(Secao, "Processar Arquivo")
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
            If e.CommandName = "Processar" Then
                ...
                Try
                    cls.ProcessarArquivo(strArquivo, Server.MapPath(GetPath()))
            ...
            If txtArquivo.PostedFile.FileName.EndsWith(".zip") = True Then
                ...
                If zip.EntryFilenames.Count = 1 Then
                    For Each f As ZipEntry In zip
                        Dim s As New IO.FileStream(GetPath() & "asdasd.txt", IO.FileMode.Create)
                        f.Extract(s)
                        s.Close()
                    Next
                Else
                    zip.Save(Server.MapPath(GetPath()) & strNome & ".zip")
                    strMessage = "Não pode ser enviado mais de um arquivo no mesmo arquivo compactado (zip)!"
                    lstErros.Items.Add(strMessage)
                End If
                zip.Dispose()
            Else
                txtArquivo.PostedFile.SaveAs(Server.MapPath(GetPath()) & strNome)
            End If
