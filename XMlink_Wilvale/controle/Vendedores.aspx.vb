...
Namespace Pages.Roteiros
    ...
    Partial Public Class Vendedores
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(ViewState("Filtro"), rbStatusVend.SelectedValue, SortExpression, SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
