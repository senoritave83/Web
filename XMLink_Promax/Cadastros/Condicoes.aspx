		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDCondicao" DataNavigateUrlFormatString="Condicao.aspx?IDCondicao={0}" DataTextField="Codigo" HeaderText="C&oacute;digo" SortExpression="Codigo"  />
						<asp:BoundField HeaderText="Condi&ccedil;&atilde;o" DataField="Condicao" SortExpression="Condicao" />
						<asp:BoundField HeaderText="Criado" DataField="Criado" SortExpression="Criado" DataFormatString='{0:d}' />
					</columns>
					<EmptyDataTemplate>
