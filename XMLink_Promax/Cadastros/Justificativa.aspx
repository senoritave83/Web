		...
		<div class='divEditArea'>
			...
			<div class='trField cb' runat='server'  id='trCodigo' visible='<%$Settings: visible, Justificativa.Codigo, true %>' >
				...
				<div class='tdField fl'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqCodigo' Enabled='<%$Settings: Required, Justificativa.Codigo, false %>' Display='None' ErrorMessage='C&oacute;digo &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtCodigo' />
				</div>
			</div>
			<div class='trField cb' runat='server'  id='trJustificativa' visible='<%$Settings: visible, Justificativa.Justificativa, true %>' >
				...
				<div class='tdField fl'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqJustificativa' Enabled='<%$Settings: Required, Justificativa.Justificativa, false %>' Display='None' ErrorMessage='Justificativa &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtJustificativa' />
				</div>
			</div>
