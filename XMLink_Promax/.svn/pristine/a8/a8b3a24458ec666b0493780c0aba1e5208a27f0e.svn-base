...
Namespace Classes
	...
	#Region "Declarations" 
        ...
        Protected m_strCodigoCliente As String
        ...
        Protected m_intIDTransportadora As Integer
        Protected m_intIDInsumo As Byte
        Protected m_strEnderecoCobranca As String
        Protected m_strEnderecoFaturamento As String
        Protected m_strEnderecoEntrega As String
	...
	#Region "Properties" 
        ...
        Public ReadOnly Property IDInsumo() As Integer
            Get
                Return m_intIDInsumo
            End Get
        End Property
        ...
        Public ReadOnly Property IDTransporte() As Integer
            Get
                Return m_intIDTransportadora
            End Get
        End Property

        Public ReadOnly Property EnderecoEntrega() As String
            Get
                Return m_strEnderecoEntrega
            End Get
        End Property

        Public ReadOnly Property EnderecoCobranca() As String
            Get
                Return m_strEnderecoCobranca
            End Get
        End Property

        Public ReadOnly Property EnderecoFaturamento() As String
            Get
                Return m_strEnderecoFaturamento
            End Get
        End Property
    ...
    #Region "Metodos"
		...
		Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            If dr.IsDBNull(dr.GetOrdinal("EnderecoEntrega")) Then
                m_strEnderecoEntrega = ""
            Else
                m_strEnderecoEntrega = dr.GetString(dr.GetOrdinal("EnderecoEntrega"))
            End If
            If dr.IsDBNull(dr.GetOrdinal("EnderecoCobranca")) Then
                m_strEnderecoCobranca = ""
            Else
                m_strEnderecoCobranca = dr.GetString(dr.GetOrdinal("EnderecoCobranca"))
            End If
            If dr.IsDBNull(dr.GetOrdinal("EnderecoFaturamento")) Then
                m_strEnderecoFaturamento = ""
            Else
                m_strEnderecoFaturamento = dr.GetString(dr.GetOrdinal("EnderecoFaturamento"))
            End If
