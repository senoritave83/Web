...
Namespace Pages.Cadastros
    ...
    Partial Public Class Coordenadores
        Inherits XMWebPage
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, cboIDStatus)
                BindGrid()
            End If			
        End Sub

        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE, cboIDStatus.SelectedValue)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, cboIDStatus)
		End Sub
