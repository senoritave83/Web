...
Namespace Pages.Cadastros
    ...
    Partial Public Class Propriedades
        Inherits XMWebPage
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, drpIdStatus)
                BindGrid()
        ...
        Public Sub BindGrid()
            ...
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, vIdStatus, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, drpIdStatus)
        End Sub
