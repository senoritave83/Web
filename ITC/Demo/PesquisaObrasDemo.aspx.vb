Public Class PesquisaObrasDemo
...
#End Region
    ...
    Private Sub btnGravarLink_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGravarLink.Click
        ...
        Dim strBody As String = p_Host & "relatorioobras.aspx?gd=" & Server.UrlEncode(p_Guid)

        Dim strScript As String = "<scr" & "ipt lang" & "uage='java" & "script'>" & vbCrLf
        strScript &= "document.location.href = 'mail" & "to:?subject=ITC.Net - Relatório de Obras&body=" & strBody & "';" & vbCrLf
