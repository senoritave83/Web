<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Noticias.aspx.vb"  ValidateRequest="False" Inherits="ITC.Noticias"%>
			...
			<table id="Table1" borderColor="#809eb7" cellpadding=0 cellSpacing="0" width="100%" border="1">
				<tr>
					...
					<td vAlign="top" align="middle">
						<img src="Imagens/TituloNoticias.jpg" border="0"><br>
						<asp:DataGrid CssClass="f10" id="dtgNoticias" runat="server" BorderColor="#999999" BorderStyle="None" BackColor="White" CellPadding="3" GridLines="none" AutoGenerateColumns="False" width="96%">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Descrição">
									<ItemTemplate>
										<a href="noticiasdet.aspx?idnoticia=<%# DataBinder.Eval(Container.DataItem, "IdNoticia")%>"><asp:Label ID="Label1" Runat=server ><%# DataBinder.Eval(Container.DataItem, "Titulo")%></asp:Label> </a>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
