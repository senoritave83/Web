<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CUBDet.aspx.vb"  ValidateRequest="False" Inherits="ITC.CUBDet"%>
			...
			<table id="Table1" borderColor="#809eb7" cellpadding=0 cellSpacing="0" width="100%" border="1">
				<tr>
					...
					<td vAlign="top" align="center">
						<img src="Imagens/TituloCUB.jpg" border="0"><br>
						<br>
						<table width="100%">
							<tr>
								<td width="2%">&nbsp;</td>
								<td width="96%">
									<br>
									<asp:Label Runat="server" ID="lblTitulo" Font-Bold="True" CssClass="f10"></asp:Label><br>
									<asp:Label Runat="server" ID="lblData" CssClass="f10"></asp:Label><br>
									<asp:Label Runat="server" ID="lblReportagem" CssClass="f10"></asp:Label><br>
									<br>
								</td>
								<td width="2%">&nbsp;</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td align="right">
									<a href='CUB.aspx'><img src='imagens/botaoesquerda.gif' border="0"></a></td>
								<td><font class="f10">Voltar</font>
									<br>
								</td>
								<td>&nbsp;</td>
							</tr>
