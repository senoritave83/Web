<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProcurarEmpresaContato.aspx.vb"  ValidateRequest="False" Inherits="ITC.ProcurarEmpresaContato"%>
			...
			<tr>
				<td vAlign="top" align="middle" width="95%">
					<form id="frmCad" action="ObrasDet.aspx" runat="server">
						<img src='imagens/TituloContatosObras.jpg' border="0">
