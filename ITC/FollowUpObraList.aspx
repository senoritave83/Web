<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FollowUpObraList.aspx.vb"  ValidateRequest="False" Inherits="ITC.FollowUpObraList"%>
	...
	<body onload="vertical();horizontal();" >
		<form id="frmCad" runat="server">
			<div id="Tudo">
					...
					<h3>SIG's Cadastrados de Obras</h3>
					<a href="followupobra.aspx" class="novo_follow" style="MARGIN:-22px 5px 0px 0px"><img src="img/follow_voltar.gif" style="MARGIN:0px 0px 2px" > Voltar</a>
					<p>&nbsp;</p>
					<p><asp:label Font-Bold=True Runat=server CssClass="FloatLeft" ID="lblNomeObra"></asp:label></p><br />
					...
					<table width=100% class="TableResultPesquisa" runat=server id=tblListarFollowUp>
						<tr>
							<td>
								<asp:DataGrid CssClass="f9" id="dtlFollowUP" runat="server" AllowPaging="true" AllowSorting="True" PageSize="10" OnPageIndexChanged="doPaging" BorderColor="#999999" BorderStyle="None" BackColor="White" CellPadding="3" GridLines="none" AutoGenerateColumns="False" width="100%">
									...
									<SelectedItemStyle BackColor=#0000ff></SelectedItemStyle>
										<Columns>
											<asp:TemplateColumn HeaderText="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
												<ItemTemplate>
													<a href='followupobradet.aspx?idobra=<%# CryptographyEncoded(ViewState("IdObra"))%>&idfollowup=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "IDFOLLOWUP"))%>&idx='><img src='imagens/botaoeditar.gif' border=0></a>
												</ItemTemplate>
											</asp:TemplateColumn>
											...
											<asp:TemplateColumn ItemStyle-Width="5%" HeaderText="Excluir">
												<ItemTemplate>
													<input type=checkbox id="chkIdFollowUp<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "IDFOLLOWUP"))%>" name="chkIdFollowUp" value="<%# DataBinder.Eval(Container.DataItem, "IDFOLLOWUP")%>">
												</ItemTemplate>
											</asp:TemplateColumn>
										</Columns>
