...
<form id="frmLogin">
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td>
				<table bgcolor="#edf0f2" id="tblLogin" cellpadding="0" cellspacing="0" width="50%" align="left" runat="server" border="0">
					<tr>
						...
						<td valign="middle" align="center">
							<asp:button CssClass="f8" id="btnLogin" Runat="server" Text=Login BorderStyle="None" CausesValidation="True"></asp:button>
						</td>
					</tr>
					<tr>
