Public Class ControleVendObr

    Inherits XMWebPage

    Protected WithEvents dtgFollowUP As System.Web.UI.WebControls.DataGrid
    Protected WithEvents txtObra As System.Web.UI.WebControls.TextBox
    Protected WithEvents btnProcurar As System.Web.UI.HtmlControls.HtmlInputButton
...
#End Region
    ...
    Private Sub BindGrid()
        ...
        Foll = New FollowUp
        Dim ds As DataSet = Foll.ListarOrigensFollowUp(Usuario.IDUsuario, TIPO_CADASTRO.OBRA, txtObra.Text, Me.Usuario.IdEmpresa, "")
