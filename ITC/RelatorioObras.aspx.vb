    ...
    Private Function Pesquisar()
        ...
        If ds.Tables.Count > 0 Then
            ...
            For i = 0 To ds.Tables(0).Rows.Count - 1
                ...
                sb.Append("<div style='border:none;align:center;height:50px;width:679px;padding-left: 30px'> " & vbCrLf)
                sb.Append("<img alt='' src='img/topo_relatorio_obra.jpg' border='0' width:'679px'")
                sb.Append("<p></br><div style='padding-top: 25px; padding-right: 0px; padding-bottom:0px; padding-left: 25px;'><center><strong>Emissão: " & Right("00" & Day(Now), 2) & "/" & Right("00" & Month(Now), 2) & "/" & Year(Now) & "  " & Right("00" & Hour(Now), 2) & ":" & Right("00" & Minute(Now), 2) & "</strong></p></center></div> " & vbCrLf)
                ...
                'INÍCIO CABEÇALHO
                sb.Append(" <div style='padding-top: 10px; padding-right: 0px; padding-bottom:0px; padding-left: 30px;'> " & vbCrLf)
                ...
                sb.Append("<div style='width: 300px; margin-right: 0px; margin-bottom: 0px; margin-left: 280px;'><input class='bt_relatorio_result' type='button' value='Desativar' onclick='fncXMHide(""pHide" & i & """)' onmousemove='this.style.cursor=""hand"";' border=0 id='btnHide" & i & "'>")
            ...
            For l = 0 To ds3.Tables(0).Rows.Count - 1
                ...
                Else
                    ...
                    ReDim Preserve strIdEmpresas(p_Index)
                            '       strEmpresas(p_Index) = ds3.Tables(0).Rows(l).Item("DESCRICAOMODALIDADE") & " - " & ds3.Tables(0).Rows(l).Item("FANTASIA") & vbCrLf
                            '        strIdEmpresas(p_Index) = "idobra=" & ds3.Tables(0).Rows(l).Item("IDOBRA") & "&idempresa=" & ds3.Tables(0).Rows(l).Item("IDEMPRESA") & "&idmodalidade=" & ds3.Tables(0).Rows(l).Item("IDMODALIDADE") & vbCrLf
                            If l = 1 Then
