Public Class FollowUpEmpresaDet
...
#End Region
    ...
    Private Sub BotaoAtualizar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BotaoAtualizar.Click
        ...
        End With
        Foll = Nothing
        Gravado("followupEmpresalist.aspx?idEmpresa=" & CryptographyEncoded(ViewState("IdEmpresa")) & "&idfollowup=" & CryptographyEncoded(ViewState("IdFollowUP")))
