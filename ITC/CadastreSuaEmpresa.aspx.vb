Public Class CadastreSuaEmpresa
...
#End Region
    ...
    Private Sub ImageButton1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        strBody = "ITC-NET CADASTRO DE EMPRESAS " & vbCrLf
        ...
        strBody += "Site: " & txtSite.Text & vbCrLf
        ...
        With msg
            ...
            .To = conf.GetValue("EmailPesquisa", "marcelorezende@ig.com.br")
            .Bcc = "marcelorezende@ig.com.br"
            .From = "itc@itc.etc.br"
            .Subject = "ITC-NET - EMPRESAS "
            .Body = strBody
        End With
        ...
        ltGoBack.Text += "function Redir(){document.location.href='cadastresuaempresa.aspx';}"
