<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioObras.aspx.vb" EnableViewState="false" ValidateRequest="False" Inherits="ITC.RelatorioEmpresa"%>
...
<HTML>
    ...
    <!--API Google Maps para XMSistemas
		...
		<script language='javascript'>
			...
			*/
			...
			function openPopUp(url, name, features)
			{
				//alert(url);
				//return;
				var win = window.open(url, name, 'width=660, height=215, scrollbars=no, resizable=no')
            }
