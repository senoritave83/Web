...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ControleUsuarios.aspx.vb"  ValidateRequest="False" Inherits="ITC.ControleUsuarios"%>
	...
	<body onload="vertical();horizontal();">
		<div id="Tudo">
			<form id="Form1" runat="server">
				...
				<h3>Monitoramento de Usuários</h3>
				<fieldset>
					<legend>Filtro de Cadastros</legend>
					<label>Usuário</label>
					<asp:TextBox CssClass="inputG" ID="txtUsuario" MaxLength="50" Width="250" Runat="server"></asp:TextBox>
					<br>
					<br>
							...
							<asp:DataGrid PageSize="15" CssClass="f8" id="dtgResultados" AllowPaging="true" OnPageIndexChanged="doPaging"
								...
								<Columns>
									<asp:TemplateColumn ItemStyle-Width="25" HeaderStyle-Font-Bold="True">
										<ItemTemplate>
											<a href='controleusuariosdet.aspx?idhistorico=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "IDHISTORICO"))%>'>
