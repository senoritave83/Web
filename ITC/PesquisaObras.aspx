<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PesquisaObras.aspx.vb"  ValidateRequest="False" Inherits="ITC.PesquisaObras"%>
...
<HTML>
  <HEAD>
		...
		<script src="scripts/populate_data.js"></script>
		<script language="javascript">
		    ...
		    function XM_ITC_Pesquisar() {
		        ...
		        window.open('relatorioobras.aspx?auth=' + document.getElementById('hidAuth').value + '&dt=<%=Now()%>&o=' + valores + '&t=' + t + '&q=' + ordem, 'ITCNET_PESQUISAR_OBRAS', 'height=600, width=800, top=10, left=10, toolbar=yes, scrollbars=yes, resizable=yes');
		    }
		    ...
		    function XM_ITC_GetLink() {
		        ...
		        if (valores != '') {
		            getForm().hidLink.value = 'relatorioobras.aspx?dt=<%=Now()%>&o=' + valores + '&t=' + t + '&q=' + ordem;
		            return true;
		        }
		    ...
		    function XM_ITC_Resumo() {
		        ...
		        window.open('relatorioobrasresumo.aspx?dt=<%=Now()%>&o=' + valores + '&q=' + ordem, 'ITCNET_RESUMO_OBRAS', 'height=600, width=800, top=10, left=10, toolbar=yes, scrollbars=yes, resizable=yes');
		    }
	...
	<body onload="vertical();horizontal();" >
        ...
        <asp:Page EnableEventValidation="true" />
			...
			<div id="Tudo">
				...
				<table id="tblSalvar" runat="server" width=100%>
					...
					<tr>
						<td>
							<asp:Button CssClass="f8" Runat="server" ID="btnSalvarAgora" Text="Salvar Campos Habilitados"></asp:Button>
						</td>
					</tr>
					<tr bgcolor=#ffffff>
						<td>
				...
				<div id="Selecao" runat=server>
					...
					<div>
						...
						<p>
							<asp:Label ID="lblMensagemTopo" Runat="server" Font-Bold="True" Font-Size="8" Font-Name="verdana">Selecione todos os itens desejados em sua pesquisa e clique no botão PESQUISAR.</asp:Label><br>
							<asp:label id="lblMensagemTopo2" Runat="server" CssClass="f8">Se nenhum item for selecionado, o resultado exibirá todas as obras disponíveis para visualização.</asp:label>
						</p>
					        ...
					        <fieldset>
						        ...
						        <table width=100%>
							        ...
							        <tr>
								        ...
								        <td width=35%>
									        <asp:DropDownList Runat="SERVER" id="cboIdEstado" AutoPostBack=true runat="server" ></asp:DropDownList>
								        </td>
								        <td width=15%>
									        <label>Cidade</label>
								        </td>
								        <td width=35%>
                                            <asp:DropDownList Runat="SERVER" id="cboCidade" runat="server">
							        ...
							        <tr>
								        ...
								        <td width=40%>
									        ...
									        <asp:textbox id="txtAreaConstruida" Runat="server" Width="70" MaxLength="50" onkeypress="javascript:SoNumeros();"></asp:textbox>
								        </td>
								        <td width=15%>
							        ...
							        <tr>
								        <td runat="server" id="tdPesquisador" width=15%>
									        <label>Pesquisador</label>	
								        </td>
								        <td runat="server" id="tdcboPesquisador" width=35%>
									        <uc1:combobox id="cboPesquisador" runat="server"></uc1:combobox>
								        </td>
                                        <td width=15%>
									        <label>Status atual do SIG</label>
								        </td>
								        <td width=35%>
						...
						<div align="center" class="botoes-pesquisa">
							...
							<table width="100%">
								<tr>
									...
									<td align="middle" width="25%"><asp:button id="btnSalvarPesquisa" Runat="server" CssClass="f8"  Text="Salvar Campos Habilitados"></asp:button></td>
				...
				<table id="Resultados" width="100%" runat="server">
						...
						<td width="100%" colSpan="4">
							...
							<asp:datagrid id="dtgResultados" runat="server" CssClass="f9" width="100%" AutoGenerateColumns="False" GridLines="none" CellPadding="3" BackColor="White" BorderColor="#999999" DataKeyField="CODIGO" HorizontalAlign="Center" AllowPaging=True PageSize="50" AllowSorting="True">
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderStyle-Width="9%" HeaderText="<B>Código ITC</B>">
										<ItemTemplate>
											<%# DataBinder.Eval(Container.DataItem, "CODIGOANTIGO")%>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Width="18%" HeaderText="<B>Nome da Obra</B>">
										<ItemTemplate>
											<b><%# DataBinder.Eval(Container.DataItem, "PROJETO")%></b>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Width="20%" HeaderText="<B>Endereço</B>">
										<ItemTemplate>
											<%# DataBinder.Eval(Container.DataItem, "ENDERECO")%>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Width="16%" HeaderText="<B>Nome Fantasia</B>">
										<ItemTemplate>
											<%# DataBinder.Eval(Container.DataItem, "FANTASIA")%>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Width="12%" HeaderText="<B>Cidade</B>">
										<ItemTemplate>
											<%# DataBinder.Eval(Container.DataItem, "CIDADE")%>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Width="10%" HeaderText="<B>Atualização</B>">
										<ItemTemplate>
											<%# DataBinder.Eval(Container.DataItem, "PUBLICACAO")%>
										</ItemTemplate>
									</asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderStyle-Width="13%" HeaderText="<B>SIG Status Atual</B>">
										<ItemTemplate>
											<%# DataBinder.Eval(Container.DataItem, "STATUSSIG")%>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Width="2%" HeaderText="" HeaderStyle-Wrap=False>
										<ItemTemplate>
											<a href='#' target:"_blank" onclick="window.open('followupobradetmini.aspx?idobra=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "CODIGO"))%>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=775, HEIGHT=355');"><img src='imagens/arrow-right.gif' border=0 alt="Adicionar/Editar Follow-UP de <%# DataBinder.Eval(Container.DataItem, "PROJETO")%>"></a>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
					...
					<tr>
						<td colspan=5 align=center>
							<table align=center border=1>
								<tr>
                                    <td align="center" width="10%"><asp:button id="btnBack" runat="server" CssClass="f8" text="Voltar" OnClientClick="JavaScript: window.history.back(1); return false;"></asp:button></td>
									<td align="center" width="18%"><asp:button id="btnNovaPesquisa2" Runat="server" CssClass="f8" Text="Nova Pesquisa"></asp:button></td>
									<td align="center" width="20%"><input type=button id="btnImprimirResumo" Class="f8" value="Visualizar Resumo" onclick="javascript:XM_ITC_Resumo();"></td>
									<td align="center" width="14%"><asp:button id="btnGravarLink" Runat="server" CssClass="f8" Text="Enviar Link"></asp:button></td>
									<td align="center" width="17%"><input type=button id="btnImprimir" Value="Visualizar Pesquisa" OnClick='javascript:XM_ITC_Pesquisar();' /></td>
									<td align="center" width="13%"><input runat="server" type=button id="btnExportar" Value="Exportar" OnClick='javascript:XM_ITC_Exportar();' /></td>
                                    <td align="center" width="18%"><input type="button" runat="server" id="btnTeste" Value="Atualizar página" /></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						...
						<td align="left" width="45%">
							<font class=f8>Exibir Todas as Empresas Participantes</font>	
							<input type=radio id=TipoRelatorio name=TipoRelatorio value=3 >
						</td>
					</tr>
					<tr>
