...
#End Region
    ...
    Private Sub showReport()
        ...
        Dim p_NomeAssociado As String = Me.Request("na") & ""
        ...
        Dim dr As SqlClient.SqlDataReader = fol.relAssociados(Me.Usuario.IdEmpresa, Me.Usuario.IDUsuario, _
                                                            p_NomeAssociado, p_NomeVendedor, p_DataInicial, _
        ...
        strHTML += " <div id='Tudo'>"
        strHTML += "    <div id='TopoRelatorioAssociado' style='margin:5px 10px 10px 10px'>"
        ...
        strHTML += "		    <td width='160'>Data do Relato</td>"
        ...
        Do While dr.Read
            ...
            strHTML += "		<td style='padding:10 0 5 0'><b>" & dr("ASSOCIADO") & "</b></td>"
            ...
            strHTML += "        <a href='#' target:""_blank"" onclick=""window.open('FollowUpAssocDetMini.aspx?idassociado=" & CryptographyEncoded(dr("IDEMPRESA_OBRA")) & "', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=775, HEIGHT=355');""><img src='imagens/arrow-right.gif' alt='Ver Follow-Up's' border=0></a></td>" & vbCrLf
            strHTML += "	</tr>"
