...
Public Class RelatorioEmpresaD
    ...
    Private Function Pesquisar()
        ...
        If Viewstate("Tipo") = 2 Then
            ...
            If Viewstate("Pagina") > 1 Then
                sb.Append("		        <a href='RelatorioObrasD.aspx?T=" & Viewstate("Tipo") & "&O=" & ViewState("Obras") & "&P=" & Viewstate("Pagina") - 1 & "'><b>Anterior</b>&nbsp;&nbsp;</a>")
            Else
                sb.Append("				<b>Anterior</b>&nbsp;&nbsp;")
            End If
            If Viewstate("Pagina") < MaxPage Then
                sb.Append("			    <a href='RelatorioObrasD.aspx?T=" & Viewstate("Tipo") & "&O=" & ViewState("Obras") & "&P=" & Viewstate("Pagina") + 1 & "'><b>Próxima</b>&nbsp;&nbsp;</a>")
            Else
        ...
        Dim ds As DataSet = pesq.RelatorioObras(strItens, Viewstate("Ordenacao"))
        ...
        If ds.Tables.Count > 0 Then
            ...
            For i = 0 To ds.Tables(0).Rows.Count - 1
                ...
                sb.Append("     <div style='border:none;align:center;height:50px;width:679px;margin:0 0 0px 33px'> " & vbCrLf)
                sb.Append("         <img alt='' src='img/topo_relatorio_obra.jpg' border='0'>")
                sb.Append("         <p style='padding:0px 0px 0px 0px;' align='left'>Emissão: " & Right("00" & Day(Now), 2) & "/" & Right("00" & Month(Now), 2) & "/" & Year(Now) & "  " & Right("00" & Hour(Now), 2) & ":" & Right("00" & Minute(Now), 2) & "</p> " & vbCrLf)
                ...
                sb.Append(" <div style='padding:0 0 0 33px;'> " & vbCrLf)

                sb.Append("   <h4 style='width:250px'><strong>Código ITC:</strong> " & ds.Tables(0).Rows(i).Item("CODIGOANTIGO") & "</h4> " & vbCrLf)
                sb.Append("   <h4 style='width:428px'><strong>Data da última atualização:</strong> " & ds.Tables(0).Rows(i).Item("PUBLICACAO") & " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" & vbCrLf)
                ...
                sb.Append(" <div style='margin:-10px 0;*margin:-14px 0'>&nbsp;</div> " & vbCrLf)
                'FIM CABEÇALHO


                'INÍCIO DE DIV DA OBRA
                sb.Append("	<div class='relatorio_tit' style='line-height:20px;width:678px;'><div class='FloatLeft'>Dados da Obra</div>")

                sb.Append("<div class='FloatRight'><input class='bt_relatorio_result' type='button' value='Desativar' onclick='fncXMHide(""pHide" & i & """)' onmousemove='this.style.cursor=""hand"";' border=0 id='btnHide" & i & "'>&nbsp;</div>")
                'sb.Append("<input class='bt_relatorio_result' type='button' value='SIG' onclick=""window.open('followupobradetmini.aspx?idobra=" & CryptographyEncoded(ds.Tables(0).Rows(i).Item("CODIGO")) & "', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=775, HEIGHT=355');"" >&nbsp;</div>")
                sb.Append("</div>" & vbCrLf)

                'INÍCIO DE DADOS DA OBRA
                sb.Append("	    <div class='relatorio' style='margin:0 0 5px 33px;'>" & vbCrLf)
                ...
                sbMapsIf.Append("                   geocoder.getLocations('" & strEndereco & "', CallbackMap_" & i & ");" & vbCrLf)
                sbMapsIf.Append("               }" & vbCrLf)
                ...
                If segmentoStr = "Residencial" Then
                    ...
                    If IsDBNull(ds.Tables(0).Rows(i).Item("obr_Foto_chr")) Then
                        sb.Append("     <img src='imagens/condominio-05.jpg' style='float:right' width='240' height='160' />" & vbCrLf)
                    ElseIf (ds.Tables(0).Rows(i).Item("obr_Foto_chr")) = "" Then
                        sb.Append("     <img src='imagens/condominio-05.jpg' style='float:right' width='240' height='160' />" & vbCrLf)
                    Else
                        sb.Append("     <img src='imagens/relatorios_obras/" & ds.Tables(0).Rows(i).Item("obr_Foto_chr") & "' style='float:right' width='240' height='160' />" & vbCrLf)
                    End If
                    sb.Append("</div>")
                ...
                Else
                    ...
                    ElseIf (ds.Tables(0).Rows(i).Item("obr_Foto_chr")) = "" Then
                        sb.Append("     <img src='imagens/condominio-05.jpg' style='float:right' width='250' height='160' />" & vbCrLf)
                    Else
                        sb.Append("     <img src='imagens/relatorios_obras/" & ds.Tables(0).Rows(i).Item("obr_Foto_chr") & "' style='float:right' width='250' height='160' />" & vbCrLf)
                    End If
                ...
                If ds2.Tables.Count > 0 Then
                    ...
                    If ds2.Tables(0).Rows.Count > 0 Then
                        ...
                        'INÍCIO DE HEADER DE CONTATOS DA OBRA
                        sb.Append(" <div class='relatorio_tit' style='width:678px;line-height:15px;'>Contatos na Obra</div>" & vbCrLf)
                        sb.Append(" <div class='relatorio' style='padding:1px 18px 1px 18px;margin:0 0 5px 33px;'>" & vbCrLf)
                        'FIM DE HEADER DE CONTATOS DA OBRA

                        For j = 0 To ds2.Tables(0).Rows.Count - 1

                            'sb.Append("     <div style='margin:0 0 0 0;padding:5px 0 0 0'>" & vbCrLf)

                            sb.Append("							<table cellpadding='0' width=100% border='0'>" & vbCrLf)
                            ...
                            sb.Append("<b>E-mail:</b><a class=f8Rel href='mailto:" & ds2.Tables(0).Rows(j).Item("EMAIL") & "'><font class='f8Rel' > " & ds2.Tables(0).Rows(j).Item("EMAIL") & "</a>" & vbCrLf)
                ...
                'INIÍCIO DE EMPRESAS PARTICIPANTES
                ...
                If ds3.Tables.Count > 0 Then
                    ...
                    For l = 0 To ds3.Tables(0).Rows.Count - 1
                        ...
                        If l = 0 Or Viewstate("Tipo") = 3 Then
                            ...
                            If l = 0 Then
                                ...
                                sb.Append(" <div class='relatorio_tit' style='line-height:15px;width:678px;'>Empresas Participantes</div>" & vbCrLf)

                                'DIV EMPRESAS PARTICIPANTES
                                sb.Append("     <div class='relatorio' id='relatorioEmpresas' style='width:678px;padding:1px 18px 1px 18px;margin:0 0 5px 33px; overflow:hidden'>" & vbCrLf)
                            End If
                        ...
                        If l = 0 Or Viewstate("Tipo") = 3 Then
                            ...
                            'sb.Append("			    <li>" & vbCrLf)
                            sb.Append("				<table width='100%' style='border:none'>" & vbCrLf)
                            sb.Append("					<tr>" & vbCrLf)
                            sb.Append("						<td width=100% align='center'>" & vbCrLf)
                    ...
                    For jEmp = 1 To UBound(strEmpresas)
                        ...
                        sb.Append("								<td width=50% align=left nowrap><class='f8Rel' alt='' border='0'>" & strEmpresas(jEmp) & "</a></td>" & vbCrLf)
                ...
                'DIV RODAPÉ
                sb.Append(" <div class='RodapeRelatorio' style='height:10px;margin:0px 0px 0px 33px;padding:0px 0px 0px 0px'>")
                sb.Append("     <p style='padding:0px 0px 0px 0px;text-align: center;'>www.itc.etc.br     -      E-mail: itc@itc.etc.br<br>")
