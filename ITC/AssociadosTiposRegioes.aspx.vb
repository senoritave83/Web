                    ...
                    If i = 0 Then
                        For j = 2 To .Columns.Count - 1
                            ...
                            If dc.ColumnName.ToString().ToUpper() <> "IDSEGMENTO" Then
                                ...
                                cl.HeaderText = "<a alt='Clique aqui para selecionar a coluna toda' href=""javascript:CA('" & dc.ColumnName.Substring(0, 3) & "')"" bgcolor=""#003C6E""><font class=f8 color=#FFFFFF>" & dc.ColumnName.Substring(4) & "</font></a>"
