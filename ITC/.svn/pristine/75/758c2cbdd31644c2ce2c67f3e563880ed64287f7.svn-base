...
#End Region
    ...
    Private Sub BindGrid()
        ...
        Foll = New FollowUp
        Dim ds As DataSet = Foll.ListarOrigensFollowUp(Usuario.IDUsuario, TIPO_CADASTRO.ASSOCIADO, txtAssociado.Text, Me.Usuario.IdEmpresa, txtCodigo.Text)
