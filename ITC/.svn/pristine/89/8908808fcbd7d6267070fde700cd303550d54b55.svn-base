...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FollowupEmpDetMini.aspx.vb" Inherits="ITC.FollowupEmpDetMini"%>
...
<HTML>
	...
	<body onload="vertical();horizontal();">
		<div id="Tudo" runat="server">
			<form id="frmCad" runat="server">
				...
				<div id="divRegistros" runat="server" visible="false">
					<asp:DataGrid CssClass="f9" id="dtlRegistros" runat="server" AllowPaging="True" AllowSorting="True"
						...
						<Columns>
							<asp:TemplateColumn ItemStyle-Width="55%" HeaderText="<b>Descrição</b>">
								<ItemTemplate>
									<font class="f8">
							...
							<asp:TemplateColumn ItemStyle-Width="10%" HeaderText="<b>Relator</b>">
								<ItemTemplate>
									<font class="f8">
		...
		<div id="Falha" visible="false" runat="server">
			<label>Erro: Você não tem permissão para cadastrar SIG's nesta obra.</label>
		</div>
	</body>
</HTML>
