<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ControleVendEmp.aspx.vb"  ValidateRequest="False" Inherits="ITC.ControleVendEmp"%>
				...
				<table width="100%" border="0" bgcolor=#FFFFFF >
					<tr>
						<td align="right" width=10%>
							<asp:label Runat=server CssClass="f9" ID="Label1">Empresa</asp:Label>
						</td>
						<td align="left" width="60%" colspan="2">
							<asp:TextBox CssClass="f8" ID="txtEmpresa" Runat="server" MaxLength="100" Width="80%"></asp:TextBox>
						</td>
						<td  align="middle" width="20%">
							<input type=button Runat="server" ID="btnProcurar" value="Pesquisar" NAME="btnProcurar"/>
						</td>
					</tr>
				</table>
				<br />
							...
							<PagerStyle HorizontalAlign="Center" PageButtonCount=15 ForeColor="white" BackColor="#999999" Mode="NumericPages"></PagerStyle>
								<Columns>
									<asp:TemplateColumn ItemStyle-Width=25>
										<ItemTemplate>
											<a href="ControleVendEmpDet.aspx?idempresa=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "Codigo"))%>"><img src='img/ico_status_ok.gif' border=0 ></a>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="<b>Empresa</b>" ItemStyle-Width=100%>
										<ItemTemplate>
											<a href="ControleVendEmpDet.aspx?idempresa=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "Codigo"))%>"><asp:Label ID=lblCodigo Runat=server ><%# DataBinder.Eval(Container.DataItem, "RAZAOSOCIAL")%></asp:Label></a>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
