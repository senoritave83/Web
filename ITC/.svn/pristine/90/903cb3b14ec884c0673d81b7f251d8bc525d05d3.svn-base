<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelFAss.aspx.vb" Inherits="ITC.RelFAss"%>
...
<HTML>
	<head>
		...
		<script language="javascript">
			function showReport()
			{
				...
				var win = window.open('relfassdet.aspx?' + p_URL, 'RelFolAssoc', 'width=800, height=600, top=100, left=100, scrollbars=1, toolbar=1');
			}
		</script>
	</head>
	...
	<body onload="vertical();horizontal();" >
		<div id="Tudo">
			...
			<h3>Relatório de SIG's - Associados</h3>
