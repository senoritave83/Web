...
#End Region
    ...
    Private Sub BindGrid()
        ...
        Foll = New FollowUp
        Dim ds As DataSet = Foll.ListarOrigensFollowUp(Usuario.IDUsuario, TIPO_CADASTRO.OBRA, txtObra.Text, Me.Usuario.IdEmpresa, txtCodigo.Text)
