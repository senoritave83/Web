Public MustInherit Class Bloco2

    Inherits System.Web.UI.UserControl
    Protected WithEvents ltScrollable As System.Web.UI.WebControls.Literal
    Protected WithEvents dtgSubTipos As System.Web.UI.WebControls.DataGrid
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not Page.IsPostBack Then
            ...
            ltScrollable.Visible = False

            'Dim clsNot As Noticia
            'clsNot = New Noticia()
            'Dim ds As DataSet = clsNot.UltimasNoticias(6)
            'ltScrollable.Text = MontaScrollable()
            dtgSubTipos.DataSource = Noticias(5)
            dtgSubTipos.DataBind()

        End If
    End Sub

    Public Function Noticias(ByVal Numero As Integer) As DataSet
        Dim clsNot As Noticia
        clsNot = New Noticia()
        Return clsNot.UltimasNoticias(Numero)
    End Function
    ...
    Private Function MontaScrollable() As String
        ...
        'strScrollable += "	var scroller_height=300" & vbCrLf
        ...
        clsNot = New Noticia()
        With clsNot
            Dim ds As DataSet = .UltimasNoticias(6)
            Dim i As Integer
