...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FollowUpEmpresaList.aspx.vb" Inherits="ITC.FollowUpEmpresaList"%>
	...
	<body onload="vertical();horizontal();" >
		<form id="frmCad" runat="server">
			<div id="Tudo">
					...
					<h3>SIG's Cadastrados de Empresas</h3>
					<a href="followupempresa.aspx" class="novo_follow" style="MARGIN:-22px 5px 0px 0px"><img src="img/follow_voltar.gif" style="MARGIN:0px 0px 2px" > Voltar</a>
					<p>&nbsp;</p>
					<p><asp:label Font-Bold=True Runat=server CssClass="FloatLeft" ID="lblNomeEmpresa"></asp:label></p><br />
									...
									<SelectedItemStyle BackColor=#0000ff></SelectedItemStyle>
										<Columns>
											<asp:TemplateColumn HeaderText="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
												<ItemTemplate>
													<a href='followupEmpresadet.aspx?idEmpresa=<%# CryptographyEncoded(ViewState("IdEmpresa"))%>&idfollowup=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "IDFOLLOWUP"))%>&idx='><img src='imagens/botaoeditar.gif' border=0></a>
												</ItemTemplate>
											</asp:TemplateColumn>
				...
				<uc1:Rodape id="Rodapé1" runat="server"></uc1:Rodape></div>
			</div>
		</form>
	</body>
</HTML>
