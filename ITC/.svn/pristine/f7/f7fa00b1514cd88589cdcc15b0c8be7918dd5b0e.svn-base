...
Public Class clsAssociados
    ...
    Private m_blnAparecerNoGuia As Boolean
    Private m_MensagemErro As String
    Private m_strPrimeiroContrato As String
    ...
    Public Property AparecerNoGuia() As Boolean
        Get
            Return m_blnAparecerNoGuia
        End Get
        Set(ByVal Value As Boolean)
            m_blnAparecerNoGuia = Value
        End Set
    End Property

    Public Property PrimeiroContrato() As String
        Get
            Return m_strPrimeiroContrato
        End Get
        Set(ByVal Value As String)
            m_strPrimeiroContrato = Value
        End Set
    End Property
    ...
    Private Sub Inflate(ByVal row As DataRow)
        ...
        Me.m_blnAparecerNoGuia = IIf(row("ass_Guia_ind") = 1, True, False)
        ...
        Me.m_strPrimeiroContrato = CStr(row("PrimeiroContrato") & "")
    ...
    Private Function Deflate() As String
        ...
        strDeflate &= IIf(m_blnAparecerNoGuia, 1, 0) & ","
        strDeflate &= "'" & Replace(m_strPrimeiroContrato, "'", "''") & "',"
    ...
    Private Sub Clear()
        ...
        m_strObservacoes = ""
        m_varModulo = ""
        m_strPrimeiroContrato = ""
        m_strSkype = ""
    End Sub

    Public Function Buscar(ByVal p_Associado As String, ByVal p_IdUsuario As Integer) As DataSet
        Try
            Return GetDataSet("SP_BS_BUSCARASSOCIADO '" & p_Associado & "'," & p_IdUsuario)
