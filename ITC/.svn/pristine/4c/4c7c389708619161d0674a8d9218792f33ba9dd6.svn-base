Public Class CadastreSuaObra
    ...
    Protected WithEvents reqEstagio As System.Web.UI.WebControls.RequiredFieldValidator
    Protected WithEvents txtEstagio As System.Web.UI.WebControls.TextBox
    ...
    Private Sub ImageButton1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        Try
            ...
            With msg
                ...
                .To = "marcelorms@gmail.com"
                .Bcc = "marcelorezende@ig.com.br"
                .From = "itc@itc.etc.br"
                .Subject = "ITC-NET CADASTRO DE OBRAS "
                .Body = strBody
            End With
            ...
            ltGoBack.Text += "function Redir(){document.location.href='cadastresuaobra.aspx';}"
            ltGoBack.Text += "setTimeout('Redir()', 3000);"
            ltGoBack.Text += "</" & "script>'"

        Catch ex As Exception
            Response.Write("Erro no envio " & ex.Message)
        End Try
