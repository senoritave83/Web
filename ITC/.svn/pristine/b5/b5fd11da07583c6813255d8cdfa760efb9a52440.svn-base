<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProcurarEmpresa.aspx.vb"  ValidateRequest="False" Inherits="ITC.ProcurarEmpresa"%>
<HTML>
			...
			<tr>
				<td vAlign="top" align="middle" width="95%">
					<form id="frmCad" action="ObrasDet.aspx" runat="server">
						<img src='imagens/TituloEmpresasParticipantes.jpg' border="0">
