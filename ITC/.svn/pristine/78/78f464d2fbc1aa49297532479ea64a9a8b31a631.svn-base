...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CadastreSuaEmpresa.aspx.vb"  ValidateRequest="False" Inherits="ITC.CadastreSuaEmpresa"%>
			...
			<table id="Table1" borderColor="#809eb7" cellpadding="0" cellSpacing="0" width="100%" border="1">
				<tr>
					...
					<td vAlign="top" align="middle">
						<img src="Imagens/TituloCadastreEmpresa.jpg" border="0"><br>
						<br>
						<br>
						...
						<table width="90%" id="tblDadosEmail" runat="server">
							<tr>
								<td colspan="2">
									<font class="f10">Preencha os dados de sua empresa e receba uma oportunidade de 
										negócios: </font>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<font class="f10">Endereço</font><asp:RequiredFieldValidator ID="reqEndereco" Runat="server" CssClass="f8" ControlToValidate="txtEndereco" ErrorMessage="*"></asp:RequiredFieldValidator>
								</td>
								<td nowrap>
