<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ControleAssociadosDet.aspx.vb"  ValidateRequest="False" Inherits="ITC.ControleAssociadosDet"%>
	...
	<body onload="vertical();horizontal();" >
		<div id="Tudo">
			<form id="frmCad" runat="server">
				...
				<fieldset>
    				<legend>Detalhes do Associado</legend>
