<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ControleVendObrDet.aspx.vb"  ValidateRequest="False" Inherits="ITC.ControleVendObrDet"%>
			...
			<form id="frmCad" runat="server">
				...
				<table width="100%" border="0" bgcolor="#ffffff">
					<tr>
						...
						<td colspan="3">
							<asp:label Runat="server" CssClass="f9" Font-Bold="True" ID="lblNomeObra"></asp:label>
						</td>
					</tr>
					<tr>
						<td width="150">
				...
				<table width="100%">
					<tr>
						<td width=10%>
							<input type=button value="Gravar" id="btnGravar" runat="server" />
						</td>
						<td>
