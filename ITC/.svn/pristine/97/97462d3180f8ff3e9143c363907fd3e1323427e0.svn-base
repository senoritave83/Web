				...
				<uc1:top id="Top1" runat="server"></uc1:top>
					...
					<asp:DataGrid id="dtgEstagios" runat="server" BorderColor="#999999" BorderWidth="0" BackColor="White" CellPadding="3" GridLines="Horizontal" AutoGenerateColumns="False" width="100%">
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderStyle-Width="20%" ItemStyle-VerticalAlign=Middle ItemStyle-Height=40 HeaderStyle-Font-Bold=True HeaderText="Estágio">
								<ItemTemplate>
									<font Color="#000000" face="verdana" Size="2">
							...
							<asp:TemplateColumn HeaderStyle-Width="70%" ItemStyle-VerticalAlign=Middle ItemStyle-Height=40 HeaderStyle-Font-Bold=True HeaderText="Descrição do Estágio">
								<ItemTemplate>
