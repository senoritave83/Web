...
#End Region
    ...
    Private Sub showReport()
        ...
        Dim p_NomeEmpresa As String = Me.Request("na") & ""
        ...
        Dim dr As SqlClient.SqlDataReader = fol.relEmpresas(Me.Usuario.IdEmpresa, Me.Usuario.IDUsuario, _
                                                            p_NomeEmpresa, p_NomeVendedor, p_DataInicial, _
        ...
        strHTML += " <div id='Tudo'>"
        strHTML += "    <div id='TopoRelatorioEmpresa' style='margin:5px 10px 10px 10px'>"
        strHTML += "        <p>Emissão: " & Day(Now) & "/" & Month(Now) & "/" & Year(Now) & "  " & Hour(Now) & ":" & Minute(Now) & "</p>"
        strHTML += "    </div>"

        strHTML += "    <table width='645' border='0' cellpadding='0' cellspacing='0' class='TableRelatorio'>"
        ...
        Do While dr.Read
            ...
            strHTML += "		<td style='padding:10 0 5 0'><b>" & dr("Empresa") & "</b></td>"
            ...
            strHTML += "        <a href='#' target:""_blank"" onclick=""window.open('followupempdetmini.aspx?idempresa=" & CryptographyEncoded(dr("IDEMPRESA_OBRA")) & "', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=775, HEIGHT=355');""><img src='imagens/arrow-right.gif' alt='Ver Follow-Up's' border=0></a></td>" & vbCrLf
            strHTML += "	</tr>"
            ...
            If (i Mod 4 = 0) And (i <> cont) Then
                ...
                strHTML += "    <table width='660' border='0' cellpadding='0' cellspacing='0' class='TableRelatorio'>"
                strHTML += "		<tr class='Tit'>"
                strHTML += "		    <td width='150'>Data do Relato</td>"
                strHTML += "            <td >Empresa</td>"
                strHTML += "            <td >Relator</td>"
