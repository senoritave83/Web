            ...
            <ContentTemplate>
                ...
                <asp:GridView runat='server' ID='grdProdutos' AutoGenerateColumns="false" DataKeyNames="IDItemPedido">
                    ...
                    <Columns>
                       ...
                       <%-- <asp:BoundField DataField='Preco' HeaderText ='Valor Estipulado' DataFormatString='{0:c}' Visible='True' />--%>
			            ...
			            <Columns>
                            ...
                            <asp:TemplateField HeaderText="Quantidade" ItemStyle-Width="30%">
                                <ItemTemplate>
			                        ...
			                        <asp:CustomValidator runat="server" ID="CompareValidator4" Display="Dynamic" ErrorMessage="Quantidade inválida" ControlToValidate="txtQuantidade" Operator="DataTypeCheck" Type="Integer" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Preço Unitário" ItemStyle-Width="30%">
                                <ItemTemplate>
                                    ...
                                    <asp:CompareValidator runat="server" ID="CompareValidator5" Display="Dynamic" ErrorMessage="Voce Precisa ter uma quantidade para adicionar um valor" ControlToValidate="txtPreco" Operator="DataTypeCheck" Type="Currency"/>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
	                </asp:GridView>
