...
Partial Class pedidos_cliente
    ...
    Protected Sub grdPedidos_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdPedidos.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            '*** O link "Editar" só é ativado quando o STATUS do PEDIDO for 0 (indefinido) ou 7 ("Em Edição") e se o ATENDIMENTO não estiver finalizado.
            lnk.Visible = e.Row.DataItem("IDStatusPedido") = 0 Or e.Row.DataItem("IDStatusPedido") = 7 And atc.Finalizado = False
