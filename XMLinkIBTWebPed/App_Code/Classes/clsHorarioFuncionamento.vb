...
#Region "Metodos"
        ...
        ''' </summary>
        Public Sub Inserir(ByVal vHorario As String, ByVal vInicio As Short, ByVal vFinal As Short, ByVal vDevolucao As Boolean)
            ...
            cmd.Parameters.Add("@DEVIMP", SqlDbType.TinyInt).Value = vDevolucao
            cn.Open()
            Try
                cmd.ExecuteNonQuery()
            Finally
