<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="~/Controle/estvendedoresadicionar.aspx.vb" Inherits="Vendedores_ConsignadoAdicionar" title="Untitled Page" %>
                    ...
                    <table>
                        <tr>
                            <td id='tdProcurar'>
                                ...
                                <p>
                                    <asp:Label runat='server' ID='lblNaoEncontrados'>Categoria</asp:Label>
                                    <asp:DropDownList style="width:60%" runat="server" ID="cboIDCategoria" DataTextField="Categoria" DataValueField="IDCategoria" /><br class='cb' />
                                    <asp:Label runat='server' ID='Label1'>Código ou Descrição</asp:Label><asp:TextBox Runat="server" ID='txtFiltro' style="width:50%"  /><asp:Button runat='server' ID='btnFiltrar' Text='Filtrar' />
