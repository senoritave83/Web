<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="consignado.aspx.vb" Inherits="Roteiros_consignado" title="Untitled Page" %>
    ...
    <div class='EditArea'>
		<table id='tblEditArea'>
            ...
            <tr class='trField'>
				...
				<td class='tdField' colspan='3'>
					<asp:Label runat='server' ID='lblTextoNomeFantasia' />
				</td>
            </tr>
        ...
        <asp:UpdatePanel Runat="server" ID='pnlProdutos'>
            <ContentTemplate>
                    ...
                    <asp:GridView runat='server' ID='grdProdutos' AutoGenerateColumns='false' Width='100%' DataKeyNames='IDProduto'>
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText='Histórico' HeaderStyle-HorizontalAlign='Left'>
                                <ItemTemplate>
                                    <a href='consignacaohistorico.aspx?idproduto=<%# Eval("IDProduto") %>&idcliente=<%=ViewState(VW_IDCLIENTE) %>'>Visualizar</a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        ...
                        <EmptyDataTemplate>
                            <table class="TextDefault" width='100%' cellspacing="0" cellpadding="4" border="0" >
                                ...
                                <tr>
                                    <td>
                                        N&atilde;o h&aacute; produtos consignados
                                    </td>
                                </tr>
                               </table>
                        </EmptyDataTemplate>
                ...
                <div class='AreaBotoes'>
                    ...
                    <asp:Button runat='server' ID='btnAdicionar' Text="Adicionar Produto" CssClass='Botao' Visible='True' />
