<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="~/Controle/estvendedores.aspx.vb" Inherits="consignado_vendedores" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Timer runat="server" ID="tmrTimer" Interval="3000" Enabled="false">
    </asp:Timer>
    <asp:Panel ID="pnlMensagem" runat="server" Visible="false">
		<div class='Filtro'>
			<div class='FiltroItem' style="width:100%;">
				<asp:Label runat="server" id="Label1">Usuário não pode acessar os dados de consignação.</asp:Label>
			</div> 
        </div>
    </asp:Panel>
		    ...
		    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
				    <asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					    ...
					    <columns>
						    <asp:HyperLinkField DataNavigateUrlFields="IDVendedor" DataNavigateUrlFormatString="estvendedoresdet.aspx?idvendedor={0}" DataTextField="Codigo" HeaderText="C&oacute;digo" SortExpression="Codigo"  />
