<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="schedule.aspx.vb" Inherits="Relatorios_schedule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div class='ListArea'>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns='false' EnableModelValidation="True" DataKeyNames='IDSchedule' style="border:1px solid #CDCECF;" CellPadding="1" CellSpacing="1">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IDSchedule" DataNavigateUrlFormatString="relat.aspx?idschedule={0}" DataTextField="Name" HeaderText="Nome" ItemStyle-Width='150px'  />
                    ...
                    <EmptyDataTemplate>
                        <div class="divEmptyRow">N&atilde;o h&aacute; relat&oacute;rios agendados</div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </ContentTemplate>
            <Triggers>
