...
Partial Class Vendedores_ConsignadoAdicionar
    Inherits XMWebPage
    ...
    Protected Sub btnVoltar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnVoltar.Click
        Response.Redirect("estvendedoresdet.aspx?idvendedor=" & cls.IDVendedor)
    End Sub
    ...
    Protected Sub btnAdicionar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdicionar.Click
        ...
        lblMensagem.Text = "O produto informado foi adicionado aos produtos em consignação do Vendedor!"
        BindProdutos()
    End Sub
    ...
    Protected Sub grdProdutos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdProdutos.RowCommand
        If e.CommandName = "AdicionarProduto" Then
