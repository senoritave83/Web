...
Namespace Pages.Cadastros
    ...
    Partial Public Class Clientes
        ...
        Const ACAO_VISUALIZAR_TODOS As String = "Visualizar Todos os clientes"
        ...
        Public Sub BindGrid()
            ...
            If VerificaPermissao(SecaoAtual, ACAO_VISUALIZAR_TODOS) Then
                ret = cls.Listar(ViewState("Filtro"), cboUF.SelectedValue, drpReferencia.SelectedItem.Value, rdClienteBloqueado.SelectedItem.Value, SortExpression, SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE, 0, DataClass.enReturnType.DataReader)
            Else
                ret = cls.Listar(ViewState("Filtro"), cboUF.SelectedValue, drpReferencia.SelectedItem.Value, rdClienteBloqueado.SelectedItem.Value, SortExpression, SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE, User.IDUser, DataClass.enReturnType.DataReader)
            End If
