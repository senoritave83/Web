		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDCategoria" DataNavigateUrlFormatString="Categoria.aspx?IDCategoria={0}" DataTextField="Codigo" HeaderText="C&oacute;digo" SortExpression="Codigo"  />
