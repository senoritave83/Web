<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Vendedores.aspx.vb" Inherits="Pages.Roteiros.Vendedores" title="Untitled Page" %>
	...
	<asp:UpdatePanel ID="updFiltro" runat="server">
	    <ContentTemplate>
			<div class='Filtro'>
		        ...
		        <div class='FiltroItem'>Filial de Venda<br>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDVendedor" DataNavigateUrlFormatString="VendedorRoteiros.aspx?IDVendedor={0}" DataTextField="Codigo" HeaderText="C&oacute;digo" SortExpression="Codigo"  />
						...
						<asp:BoundField HeaderText="Filial de Venda" DataField="Grupo" SortExpression="Grupo" />
					</columns>
					<EmptyDataTemplate>
