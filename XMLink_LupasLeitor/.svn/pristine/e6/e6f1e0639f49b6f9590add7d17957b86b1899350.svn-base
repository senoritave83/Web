...
Partial Class Relat_Relatorios
    Inherits XMWebPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim strIDSchedule As String = Request("IDSchedule")
            If Not String.IsNullOrEmpty(strIDSchedule) Then
                XMReportFilters1.LoadScheduling(strIDSchedule)
            Else
                Dim strPath As String = AppSettings("reportspath") 'SettingsExpression.GetProperty("reportspath", "", "/")
    ...
    Protected Sub btnVisualizar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
        XMReportFilters1.PostXML("relatoriodet.aspx", "width=800px height=600px scrollable=yes resizable=yes", "report_view")
    End Sub
    ...
    Protected Sub btnListagemRelatorios_Click(sender As Object, e As System.EventArgs) Handles btnListagemRelatorios.Click
