...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class='EditArea'>
		<table id='tblEditArea'>
			...
			<tr class='trField'>
				<td class='tdFieldHeader'>
				    <asp:Label runat='server' ID='lblTextoJustificativa'>
						Justificativa:
					</asp:Label> 
				</td>
				<td class='tdField'>
					<asp:TextBox runat='server' ID='txtJustificativa' MaxLength='100' />
					<asp:RequiredFieldValidator runat='server' ID='valReqJustificativa' Display='None' ErrorMessage='Justificativa &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtJustificativa' />
				</td>
			</tr>
			<tr class='trField'>
				<td class='tdFieldHeader'>
