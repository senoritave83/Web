	...
	<asp:UpdatePanel ID="updFiltro" runat="server">
	    <ContentTemplate>
			<div class='Filtro'>
                ...
                <div class='FiltroItem'>Cliente bloqueado<br>
                    <asp:RadioButtonList runat="server" ID="rdClienteBloqueado" ForeColor="White">
            ...
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						...
						<asp:BoundField HeaderText="UF" DataField="UF" SortExpression="UF" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                        <asp:BoundField HeaderText="Referência" DataField="REFERENCIA" SortExpression="REFERENCIA" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                        <asp:BoundField HeaderText="Bloqueado" DataField="Bloqueado" SortExpression="Bloqueado" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
					</columns>
					<EmptyDataTemplate>
