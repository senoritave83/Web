    ...
    Partial Public Class Produtos
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, cboIDCategoria)

                GridView1.Columns(3).Visible = UsaFotos
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(ViewState("Filtro"), cboIDCategoria.selectedValue, SortExpression, SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, cboIDCategoria)
		End Sub
        ...
        Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow And UsaFotos Then
                Dim img As Image = e.Row.FindControl("imgFoto")
                Dim strFoto = e.Row.DataItem("Foto").ToString
                If String.IsNullOrEmpty(strFoto) Then
                    img.Visible = False
                Else
                    img.Visible = True
                    img.ImageUrl = "~/imagens/camera.gif"
                End If
