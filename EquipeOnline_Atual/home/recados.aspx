<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="recados.aspx.vb" Inherits="home_recados" title="Equipe Online" %>
									...
									<table width="100%" border="0" style= "background-color:#eeece7;">
										<tr>
											<td style="text-align:left;">
                                                <br />
                                                <font class="cinza1">Selecione o R&aacute;dio ou Grupo</font>
                                                <br />
