...
Public Class clsRespostaAdicional
    ...
    ''' </summary>
    Public Sub Gravar(ByVal vIDRespostaAdicional As Integer, ByVal vIDResposta As Integer, ByVal vTexto As String, ByVal vPreenchimento As Byte, ByVal vFormato As String)
