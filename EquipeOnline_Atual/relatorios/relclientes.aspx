<%@ Page Title="" Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="relclientes.aspx.vb" Inherits="relatorios_relclientes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="101%" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr class='Header2' align='left'> 
            <td>
                Relat&oacute;rio de O.S. por Cliente
            </td>
        </tr> 
	    <tr>
		    <td>
		        ...
		        <asp:GridView runat='server' ShowFooter='true' ID='grdRelatorio' AutoGenerateColumns='false' Width='100%' CssClass="GridView" >
		            ...
		            <Columns>
		                <asp:TemplateField HeaderText='Cliente' HeaderStyle-HorizontalAlign="Left">
		                    <ItemTemplate>
                                <a href='../home/default.aspx?cliente=<%#Eval("Cliente")%>&datainicial=<%=txtDataInicial.text%>&datafinal=<%=txtDataFinal.text%>'><%#Eval("Cliente")%></a>		                    
		                    </ItemTemplate>
		                </asp:TemplateField>
...
<asp:Content runat='server' ID='Content4' ContentPlaceHolderID='menuEsquerdo'>
    ...
    <dt class="current"><span lang="pt-br"><a href="relclientes.aspx">O.S por cliente</a> </span></dt>
