<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="mensagens.aspx.vb" Inherits="configuracoes_mensagens" title="Equipe Online" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<table width="101%" align="center">
        ...
        <tr>
            <td>
                <uc1:Paginate ID="Paginate1" runat="server" CausesValidation='False' />
            </td>
        </tr>
        <tr class="Header2">
            <td>
