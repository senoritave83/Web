<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="etapas.aspx.vb" Inherits="configuracoes_Etapas" title="Equipe Online" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Botoes" Runat="Server">    
    ...
    <asp:ImageButton id="btnSalvar" Runat="server" ImageUrl="../images/buttons/btn_salvar2.png"></asp:ImageButton>
</asp:Content>
