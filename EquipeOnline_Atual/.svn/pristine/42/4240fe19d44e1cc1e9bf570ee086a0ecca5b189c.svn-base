<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="respostas.aspx.vb" Inherits="configuracoes_respostas" title="Equipe Online" %>
