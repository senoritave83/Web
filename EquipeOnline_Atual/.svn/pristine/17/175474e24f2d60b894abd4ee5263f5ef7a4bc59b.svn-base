<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="responsaveis.aspx.vb" Inherits="configuracoes_responsaveis" title="Equipe Online" %>
    ...
    <table width="101%" align="center" class="resumo">        
        <tr style="height:30px;background-color:#DDDDDD;">
            ...
            <td style="width:150px;">
                R&aacute;dios Pendentes:&nbsp;<asp:label id="lblPendente" runat="server" Font-Bold="true"></asp:label>
            </td>
            <td style="width:150px;">
                R&aacute;dios Bloqueados:&nbsp;<asp:label id="lblBloqueado" runat="server" Font-Bold="true"></asp:label>
            </td>            
            <td style="width:150px;">
                R&aacute;dios Ativos:&nbsp;<asp:label id="lblAtivo" runat="server" Font-Bold="true"></asp:label>
            </td>
            <td style="width:150px;">
                R&aacute;dios sem Servi&ccedil;o:&nbsp;<asp:label id="lblSemServico" runat="server" Font-Bold="true"></asp:label>
            </td>
            <td>
                &nbsp;
            </td>
			...
			<td>
				<asp:Repeater Runat="server" EnableViewState="False" id="rptResponsaveis">                    
					<HeaderTemplate>						
	                    ...
	                    <tr class="Header2">
	                        <td>&nbsp;</td>
		                    <td><a href='javascript:void();' onclick="fncOrdenacao('Responsavel')">R&aacute;dio</a></td>
...
<asp:Content runat="server" ID='Content3' ContentPlaceHolderID="Ajuda">    
	<b>Novo:</b> Adicione um novo r&aacute;dio à lista de r&aacute;dios de Campo.<br />
    <b>Excluir:</b> Exclua um ou mais r&aacute;dios selecionados pelas caixas de sele&ccedil;&atilde;o.
</asp:Content>
