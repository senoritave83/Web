<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="pasta.aspx.vb" Inherits="home_pasta" title="Equipe Online" %>
		    ...
		    <td>
				<asp:GridView BorderStyle="None" BorderWidth="0" Runat="server" ID='dtgGrid' Width="100%" AutoGenerateColumns="False" AllowSorting="True" CssClass="GridView">					
					...
					<Columns>
						...
						<asp:TemplateField HeaderText='#OS' SortExpression='Numero' ItemStyle-Width="50" ItemStyle-HorizontalAlign="Left">
							<ItemTemplate>
								<%# Eval("ors_OrdemServico_chr")%>    
							</ItemTemplate>
						</asp:TemplateField>
						<asp:BoundField DataField='cli_Cliente_chr' HeaderText='Cliente' SortExpression='Cliente' ItemStyle-HorizontalAlign="Left" />
						<asp:BoundField ItemStyle-Width='150' DataField='ors_Inclusao_dtm' HeaderText='Criado em' SortExpression='Inclusao'  ItemStyle-HorizontalAlign="Left" />
						<asp:TemplateField HeaderText="R&#65533;dio"  ItemStyle-Width='150' SortExpression='Radio'  ItemStyle-HorizontalAlign="Left">
							<ItemTemplate>
...
<asp:Content runat='server' ID='Content2' ContentPlaceHolderID='Ajuda'>   
	<b>Enviar:</b> Envie a(s) Ordem(ns) de Servi&ccedil;o criada(s) diretamente para o(s) r&aacute;dio(s) da sua equipe de campo.
    <br />
