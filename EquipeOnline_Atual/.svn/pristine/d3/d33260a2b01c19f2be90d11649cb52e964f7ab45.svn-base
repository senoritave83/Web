<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="grupo_det.aspx.vb" Inherits="configuracoes_grupo_det" title="Equipe Online" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<table width="101%" align="center">
        ...
        <tr class="Header2">
            <td>
                Rádios
                <img src='../images/help.gif' alt='Seleciona os Rádios da Equipe de Campo que irão participar do grupo.' />
            </td>
        </tr>
		<tr>
			<td align="left">
...
<asp:Content runat='server' id='Content3' ContentPlaceHolderID='Ajuda'>
	<b>Salvar:</b> Salva as alterações efetuadas no Grupo de Rádios.<br />
</asp:Content>