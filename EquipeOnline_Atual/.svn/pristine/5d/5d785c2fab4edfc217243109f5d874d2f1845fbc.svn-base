...
Public Class clsOrdemServico
    ...
    Private m_strEnderecoOrigem As String
    Private m_strEnderecoDestino As String
    ...
    Private m_IdStatus As STATUS_ORDEMSERVICO
...
#Region "Propriedades"
    ...
    Public ReadOnly Property EnderecoOrigem() As String
        Get
            Return m_strEnderecoOrigem
        End Get
    End Property

    Public ReadOnly Property EnderecoDestino() As String
        Get
            Return m_strEnderecoDestino
        End Get
    End Property
    ...
    Public ReadOnly Property IdStatus() As STATUS_ORDEMSERVICO
        Get
            Return m_IdStatus
        End Get
    End Property
...
#End Region
    ...
    Protected Overridable Sub Inflate(ByRef dr As IDataReader)
        ...
        End If
        If dr.IsDBNull(dr.GetOrdinal("ors_Endereco_chr")) Then
            m_strEnderecoOrigem = ""
        Else
            m_strEnderecoOrigem = dr.GetString(dr.GetOrdinal("ors_Endereco_chr"))
        End If
        If dr.IsDBNull(dr.GetOrdinal("ors_EnderecoDestino_chr")) Then
            m_strEnderecoDestino = ""
        Else
            m_strEnderecoDestino = dr.GetString(dr.GetOrdinal("ors_EnderecoDestino_chr"))
        End If
        ...
        If dr.IsDBNull(dr.GetOrdinal("IdStatus")) Then
            m_IdStatus = 0
        Else
            m_IdStatus = dr.Item(dr.GetOrdinal("IdStatus"))
        End If
    ...
    Public Function EnviarOS(ByVal vCliente As String, ByVal vEndereco As String, _
                             ByVal vReferencia As String, ByVal vIDDestinatario As Integer, _
                             ByVal vObservacao As String, ByVal vTempoLimite As Integer, _
                             ByVal vIDPrioridade As Integer, ByVal vEnderecoDestino As String, _
                             ByVal vReferenciaDestino As String) As Boolean
        ...
        cmd.Parameters.Add("@ENDERECO", SqlDbType.VarChar, 150).Value = vEndereco
        cmd.Parameters.Add("@REFERENCIA", SqlDbType.VarChar, 150).Value = vReferencia
        ...
        cmd.Parameters.Add("@ENDERECODESTINO", SqlDbType.VarChar, 150).Value = vEnderecoDestino
        cmd.Parameters.Add("@REFERENCIADESTINO", SqlDbType.VarChar, 150).Value = vReferenciaDestino
        ExecuteNonQuery(cmd)
        Return True
    End Function
    ...
    Public Function AgendarOS(ByVal vCliente As String, ByVal vEndereco As String, ByVal vReferencia As String, _
                              ...
                              ByVal vDataEnvio As Date, ByVal vIDPrioridade As Integer, ByVal vEnderecoDestino As String, _
                             ByVal vReferenciaDestino As String) As Boolean
    ...
    Public Function AgendarOS(ByVal vCliente As String, ByVal vEndereco As String, ByVal vReferencia As String, _
                              ByVal vIDDestinatario As Integer, ByVal vObservacao As String, ByVal vTempoLimite As Integer, _
                              ByVal vNome As String, ByVal vDias As Integer, ByVal vMeses As Integer, _
                              ByVal vDiasSemana As Integer, ByVal vTipoFrequencia As Integer, _
                              ByVal vHoraExecucao As Integer, ByVal vHoraFinal As Integer, ByVal vIntervalo As Integer, _
                              ByVal vDataInicio As String, ByVal vDataFinal As String, ByVal vIDPrioridade As Integer) As Boolean
