<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="contingencia.aspx.vb" Inherits="configuracoes_contingencia" title="Equipe Online" %>
	...
	<table width="101%" align="center">                    
		...
		<tr>
			<td style="text-align:justify;padding:10px 10px 10px 10px; font-size: 9pt; height: 90px; line-height:16px">					
				...
				r&aacute;dios das Equipes de Campo ir&atilde;o apenas receber Recados Digitais 
