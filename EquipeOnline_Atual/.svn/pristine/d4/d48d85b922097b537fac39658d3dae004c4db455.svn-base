...
#Region "Metodos"
    ...
    Public Sub Update()
        ...
        cmd.Parameters.Add("@NOMEUSUARIO", SqlDbType.VarChar, 50).Value = Identity.Nome
    ...
    Protected Overrides Function CheckIfSubClassIsValid() As Boolean
        ...
        If strServices.Contains("EQLOC") = False And strServices.Contains("EQON") = False And emp.Verifica = True And strServices <> "" Then
            blnValid = False
            AddBrokenRule("O Serviço do Equipe Online não está habilitado para o rádio informado!")
        ElseIf strServices <> "" Then
            m_indAtivo = 1
        End If
        If Existe(m_strTelefone) Then
            blnValid = False
            AddBrokenRule("O rádio informado já está cadastrado em outra conta do Equipe Online!")
        End If
