<%@ Page Title="" Language="VB" MasterPageFile="~/Imprimir.master" AutoEventWireup="false" CodeFile="relsla_prn.aspx.vb" Inherits="relatorios_relsla_prn" %>
		    ...
		    <td>
		        <asp:GridView runat='server' ShowFooter='true' ID='grdRelatorio' AutoGenerateColumns='false' Width='100%' CssClass="GridView">
		            ...
		            <Columns>
		                ...
		                <asp:BoundField DataField='Abaixo50SLA' HeaderText='Abaixo de 50%' HeaderStyle-HorizontalAlign="Left" />
		                <asp:BoundField DataField='DentroSLA' HeaderText='Dentro do SLA' HeaderStyle-HorizontalAlign="Left" />
