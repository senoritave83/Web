<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="responsavel_det.aspx.vb" Inherits="configuracoes_responsavel_det" title="Equipe Online" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<script type="text/javascript">
       function fncConfirm() {
           if (confirm("Tem certeza que deseja excluir o rádio do sistema?") == true)
               return true
           else
               return false
       }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Botoes" Runat="Server">
    ...
    <asp:ImageButton id="btnSalvar" runat="server" ImageUrl="../images/buttons/btn_salvar2.png" CssClass="botao"></asp:ImageButton>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Ajuda" Runat="Server">
	<asp:PlaceHolder runat="server" ID='plhNovo'><b>Novo:</b>  Cadastre um novo rádio. <br /></asp:PlaceHolder>
    <asp:PlaceHolder runat="server" ID='plhSalvar'><b>Salvar:</b>  <asp:Literal runat="server" ID='ltrSalvar'>Salva o registro atual na Lista de rádios. </asp:Literal> <br /></asp:PlaceHolder>
    <asp:PlaceHolder runat="server" ID='plhExcluir'><b>Excluir:</b> Exclua este registro da Lista de rádios.</asp:PlaceHolder>
</asp:Content>
