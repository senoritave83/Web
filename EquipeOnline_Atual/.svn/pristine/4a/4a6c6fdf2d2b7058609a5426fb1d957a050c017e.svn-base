<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="clientesdet.aspx.vb" Inherits="configuracoes_clientesdet" title="Equipe Online" %>
