...
Partial Class inicio_registro
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        If oEmpresa.IDEmpresa > 0 Then
            ...
            SendEmailConfirmacao(oEmpresa.IDEmpresa, txtUsuario.Text, strSubject, txtEmail.Text, AppSettings("FromC"), strMsg)

            'Dim mail As New MailMessage(AppSettings("FromC"), txtEmail.Text, "Tipo 2 " & strSubject, strMsg)
