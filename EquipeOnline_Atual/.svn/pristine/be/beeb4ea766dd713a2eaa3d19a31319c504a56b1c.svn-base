<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="mensagemdet.aspx.vb" Inherits="configuracoes_mensagemdet" title="Equipe Online" %>
