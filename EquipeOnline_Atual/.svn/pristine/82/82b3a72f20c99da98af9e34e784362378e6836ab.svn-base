...
Public Class clsConfig
    ...
    Protected m_blnOrigemDestino As Boolean
    Protected m_blnModuloJava As Boolean
    Protected m_intCopiarEnderecoOrigemDestino As Integer
    ...
    Public Property OrigemDestino() As Boolean
        Get
            Return m_blnOrigemDestino
        End Get
        Set(ByVal Value As Boolean)
            m_blnOrigemDestino = Value
        End Set
    End Property

    Public Property CopiarEnderecoOrigemDestino() As Integer
        Get
            Return m_intCopiarEnderecoOrigemDestino
        End Get
        Set(ByVal Value As Integer)
            m_intCopiarEnderecoOrigemDestino = Value
        End Set
    End Property
    ...
    Protected Overridable Sub Inflate(ByVal dr As IDataReader)
        ...
        End If
        If dr.IsDBNull(dr.GetOrdinal("cfg_OrigemDestino_ind")) Then
            m_blnOrigemDestino = False
        Else
            m_blnOrigemDestino = IIf(dr.GetByte(dr.GetOrdinal("cfg_OrigemDestino_ind")) = 1, True, False)
        End If
        If dr.IsDBNull(dr.GetOrdinal("cfg_CopiarEndereco_ind")) Then
            m_intCopiarEnderecoOrigemDestino = 2
        Else
            m_intCopiarEnderecoOrigemDestino = dr.Item(dr.GetOrdinal("cfg_CopiarEndereco_ind"))
        End If
    ...
    Public Sub Update()
        ...
        cmd.Parameters.Add("@cfg_OrigemDestino_ind", SqlDbType.TinyInt).Value = IIf(m_blnOrigemDestino = True, 1, 0)
        cmd.Parameters.Add("@cfg_CopiarEndereco_ind", SqlDbType.Int).Value = m_intCopiarEnderecoOrigemDestino
