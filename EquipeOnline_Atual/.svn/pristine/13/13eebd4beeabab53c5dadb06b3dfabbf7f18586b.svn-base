...
<HTML>
	...
	<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" scroll="no" style='background-color:White' style=" width:98%*">
                    ...
                    <thead > 
                        ...
                        <tr class="Header2"> 
                            ...
                            <td style="width:115px;height:20px; background-color:<%#IIf(ViewState("Sort") = "Responsavel","#ECEEE7","")%>">
                                <a href='#' onclick="fncOrdenacao('Responsavel')">Rádio</a>
