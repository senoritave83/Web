...
Partial Class home_OrdemServico
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            cls.Load(intIDOS)
            'btnReenviar.Visible = Not (cls.IdStatus = clsOrdemServico.STATUS_ORDEMSERVICO.Agendada)
            Inflate()
            BindRespostas()
            BindEtapas()
        End If
    ...
    Protected Sub Inflate()
        ...
        With cls
            ...
            lblEndereco.Text = .EnderecoOrigem
            lblEnderecoDestino.Text = .EnderecoDestino
        End With

        Dim cfg As New clsConfig()
        trEnderecoDestino.Visible = cfg.OrigemDestino
        If cfg.OrigemDestino Then
            ltEnderecoCaption.Text = "Endereço de Origem:"
        Else
            ltEnderecoCaption.Text = "Endereço:"
        End If
        cfg = Nothing
