...
Public Class PaginateResult
    ...
    Protected m_objDataSet As DataSet
    ...
    Public Property RecordCount() As Integer Implements IPaginaResult.RecordCount
        ...
        Set(ByVal value As Integer)
            ...
            m_intPageCount = m_intRecordCount \ m_intPageSize
            If m_intPageCount < m_intCurrentPage Then
                m_intCurrentPage = m_intPageCount
            End If
        End Set
    End Property
    ...
    Public Property DataSet() As System.Data.DataSet Implements IPaginaResult.DataSet
        Get
            Return m_objDataSet
        End Get
