<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="calendario.aspx.vb" Inherits="home_calendario"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td style="*display:inline">
            <table width="100%">
                <tr>
                    <td width="33%" style="border:1px #D7D2CB solid; *vertical-align:top; background-color:#FFFFFF;">
                    ...
                    <td style="padding:0 1px 0 1px; border:1px #D7D2CB solid; background-color:#FFFFFF; *vertical-align:top; width:33%; ">
                    ...
                    <td style="border:1px #D7D2CB solid; background-color:#FFFFFF; *vertical-align:top" width="33%">
        ...
        <td style="padding-left:5px; *padding-left:0px; vertical-align:top;width:15%; background-color:#FFFFFF;">
