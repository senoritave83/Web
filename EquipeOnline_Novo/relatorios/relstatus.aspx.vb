...
Partial Class relatorios_relstatus
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If cboTipoGrafico.SelectedValue = "Tabular" Then
            ...
            ds = cls.GetReport_Status(txtDataInicial.Text, txtDataFinal.Text)
        ...
        Else
            ...
            If cboTipoGrafico.SelectedValue = "Linhas" Then
                ds = cls.GetReport_Status_Linha(txtDataInicial.Text, txtDataFinal.Text)
            ...
            MakeChart(ds, cboTipoGrafico.SelectedItem.Value, chartEOL, "O.S. por Status")

        End If

        Dim strScript As String = "<scrip" & "t type='text/javascript'>" & vbCrLf
        strScript &= "          function printReport(){" & vbCrLf
        strScript &= "            var win = window.open('relstatus_prn.aspx?tp=" & cboTipoGrafico.SelectedItem.Value & _
                                                                    "&di=" & txtDataInicial.Text & _
                                                                    "&df=" & txtDataFinal.Text & "','IMPRIMIR_RELATORIO_STATUS','width=950, height=600,status=no,scrollbars=yes,toolbar=no,top=20,left=20');" & vbCrLf
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnExportar.Click
        ...
        cls = New clsRelatorio()
        Dim dsExcel As DataSet = cls.GetReport_Status(txtDataInicial.Text, txtDataFinal.Text)
        ...
        If Not dsExcel Is Nothing Then
            ...
            Response.Clear()
            Response.AddHeader("Content-Disposition", "attachment; filename=Relatorio_OS_por_Status_" & Now().ToString("yyyyMMdd-hhmmss") & ".xlsx")
