<%@ Page Title="" Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="relradios.aspx.vb" Inherits="relatorios_relradios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="101%" border="0" align="left" cellpadding="0" cellspacing="0">      
        ...
        <tr class='Header2' align='left'> 
            <td>
                Relat&oacute;rio de O.S. por Respons&aacute;vel
            </td>
        </tr> 
	    <tr>
		    <td>
...
<asp:Content runat='server' ID='Content4' ContentPlaceHolderID='menuEsquerdo'>
    ...
    <dt class="current"><span lang="pt-br"><a href="relradios.aspx">O.S por Respons&aacute;vel</a></span></dt>
