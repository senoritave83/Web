...
Partial Class relatorios_relradios
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If cboTipoGrafico.SelectedValue = "Tabular" Then
            ...
            ds = cls.GetReport_Responsavel(txtDataInicial.Text, txtDataFinal.Text)
        ...
        Else
            ...
            If cboTipoGrafico.SelectedValue = "Linhas" Then
                ds = cls.GetReport_Responsavel_Linha(txtDataInicial.Text, txtDataFinal.Text)
        ...
        strScript &= "            var win = window.open('relradios_prn.aspx?tp=" & cboTipoGrafico.SelectedItem.Value & _
                                                                    "&di=" & txtDataInicial.Text & _
                                                                    "&df=" & txtDataFinal.Text & "','IMPRIMIR_RELATORIO_RADIOS','width=950, height=600,status=no,scrollbars=yes,toolbar=no,top=20,left=20');" & vbCrLf
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnExportar.Click
        ...
        cls = New clsRelatorio()
        Dim dsExcel As DataSet = cls.GetReport_Responsavel(strDataInicial, strDataFinal)
        ...
        If Not dsExcel Is Nothing Then
            ...
            Response.Clear()
            Response.AddHeader("Content-Disposition", "attachment; filename=Relatorio_OS_por_Radio_" & Now().ToString("yyyyMMdd-hhmmss") & ".xlsx")
