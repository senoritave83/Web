<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="reenviar.aspx.vb" Inherits="home_reenviar" title="Gestor de O.S" %>
        ...
        <tr>
	        <td align="left">	
		        <table border='0' width="100%">
			        <tr>
				        <td style="padding-left:10px; width: 101px;">Enviar para o respons&aacute;vel:</td>
				        <td align="left">				       
...
<asp:Content ID="Content3" ContentPlaceHolderID="Ajuda" Runat="Server">
	&bull; <b>Enviar:</b> Selecione o respons&aacute;vel para qual deseja enviar a O.S.<br />
</asp:Content>