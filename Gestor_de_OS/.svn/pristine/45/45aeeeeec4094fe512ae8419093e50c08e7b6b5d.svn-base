    ...
    function hora(v) {
        ...
        document.getElementById('<%=txtTempoLimite.clientID%>').value = v
                ...
                <table border="0" cellpadding='3' cellspacing='2' align="left" style="*float:left;">
					<tr>
						<td class="cinza1" align="right"><asp:Literal ID="Literal1" runat="server" Text='<%$Settings: Caption, EnviodeOS.Cliente, "Cliente" %>'> </asp:Literal><asp:RequiredFieldValidator id="valCliente" Runat="server" ControlToValidate="txtCliente">*</asp:RequiredFieldValidator></td>
					...
					<tr>
						<td class="cinza1" align='right'> <asp:Literal ID="Literal4" runat="server" Text='<%$Settings: Caption, EnviodeOS.Endereco, "Endereco" %>'></asp:Literal></td>
					...
					<tr>
						<td class="cinza1" align='right'> <asp:Literal ID="Literal5" runat="server" Text='<%$Settings: Caption, EnviodeOS.LocalRef, "Local de Referência" %>'></asp:Literal></td>
						<td height="20" class="cinza1"><asp:TextBox id="txtReferencia" onkeyup="return checkSize();" Runat="server" Width="350"></asp:TextBox></td>
					</tr>
					<tr>
						<td class="cinza1" align='right'>  <asp:Literal ID="Literal3" runat="server" Text='<%$Settings: Caption, EnviodeOS.Responsavel, "Responsavel" %>'></asp:Literal>
                    ...
                    <tr>
                        <td class="cinza1"  align='right'><asp:Literal ID="Literal2" runat="server" Text='<%$Settings: Caption, EnviodeOS.Prioridade, "Prioridade" %>'></asp:Literal></td>
                ...
                <table width="100%" border="0" cellpadding='2'>
					<tr>
						<td align="left" class="cinza1" id="tdDsc"  runat="server" width='480px'><asp:Literal ID="Literal6" runat="server" Text='<%$Settings: Caption, EnviodeOS.Descricao, "Descrição" %>'></asp:Literal><br />
						...
						<td class="cinza1" id="tdMsg" runat="server" align="left"><asp:Literal ID="Literal7" runat="server" Text='<%$Settings: Caption, EnviodeOS.Mensagem, "Mensagem Padrão" %>'></asp:Literal><br />
