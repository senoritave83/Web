    ...
    <asp:PlaceHolder Runat="server" ID='plhNova' Visible="True">
		...
		<table cellpadding="0" width="101%">
            ...
            <tr align="left">
                ...
                <td runat="server" id="tdGPS" align="left" valign="top" style="width:910px;">
                    <asp:CheckBox runat="server" ID="chkCapPosGPS" />
                    Capturar posição via GPS
                    <img alt="Grava a posição física do usuário em campo." src="../images/help.gif" align="bottom" />
                </td>
            </tr>
            <tr class='Footer1'> 
