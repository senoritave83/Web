...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="101%" border="0" align="center" cellpadding="0" cellspacing="0">        
        ...
        <tr class='Header2' align='left'> 
            <td>
                Relat&oacute;rio de Performance por respons&aacute;vel.
            </td>
        </tr> 
	    <tr>
		    <td>
...
<asp:Content runat='server' ID='Content4' ContentPlaceHolderID='menuEsquerdo'>
    ...
    <dt class="current"><span lang="pt-br"><a href="relperformance.aspx">Performance por respons&aacute;vel</a> </span></dt>
