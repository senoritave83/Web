<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="agenda.aspx.vb" Inherits="home_agenda" title="Gestor de O.S" %>
					...
					<tr class="Header2">
						...
						<td align="right" width="30%">
							<asp:LinkButton Runat="server" ID="lnkNext">
								<font color="White">Pr�ximo &gt; &gt;</font></asp:LinkButton>&nbsp;
						</td>
					</tr>
				</table>
