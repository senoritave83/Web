<%@ Page Language="VB" MasterPageFile="~/Principal2.master" AutoEventWireup="false" CodeFile="OrdemServico.aspx.vb" Inherits="home_OrdemServico" title="Gestor de O.S" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<table width="101%" align="center">
	    ...
	    <tr>
		    <td>	
			    <table width="98%" style="text-align:left;margin-top:5px" border="0">
				    <tr valign="top" class="Header">
                        ...
                        <td rowspan="8" align="center">
                            Anexo:
                            <br />
                            <asp:Image runat="server" ID="imgOS" ImageUrl="~/images/FotosOS/noimage.png" Width="200" />
                        </td>
				    </tr>
				    <tr>
					    <td class="cinza1">
				    ...
				    <tr>
					    <td class="cinza1">Respons&aacute;vel:
                    ...
                    <tr>
					    <td class="cinza1">Prioridade:
                            ...
                            <asp:DropDownList  CssClass="ui-select" ID="cboPrioridade" runat='server' Visible="false" Width="110px">
                                ...
                                <asp:ListItem Text='M&#65533;dia' Value='2'></asp:ListItem>
                    ...
                    <tr>
                        <td class="cinza1" runat="server" id="tdGPS">
                            <asp:CheckBox runat="server" ID="chkCapPosGPS" Enabled="false" />
        ...
        <asp:PlaceHolder runat='server' ID='plhHistorico'>
            ...
            <tr runat="server" ID="trlnkFotos">
                <td style="text-align:right; padding-top:10px; color:Black; font-size:13px;">
                    <a href="OrdemServicoFotos.aspx?idos=<%=ViewState(VW_IDOS)%>"><b><u>Fotos das Respostas</u></b></a>
                </td>
            </tr>
	        <tr>
		        <td>	
