...
Partial Class home_novaordem
    ...
    Protected Sub btnEnviar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnEnviar.Click
        clsOs.EnviarOS(os_editor1.Cliente, os_editor1.Endereco, os_editor1.Referencia, os_editor1.IDDestinatario, os_editor1.Observacao, os_editor1.TempoLimite, os_editor1.IDPrioridade, ViewState("FileName"), chkCapPosGPS.Checked)
        Response.Redirect("default.aspx")
    End Sub
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnGuardar.Click
        clsOs.GuardarOS(os_editor1.Cliente, os_editor1.Endereco, os_editor1.Referencia, os_editor1.IDDestinatario, os_editor1.Observacao, os_editor1.TempoLimite, os_editor1.IDPrioridade, ViewState("FileName"), chkCapPosGPS.Checked)
        Response.Redirect("default.aspx")
    End Sub
