            ...
            <td>
                <br />
		         <table width="100%" style="text-align:left;">
                    <tr>
                        <td>
                            <font class='cinza1'><asp:Literal ID="Literal1" runat="server" Text='<%$Settings: Caption, exportar.cliente, "Cliente" %>'></asp:Literal>
</font>
                            <br/>
                            <uc2:SelectCliente ID="SelectCliente1" runat="server" />
                        </td>
                        <td>
                            <font class='cinza1'><asp:Literal ID="Literal2" runat="server" Text='<%$Settings: Caption, exportar.Responsavel, "Responsável" %>'></asp:Literal></font>
                            <br />
                            <uc3:SelectResponsaveis ID="SelectResponsaveis1" runat="server" />
                        </td>
                        <td>
                            <font class='cinza1'><asp:Literal ID="Literal3" runat="server" Text='<%$Settings: Caption, exportar.Status, "Status" %>'></asp:Literal></font>
                            <br />
                    ...
                    <tr>
                        <td>
                            <font class='cinza1'><asp:Literal ID="Literal4" runat="server" Text='<%$Settings: Caption, exportar.De, "De" %>'></asp:Literal></font>
                            <br />
                            <uc4:MaskFormater ID="txtDataInicial" runat="server" Width="140px" MaxLength='10' cssclass="formulario"/>
                        </td>
                        <td>
                            <font class='cinza1'><asp:Literal ID="Literal5" runat="server" Text='<%$Settings: Caption, exportar.Ate, "Até" %>'></asp:Literal></font>
                            <br />
