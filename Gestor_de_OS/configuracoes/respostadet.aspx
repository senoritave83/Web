            ...
            <td>
                <table>
		            <tr>
                        ...
                        <td align="left">Resposta múltipla</td>
		            </tr>
		            <tr>
                        ...
                        <td>
                            <asp:CheckBox runat="server" ID="chkRespMultiplaObs" />
                        </td>
		            </tr>			                        
                </table>
            </td>
			...
			<td>
			    <table>
			        <tr>
                        ...
                        <td align="left" style="padding-left:10px;">Resposta múltipla</td>
			            <td></td>
			        </tr>
			        <asp:Repeater ID="rptAdicionais" Runat="server" >
				        <ItemTemplate>
					        <tr>
						        ...
						        <td style="padding:0px 10px 0px 10px;text-align:left;">
                                    <uc1:FormatOption ID="ctrFormato" runat="server" Formato='<%#Eval("Formato") %>' />
                                </td>
                                <td>
                                    <asp:CheckBox runat="server" ID="chkRespMultipla" Checked='<%#Eval("RespostaMultipla") %>' />
                                </td>
						        <td>
			        ...
			        <tr>
                        ...
                        <td>
                            <asp:CheckBox runat="server" ID="chkRespMultiplaNova" />
                        </td>
			            <td>
