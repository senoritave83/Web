...
Partial Class configuracoes_respostadet
    ...
    Protected Sub inflate()
        ...
        chkRespMultiplaObs.Checked = cls.RespostaMultipla
    End Sub
    ...
    Protected Sub btnAdicionar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnAdicionar.Click
        rad.Gravar(0, cls.IDResposta, txtTextoNovo.Text, cboOpcaoNovo.SelectedValue, fopFormatoNovo.Formato, chkRespMultiplaNova.Checked)
        BindGrid()
        txtTextoNovo.Text = ""
    ...
    Protected Sub btnSalvar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSalvar.Click
        For Each item As RepeaterItem In rptAdicionais.Items
            If item.ItemType = ListItemType.AlternatingItem Or item.ItemType = ListItemType.Item Then
                ...
                Dim chkRespMultipla As CheckBox = item.FindControl("chkRespMultipla")

                rad.Gravar(intIDRespostaAdicional, cls.IDResposta, txt.Text, cbo.SelectedValue, ctrFormato.Formato, chkRespMultipla.Checked)
            End If
        Next
        cls.GravarOpcaoObservacao(cboOpcaoObs.SelectedValue, ctrFormatoObs.Formato, chkRespMultiplaObs.Checked)
        inflate()
        BindGrid()
    End Sub
