...
Partial Class controls_RoteiroPorPeriodo
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            With CType(Page, XMWebPage)
                btnGravar.Enabled = IIf(ViewState("IDSTATUSPROMOTOR") = 0, False, .VerificaPermissao(.Secao, ACAO_EDITAR))
    ...
    Protected Sub BindGrid()
        ...
        'Dim dsHoras As System.Data.SqlClient.SqlDataReader = rot.ListarHoras()

        'm_strComboInterno = "<option value=''></option>"
        'Do While dsHoras.Read
        '    m_strComboInterno &= "<option value='" & dsHoras("hro_Hora_chr") & "'>" & dsHoras("hro_Hora_chr") & "</option>"
        'Loop
        'dsHoras.Dispose()
        'rot = Nothing
        ...
        Try
            ...
            'drIdLojas = r.ListarLojas(ViewState(VW_IDPROMOTOR))
            'Dim i As Integer = drIdLojas.RecordsAffected
            'Dim arrLojas(drIdLojas.Read()) As Integer
            'Do While drIdLojas.Read()
            '    arrLojas(i) = drIdLojas("IDLoja")
            '    i += 1
            'Loop
            'ViewState("IdLojas") = arrLojas
            'drIdLojas.Close()
            'drIdLojas.Dispose()
            'drIdLojas = Nothing
    ...
    Protected Sub CarregaCombo(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        ...
        '    Dim td As Literal = e.Item.FindControl("ltTeste")
    ...
    Protected Sub ProcurarLojas()
        ...
        Dim ret As PaginateResult = loj.Listar(txtProcurarLoja.Text, 0, cboUF.Text, cboIDTipoLoja.SelectedValue, 0, cboIDRegiao.SelectedValue, "", False, Paginate1.CurrentPage, PAGESIZE, txtProcurarCidade.Text, clsLoja.STATUS_LOJA.ATIVO)
    ...
    Protected Sub btnImportRoteiro_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnImportRoteiro.Click
        ...
        Dim promo As New clsUsuario()
        cboIDPromotor.DataSource = promo.ListarUsuariosMobile()
    ...
    Protected Sub validacaoDatasCopiaRoteiro(ByVal sender As Object, ByVal args As ServerValidateEventArgs)
        ...
        Else
            ...
            args.IsValid = Not (iDias <> iDiasImp)
        End If
    ...
    Protected Sub btnCancelarCopiaRoteiro_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancelarCopiaRoteiro.Click
        ...
        plhImportarRoteiro.Visible = False
        btnGravar.Visible = IIf(ViewState("IDSTATUSPROMOTOR") = 0, False, True)
        plhLojas.Visible = IIf(ViewState("IDSTATUSPROMOTOR") = 0, False, True)
