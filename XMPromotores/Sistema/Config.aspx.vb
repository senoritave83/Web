...
Partial Public Class Sistema_Config
    ...
    Protected Sub Inflate()
        ...
        txtPrecoVisita.Text = cls.ExibirPreco
        txtCodigoBarras.Text = cls.ExibirCodigoBarras
    End Sub

    Protected Sub Deflate()
        cls.Performance = txtPerformance.Text
        cls.ExibirPreco = txtPrecoVisita.Text
        cls.ExibirCodigoBarras = txtCodigoBarras.Text
    End Sub
