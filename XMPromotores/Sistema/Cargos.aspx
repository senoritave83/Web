<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="Cargos.aspx.vb" Inherits="Pages.Cadastros.Cargos" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true' CellPadding="1" CellSpacing="1" >
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDCargo" DataNavigateUrlFormatString="Cargo.aspx?IDCargo={0}" DataTextField="Cargo" HeaderText="Cargo" SortExpression="Cargo"  />
                        <asp:BoundField DataField='Superior' HeaderText='Superior' SortExpression='Superior' />
                        <asp:BoundField DataField='Modulos' HeaderText='Acesso' SortExpression='Modulos' />
					</columns>
					<EmptyDataTemplate>
				        <div class='GridHeader'>&nbsp;</div>					    
					    <div class='divEmptyRow'>
							<asp:Label runat='server' ID='lblNaoEncontrados'>
								N&atilde;o h&aacute; Cargos com o filtro selecionado!
							</asp:Label>
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
