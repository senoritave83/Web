...
Partial Class reports_mapa_popup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            Dim ds As System.Data.DataSet = rep.GetMapaRelatorio(CInt(Request("IDEvento")))
                        ...
                        For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                            ...
                            If i < intQuant Then
                                ...
                                If ds.Tables(0).Rows(i).Item("IdPosicao") = 1 Then
                                    seq.IconURL = "http://labs.google.com/ridefinder/images/mm_20_green.png"
                                Else
