<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="MotivoFolgas.aspx.vb" Inherits="Pages.Cadastros.MotivoFolgas" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true' CellPadding="1" CellSpacing="1">
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDMotivoFolga" DataNavigateUrlFormatString="MotivoFolga.aspx?IDMotivoFolga={0}" DataTextField="MotivoFolga" HeaderText="Motivo de Aus&ecirc;ncia" SortExpression="MotivoFolga"  />
					</columns>
					<EmptyDataTemplate>
				        <div class='GridHeader'>&nbsp;</div>					    
					    <div class='divEmptyRow'>
							<asp:Label runat='server' ID='lblNaoEncontrados'>
								N&atilde;o h&aacute; Motivos de Aus&ecirc;ncia com o filtro selecionado!
							</asp:Label>
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
