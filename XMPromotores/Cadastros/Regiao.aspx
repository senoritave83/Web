		...
		<table id='tblEditArea'>
			...
			<tr class='trField'>
				<td class='tdFieldHeader'>
                    <asp:Literal ID="Literal1" runat="Server" Text='<%$Settings: Caption, Regiao, "Região"%>'></asp:Literal>:				
				</td>
				<td class='tdField'>
					<asp:TextBox runat='server' ID='txtRegiao' MaxLength='50' CssClass="formulario" Width="170px" />
					<asp:RequiredFieldValidator runat='server' ID='valReqRegiao' Display='None' ErrorMessage='Região é um campo obrigatório!' ControlToValidate='txtRegiao' />
				</td>
			</tr>
			<tr class='trField'>
				<td class='tdFieldHeader'>
