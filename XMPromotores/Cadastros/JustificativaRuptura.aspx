    ...
    <div class='EditArea'>
		<table id='tblEditArea'>
            ...
            <tr class='trField'>
				...
				<td class='tdField'>
					<asp:TextBox runat='server' ID='txtJustificativaRuptura' MaxLength='50' Width='400px' CssClass="formulario" />
            ...
            <tr class='trField'>
				...
				<td class='tdField'>
					<asp:DropDownList runat='server' ID='cboConcorrenteMostrar' CssClass="Select" >
