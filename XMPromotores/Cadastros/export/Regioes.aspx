<%@ Page Language="VB" MasterPageFile="~/Cadastros/export/export.master" AutoEventWireup="false" CodeFile="Regioes.aspx.vb" Inherits="Pages.Cadastros.export.Regioes" title="XM Promotores - Yes Mobile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView runat='server' ID='grdExportar' SkinID='GridExportar' EnableViewState='false' AutoGenerateColumns='false'>
        ...
        <Columns>
        	<asp:BoundField HeaderText="IDRegiao" DataField="IDRegiao" ItemStyle-CssClass="xl28" />
