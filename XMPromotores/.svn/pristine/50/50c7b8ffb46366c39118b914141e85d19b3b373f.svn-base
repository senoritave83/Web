...
Namespace Pages.Cadastros
    ...
    Partial Class Cadastros_TiposEvento
        Inherits XMWebPage
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                drpStatus.Items.Insert(0, New ListItem("Ativo", 1))
                drpStatus.Items.Insert(1, New ListItem("Inativo", 0))
                drpStatus.Items.Insert(2, New ListItem("Apagado", 2))
                drpStatus.SelectedValue = 1

                Me.RecuperaFiltro(txtFiltro, drpStatus, Letras1, Paginate1)
                BindGrid()
            End If
        End Sub

        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, drpStatus.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, drpStatus, Letras1, Paginate1)
        End Sub
