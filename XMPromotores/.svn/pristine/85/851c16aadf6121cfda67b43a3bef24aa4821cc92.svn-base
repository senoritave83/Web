...
#Region "Metodos"
        ...
        Public Sub Update()
            ...
            Me.User.Log("Visitas", "Gravar - IDVISITA=" & m_intIDVisita & " IDLOJA=" & m_intIDLoja & " IDPROMOTOR=" & m_intIDPromotor & " DATAINICIO=" & _
                    ...
                    " IDMOTIVOUSOFORM=" & m_indIdMotivoUsoFormulario & " TESTE=" & m_indTeste)
        ...
        ''' <param name="vReturnType">Tipo de retorno (DataReader ou DataSet)</param>		
        ''' <returns>Retorna um objeto DataReader ou DataSet de acordo com o parâmetro de solicitação</returns>
        Public Function ListarVisitasFotos(ByVal vFilter As String, ByVal vIdCliente As Integer, ByVal vDataInicial As String, _
                               ByVal vDataFinal As String, ByVal vIdCargo As Integer, ByVal vIdUsuarios As String, _
                               ByVal vTipoEntidade As String, ByVal vOrder As String, ByVal vDescending As Boolean, ByVal vPage As Integer, _
                               ByVal vPageSize As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As PaginateResult

            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_VISITAS_FOTOS"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@FILTRO", SqlDbType.VarChar, 255).Value = vFilter
            cmd.Parameters.Add("@IDCLIENTE", SqlDbType.Int).Value = vIdCliente
            If Not vDataInicial = "" Then cmd.Parameters.Add("@DATAINICIAL", SqlDbType.DateTime).Value = vDataInicial
            If Not vDataFinal = "" Then cmd.Parameters.Add("@DATAFINAL", SqlDbType.DateTime).Value = vDataFinal
            cmd.Parameters.Add("@IDCARGO", SqlDbType.Int).Value = vIdCargo
            cmd.Parameters.Add("@IDUSUARIOS", SqlDbType.VarChar, 1000).Value = vIdUsuarios
            cmd.Parameters.Add("@TIPOENTIDADE", SqlDbType.VarChar, 20).Value = vTipoEntidade
        ...
        ''' <param name="vReturnType">Tipo de retorno (DataReader ou DataSet)</param>		
        ''' <returns>Retorna um objeto DataReader ou DataSet de acordo com o parâmetro de solicitação</returns>
        Public Function ListarFotos(ByVal vIdVisita As Integer, ByVal vTipoEntidade As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object

            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_FOTOS_VISITA"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = vIdVisita
        ...
        ''' <param name="vReturnType">Tipo de retorno (DataReader ou DataSet)</param>		
        ''' <returns>Retorna um objeto DataReader ou DataSet de acordo com o parâmetro de solicitação</returns>
        Public Function ListarTipoEntidades(ByVal vIdVisita As Integer, ByVal vTipoEntidade As String, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object

            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_TIPOENTIDADES_VISITA"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = vIdVisita
            cmd.Parameters.Add("@TIPOENTIDADE", SqlDbType.VarChar, 20).Value = vTipoEntidade
            Return MyBase.ExecuteCommand(cmd, vReturnType)
        ...
        ''' <param name="vIdUsuarios">Usuários selecionados na lista</param>
        ''' <param name="vSubordinados">define se o resultado deve ser apenas dos usuário selecionados, somente dos subordinados ou ambos</param>
        ...
        Public Function Listar(ByVal vFilter As String, ByVal vIdUsuarios As String, ByVal vSubordinados As Integer, ByVal vDataInicial As String, _
                               ByVal vDataFinal As String, ByVal vIDTipoJustificativa As Integer, ByVal vTeste As Short, ByVal vOrder As String, ByVal vDescending As Boolean, ByVal vPage As Integer, _
                               ByVal vPageSize As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As PaginateResult
            ...
            cmd.Parameters.Add("@SUBORDINADOS", SqlDbType.Int).Value = vSubordinados
            cmd.Parameters.Add("@USUARIOS", SqlDbType.VarChar, 8000).Value = vIdUsuarios
        ...
        ''' <param name="vPageSize">Tamanho da página em registros</param>		
        ''' <returns>PaginateResult</returns>
        Public Function Listar(ByVal vFilter As String, ByVal vIdCargo As Integer, ByVal vIDSuperior As String, ByVal vIDPromotor As String, ByVal vDataInicial As String, _
                               ByVal vDataFinal As String, ByVal vIDTipoJustificativa As Integer, ByVal vTeste As Short, ByVal vOrder As String, ByVal vDescending As Boolean, ByVal vPage As Integer, _
                               ByVal vPageSize As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As PaginateResult
            ...
            cmd.Parameters.Add("@FILTRO", SqlDbType.VarChar, 100).Value = vFilter
            cmd.Parameters.Add("@IDCARGO", SqlDbType.Int).Value = vIdCargo
            cmd.Parameters.Add("@IDSUPERIOR", SqlDbType.VarChar, 8000).Value = vIDSuperior
            cmd.Parameters.Add("@IDPROMOTOR", SqlDbType.VarChar, 8000).Value = vIDPromotor
            If vDataInicial <> "" Then
                cmd.Parameters.Add("@DATAINICIAL", SqlDbType.DateTime).Value = _setDateTimeDBValue(vDataInicial)
            End If
            If vDataFinal <> "" Then
        ...
        Public Function ListarPerguntasEntidade(ByVal vTipoEntidade As enTipoEntidade, ByVal vIDReferencia As Integer) As IDataReader

            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_VISITA_ENTIDADE_PERGUNTAS"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
        ...
        Public Function ListarPerguntasEntidade(ByVal vTipoEntidade As enTipoEntidade) As IDataReader

            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_VISITA_PERGUNTAS_ENTIDADE"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
            cmd.Parameters.Add("@TIPOENTIDADE", SqlDbType.TinyInt).Value = vTipoEntidade
        ...
        Public Function ListarTarefasLoja() As IDataReader

            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_VISITA_TAREFAS"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
        ...
        'Public Function ListarRespostasEntidade(ByVal vTipoEntidade As enTipoEntidade, ByVal vIDReferencia As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object

        '    Dim cmd As New SqlCommand()
        '    cmd.CommandType = CommandType.StoredProcedure
        '    cmd.CommandText = PREFIXO & "LS_PERGUNTA_RESPOSTAS_ENTIDADE"
        '    cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
        '    cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
        '    cmd.Parameters.Add("@TIPOENTIDADE", SqlDbType.TinyInt).Value = vTipoEntidade
        '    cmd.Parameters.Add("@IDREFERENCIA", SqlDbType.Int).Value = vIDReferencia
        ...
        Public Function ListarRespostasEntidade(ByVal vTipoEntidade As enTipoEntidade, ByVal vIDReferencia As Integer, ByVal vIDPergunta As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object
        ...
        Public Sub AdicionarRespostasEntidade(ByVal vTipoEntidade As enTipoEntidade, ByVal vIDReferencia As Integer, ByVal vIDPergunta As Integer, ByVal vRespostas() As String)

            Dim cmd As New SqlCommand()
            Dim cn As SqlConnection = GetDBConnection()
            cmd.Connection = cn
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "IN_PERGUNTA_RESPOSTA_ENTIDADE"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
            cmd.Parameters.Add("@TIPOENTIDADE", SqlDbType.TinyInt).Value = vTipoEntidade
            cmd.Parameters.Add("@IDREFERENCIA", SqlDbType.Int).Value = vIDReferencia
            ...
            Me.User.Log("Visitas", "AdicionarRespostas - IDVISITA=" & m_intIDVisita & " TIPOENTIDADE=" & vTipoEntidade & " IDReferencia=" & vIDReferencia & " IDPERGUNTA=" & vIDPergunta & " RESPOSTA=" & prm.Value)

        End Sub


        Public Function ListarCategoriasVisita(ByVal vIDCategoria As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object
            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_CATEGORIAS_VISITA"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
        ...
        Public Function ListarSubCategoriasVisita(ByVal vIDCategoria As Integer, ByVal vIDSubCategoria As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object
            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_SUBCATEGORIAS_VISITA"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
            cmd.Parameters.Add("@IDCATEGORIA", SqlDbType.Int).Value = vIDCategoria
        ...
        Public Function ListarSubCategorias(Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object
            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_VISITAS_SUBCATEGORIAS"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
            Return MyBase.ExecuteCommand(cmd, vReturnType)
        End Function
        ...
        Public Function ListarPesquisas(Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object
            Dim cmd As New SqlCommand()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = PREFIXO & "LS_VISITA_PESQUISAS"
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = User.IDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = m_intIDVisita
            Return MyBase.ExecuteCommand(cmd, vReturnType)
        End Function
