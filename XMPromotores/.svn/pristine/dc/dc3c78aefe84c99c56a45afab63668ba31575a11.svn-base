<%@ Page ValidateRequest='false' Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="VisitaPerguntaRespostaEnt.aspx.vb" Inherits="Pages.Visita.VisitaPerguntaRespostaEnt" title="XM Promotores - Yes Mobile" %>
