	...
	<div class='EditArea' style="width:68%; width:73%;">
		<div class='divEditArea' style="height:160px; height:120px\9;">
			<div class='trField cb' runat='server'  id='trMotivoUsoForm' visible='<%$Settings: visible, MotivoUsoFormulario.MotivoUsoForm, true %>' >
				<div class='tdFieldHeader cb fl' style="padding-left:22px; padding-right:10px; padding-top:15px; text-align:left\9;">
					<a style="text-align:left;">Motivo:</a><br><br>
					<asp:TextBox runat='server' ID='txtMotivoUsoForm' MaxLength='200'  CssClass="formulario" Width="641px" Height="90px"  />
