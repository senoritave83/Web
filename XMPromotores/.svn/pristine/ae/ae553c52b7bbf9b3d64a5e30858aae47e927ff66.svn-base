<%@ Control Language="VB" AutoEventWireup="false" CodeFile="RoteiroPorPeriodo.ascx.vb" Inherits="controls_RoteiroPorPeriodo" %>
		                ...
		                <tr class='trField'>
		                    ...
		                    <td>
                                <asp:UpdateProgress ID="UpdateProgress2" DisplayAfter='0' runat="Server" AssociatedUpdatePanelID="pnuRoteiro">
                                    <ProgressTemplate>
                                        <div class="progress">
                                            <img runat="server" src="~/imagens/ajax-loader.gif" alt='Aguarde por favor...' /> Por favor aguarde...
                                        </div>
                                    </ProgressTemplate>
                                </asp:UpdateProgress>  
		                    </td>
                        ...
                        <HeaderTemplate>
                            <tr>
                              <td width='300'style="width:300px;" rowspan='3' colspan='2' class='Roteiro_LojaHeader'>
                                <img runat="server" src="~/imagens/pt.gif" width="200" height="1"/><center>Lojas</center>
                              </td>
                        ...
                        <ItemTemplate>
                            <tr id='tr_<%# eval("IDLoja") %>'>
                                ...
                                <td class='Roteiro_Loja'>
                                    <asp:ImageButton ID="ImageButton2" runat='server' CommandName="RetirarLoja" Visible='<%# IIF(ViewState("IDSTATUSPROMOTOR") = 0, "false", Eval("Deletable")) %>' CommandArgument='<%#eval("IDLoja") %>' ImageUrl="~/imagens/excluir_ico.png" AlternateText="Excluir loja do Roteiro" />
                                </td>
                        ...
                        <AlternatingItemTemplate>
                            <tr id='tr_<%# eval("IDLoja") %>'>
                                ...
                                <td class='Roteiro_LojaAlt'>
                                    <asp:ImageButton ID="ImageButton1" runat='server' Visible='<%# Eval("Deletable") %>' CommandName="RetirarLoja" CommandArgument='<%#eval("IDLoja") %>' ImageUrl="~/imagens/excluir_ico.png" AlternateText="Excluir loja do Roteiro" />
                                </td>
                                <asp:Repeater runat='server' ID='rptDias' OnItemDataBound="rptDias_ItemDataBound" DataSource='<%# GetDiasLoja(eval("IDLoja")) %>'>
                                    <ItemTemplate>
                                    ...
                                    <table style='width:815px;'>
                                        ...
                                        <tr class='Roteiro_Loja' >
                                            ...
                                            <td class='Roteiro_Loja' colspan='3' style="text-align:left;" >
                                                ...
                                                <asp:DropDownList runat="server" ID="cboIDPromotor" DataTextField="Usuario" DataValueField="IDUSuario" />
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView runat='server' ID='grdProcurar' Width='100%' SkinID='GridInterno' DataKeyNames='IDLoja' AutoGenerateColumns='false' AllowSorting="true">
                                            <Columns>  
                                                ...
                                                <asp:BoundField HeaderText='Endere&ccedil;o' DataField='Endereco' SortExpression='Endereco' />                                         
                                                ...
                                                <asp:BoundField HeaderText='<%$Settings: Caption, Regiao, "Regi&atilde;o"%>' DataField="Regiao" SortExpression="Regiao" />
