...
<asp:Panel runat='server' ID='pnlRoteiro'>
    ...
    <asp:Label runat='server' ID='lblSemanaMes' Text='Semana do Mês:' /> <asp:Label runat='server' ID='lblSemanasMes'>1</asp:Label> <br />
    <asp:Label runat='server' ID='Label1' Text='Único no Período do Roteiro:' /> <asp:Label runat='server' ID='lblUnicoRoteiro'>1</asp:Label> <br />
</asp:Panel>