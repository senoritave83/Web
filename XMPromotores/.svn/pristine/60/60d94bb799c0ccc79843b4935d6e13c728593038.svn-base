...
Namespace Pages.Cadastros
    ...
    Partial Public Class Lojas
        ...
        Public Sub BindGrid()
            ...
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDCliente.SelectedValue, cboUF.SelectedValue, cboIDTipoLoja.SelectedValue, cboIDShopping.SelectedValue, cboIDRegiao.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE, cboIDStatus.SelectedValue)
