...
<asp:Panel runat='server' ID='pnlRoteiro'>
    <asp:UpdatePanel runat=server>
        <ContentTemplate>
            <h2>Preços por UF</h2>
	        <asp:Panel runat='server' ID='pnlDia' style="padding:0px;">
                 <asp:GridView runat='server' ID='grdPrecos' Width='95%' SkinID='GridInterno' AutoGenerateColumns='false' DataKeyNames="UF">
                    ...
                    <Columns>
                        ...
                        <asp:ButtonField CommandName='Excluir' ButtonType='Link' Text='<img class="imgBtnAdd" src="../imagens/excluir_ico.png"/>' />
                    </Columns>
                    <EmptyDataTemplate>
            ...
            <table width="650" style="width:650px;">
		        <tr>
                    ...
                    <td rowspan='2'><input type=button ValidationGroup="PRECOPRODUTO" ID="btnIncluir" class='Botao' Runat="server" Value="adicionar"></td>
                </tr>
                <tr>
