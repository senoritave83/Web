...
Namespace Pages.Visita
    ...
    Partial Class VisitaPerguntaRespostaEnt
        Inherits XMWebPage
        Dim cls As clsVisitaProduto
        Protected Const VW_IDVISITA As String = "IDVisita"
        Protected Const VW_IDENTIDADE As String = "IdEntidade"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                ViewState(VW_IDENTIDADE) = CInt("0" & Request("IdEntidade"))
                ViewState(VW_IDPERGUNTA) = CInt("0" & Request("IDPergunta"))
                cls.Load(ViewState(VW_IDVISITA), ViewState(VW_IDENTIDADE))
        ...
        Protected Sub ExibirPergunta()
            ...
            If Not blnEncontrado Then
                Response.Redirect("visitaproduto.aspx?idvisita=" & ViewState(VW_IDVISITA) & "&idproduto=" & ViewState(VW_IDENTIDADE))
            Else
