...
Partial Class reports_exportar
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.ControlsNames(drpCargouperior.ID) = "crg"
            Me.ControlsNames(lstSuperior.ID) = "lid"
    ...
    Protected Sub BindCargos()
        ...
        drpCargouperior.DataSource = car.Listar()
        drpCargouperior.DataBind()
        drpCargouperior.Items.Insert(0, New ListItem("Selecione o cargo...", "0"))
        car = Nothing
    End Sub


    Protected Sub BindUsuarios(ByVal cbo As ListBox, ByVal vIDCargo As Integer, ByVal vSuperiores As String)
        Dim usu As New clsUsuario
        cbo.DataSource = usu.Listar(vIDCargo, vSuperiores)
        cbo.DataBind()
    End Sub
    ...
    Protected Sub drpCargouperior_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles drpCargouperior.SelectedIndexChanged

        Dim intIdCargo As Integer = drpCargouperior.SelectedItem.Value
        Dim usu As New clsUsuario
        lstSuperior.ClearSelection()
        lstSuperior.DataSource = usu.Listar(intIdCargo)
        lstSuperior.DataBind()
        usu = Nothing
    ...
    Protected Sub lstSuperior_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles lstSuperior.SelectedIndexChanged

        LstPromotor.Items.Clear()
        Dim vSuperiores As String = getComboValues(lstSuperior)
        Dim vIdCargo As Integer = getComboValue(drpCargouperior)
        If vSuperiores <> "" Then
            ...
            With LstPromotor
                .Items.Clear()
                .DataSource = pro.ListarUsuariosProximoNivel(vIdCargo, vSuperiores)
                .DataBind()
            End With
            pro = Nothing
    ...
    Protected Sub lstCampExp_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstCampExp.SelectedIndexChanged
