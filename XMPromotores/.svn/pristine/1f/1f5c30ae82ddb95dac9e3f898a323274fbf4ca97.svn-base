<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Roteiro.ascx.vb" Inherits="Controls.Roteiro" %>
        <asp:Panel runat='server' ID='pnlRoteiro'>
            ...
            <asp:Panel runat='server' ID='pnlSemanaMes' Width="70%">
		        <asp:label ID="Label1" Runat="server">Semana do mes:</asp:label><a href='javascript:fncLimparChecks("<%=chkSemanaMes.ClientID%>_");' class='LinkLimpar'>Limpar</a><br />
			    <asp:checkboxlist id="chkSemanaMes" Runat="server" Width="100%" RepeatDirection="Horizontal" RepeatColumns="6">
