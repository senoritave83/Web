...
Namespace Pages.Sistema
    ...
    Partial Public Class Recados
        ...
        '    FiltroSuperiorMultiplo1.Superiores = ""
        ...
        'Protected Sub FiltroSuperiorMultiplo1_SelectedIndexChanged(ByVal sender As Object, ByVal FiltroSuperiorEventArgs As System.EventArgs) Handles FiltroSuperiorMultiplo1.SelectedIndexChanged

        '    Dim pro As New clsUsuario
        '    With LstPromotor
        '        Dim strSelected As String = getComboValues(LstPromotor)
        '        .Items.Clear()
        '        .DataSource = pro.Listar(1, FiltroSuperiorMultiplo1.Superiores)
        '        .DataBind()
        '        If Not String.IsNullOrEmpty(strSelected) Then setComboValues(LstPromotor, strSelected)
        '    End With
        '    pro = Nothing
