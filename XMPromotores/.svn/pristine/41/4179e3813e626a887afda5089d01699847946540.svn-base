    ...
    Partial Public Class VisitaProduto
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                cboEncontrado.Attributes.Add("onChange", "showMessage();")
                cboPesquisado.Attributes.Add("onChange", "showMessage();")
                cboVisualizouEstoque.Attributes.Add("onChange", "VerificaCampos();")
            Else
            ...
            trEstoque.Visible = cboVisualizouEstoque.SelectedValue <> 0
        ...
        Protected Sub Inflate()
            ...
            Try
                ...
                lblProduto.Text = prd.Codigo & " - " & prd.Descricao
        ...
        Protected Sub dtgPerguntas_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles dtgPerguntas.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                If e.Row.DataItem("TipoCampo") = 2 Then
                    Dim img As inccontrols.ImageRotator
...
#End Region
        ...
        Protected Sub cboVisualizouEstoque_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboVisualizouEstoque.SelectedIndexChanged
            If cboVisualizouEstoque.SelectedValue = 0 Then
                txtEstoque.Text = 0
