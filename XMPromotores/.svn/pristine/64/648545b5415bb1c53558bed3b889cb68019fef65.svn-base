...
Partial Class controls_VerRoteiro
    ...
    Protected m_bytUnicoPeriodo As Integer = 0
    Protected m_strDias As String = ""
    Protected m_strMeses As String = ""
    Protected m_strDiasSemana As String = ""
    Protected m_strSemanaMes As String = ""
    Protected m_strUnicoPeriodo As String = ""
  ...
  Public Overridable Property SemanaMes() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If Value = 0 Then
                m_strSemanaMes = "Todas"
            Else
                m_strSemanaMes = ""
                Dim m_colTemp As New Collections.Generic.List(Of String)
                For iTemp As Integer = 0 To 5
                    If ((2 ^ iTemp) And CInt(m_intSemanaMes)) Then
                        m_colTemp.Add(iTemp + 1)
                    End If
                Next
                m_strSemanaMes = MontaLista(m_colTemp)
            End If
            lblSemanasMes.Text = m_strSemanaMes
        End Set
    End Property
    Public Overridable Property UnicoPeriodo() As Integer
        Get
        ...
        Set(ByVal Value As Integer)
            ...
            If Value = 0 Then
                m_strUnicoPeriodo = "Não"
            Else
                m_strUnicoPeriodo = "Sim"
            End If
            lblUnicoRoteiro.Text = m_strUnicoPeriodo
        End Set
    End Property
