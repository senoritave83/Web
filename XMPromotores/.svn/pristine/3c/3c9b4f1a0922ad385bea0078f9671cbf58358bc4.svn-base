    ...
    Partial Public Class SubCategorias
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, cboIDCategoria, drpIdStatus)
                BindGrid()
            End If			
        End Sub

        Public Sub BindGrid()
            Dim vIdStatus As Integer = getComboValue(drpIdStatus)
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDCategoria.SelectedValue, vIdStatus, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, cboIDCategoria, drpIdStatus)
        End Sub
        ...
        Sub GridView1_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName = "UP" Then
                Dim intIdSubCategoria As Integer = e.CommandArgument
                cls.TrocarOrdem(intIdSubCategoria, 1)
            ElseIf e.CommandName = "DOWN" Then
                Dim intIdSubCategoria As Integer = e.CommandArgument
                cls.TrocarOrdem(intIdSubCategoria, 2)
            End If
            BindGrid()
