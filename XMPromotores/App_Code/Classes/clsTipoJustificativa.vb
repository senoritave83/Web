...
Namespace Classes
	...
	#Region "Declarations" 
        ...
        Protected m_blnAplicarRuptura As Boolean
	#End Region  
	...
	#Region "Properties" 
        ...
        Public Overridable Property AplicarRuptura() As Boolean
            Get
                Return m_blnAplicarRuptura
            End Get
            Set(ByVal value As Boolean)
                m_blnAplicarRuptura = value
            End Set
        End Property
...
#End Region
    ...
    #Region "Metodos"
        ...
        Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            End If
            If dr.IsDBNull(dr.GetOrdinal("AplicarRuptura")) Then
                m_blnAplicarRuptura = False
            Else
                m_blnAplicarRuptura = IIf(dr.GetByte(dr.GetOrdinal("AplicarRuptura")) = 1, True, False)
            End If
        ...
        Public Sub Update()
            ...
            cmd.Parameters.Add("@APLICARRUPTURA", SqlDbType.TinyInt).Value = IIf(m_blnAplicarRuptura = True, 1, 0)
