...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="formapagamento.aspx.vb" Inherits="xmlinkwm.formapagamento"%>
<HTML>
					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" width="730">
							<tr vAlign="center" height="60">
								<td>
									<uc1:titulo id="Titulo1" runat="server" Titulo="Lista de Forma de Pagamento" Descricao="Cadastre e edite as Formas de Pagamento" imagem="imagens/group6060.jpg"></uc1:titulo>
								</td>
							</tr>
							<tr>
								<td>
									<table width="100%"class='frente'>
										<tr class='fundo'>
											<td>
												<table width="100%">
													<tr vAlign="top">
														<td colSpan="4"><font face="Verdana"color="#FFFFFF" size="2"><b>Filtrar as formas de 
																	pagamentos por:</b></font> <img src='imagens/help.gif' alt='Filtra as formas de pagamento segundo critérios escolhidos nas caixas de combinação.' align="absBottom">
														</td>
													</tr>
													<tr>
												...
												<asp:DataGrid Runat="server" ID='dtgGrid' Width="100%" AutoGenerateColumns="False" AllowSorting="True" CssClass='TextDefault' BorderStyle="none">
													...
													<Columns>
														<asp:TemplateColumn ItemStyle-Width="20" HeaderText="<input type='checkbox' name='chkSel' onclick='selectAll(document.Form2.chkSelected, document.Form2.chkSel.checked);' title='Selecionar Todos'><img src='imagens/help4.gif' align=absmiddle alt='Selecionar Todos'>">
															<ItemTemplate>
																<input type=checkbox name='chkSelected' value='<%# DataBinder.Eval(Container.DataItem, "frm_FormaPagamento_int_PK")%>' />
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:HyperLinkColumn DataTextField='frm_FormaPagamento_chr' DataNavigateUrlField='frm_FormaPagamento_int_PK' DataNavigateUrlFormatString='FormaPagamentodet.aspx?idFormaPagamento={0}' HeaderText='Forma de Pagamento' />
														<asp:BoundColumn HeaderText="Criado em" DataFormatString='{0:d}' DataField='frm_Criado_dtm' />
													</Columns>
												</asp:DataGrid>
												<table width="100%">
								...
								<td height="60">
									<table width="100%" class='fundo'>
										<tr>
											...
											<td class='TextDefault' colspan="2" valign="bottom">Forma de Pagamento
												<asp:RequiredFieldValidator Runat="server" ID='valRequired' ControlToValidate='txtFormaPagamento' ErrorMessage='<img src="imagens/exclam2.gif"> Campo obrigatório!' />
												<br>
												<asp:TextBox Runat="server" ID='txtFormaPagamento' CssClass="Caixa" Width="100%" />
											</td>
							...
							<tr>
								<td valign="top">
									<ul class='TextDefault'>
										...
										<li>
											<b>Excluir:</b> Exclua as formas de pagamento selecionadas pela caixa de 
											seleção.</li>
									</ul>
								</td>
							</tr>
