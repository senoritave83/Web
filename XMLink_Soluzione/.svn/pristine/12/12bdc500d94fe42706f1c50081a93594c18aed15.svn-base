...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Categorias.aspx.vb" Inherits="xmlinkwm.Categorias"%>
<HTML>
					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" width="730">
							<tr vAlign="center" height="60">
								<td>
									<uc1:titulo id="Titulo1" runat="server" Titulo="Lista de Categorias" Descricao="Cadastre e edite os Categorias de trabalho para envio de Recados Digitais" imagem="imagens/group6060.jpg"></uc1:titulo>
								</td>
							</tr>
							<tr>
								<td>
									<table width="100%"class='frente'>
										<tr class='fundo'>
											<td>
												<table width="100%">
													<tr vAlign="top">
														<td colSpan="4"><font face="Verdana"color="#FFFFFF" size="2"><b>Filtrar as categorias por:</b></font>
															<img src='imagens/help.gif' alt='Filtra as categorias segundo critérios escolhidos nas caixas de combinação.' align="absBottom">
														</td>
													</tr>
													<tr>
														...
														<td vAlign="bottom">
															<asp:Button Runat="server" ID='btnFiltrar' Text='Filtrar' ToolTip="Filtrar Categorias" CssClass="Botao" CausesValidation="False"></asp:Button>
														</td>
														<td>&nbsp;</td>
													</tr>
												</table>
												...
												<asp:DataGrid Runat="server" ID='dtgGrid' Width="100%" AutoGenerateColumns="False" AllowSorting="True" CssClass='TextDefault' BorderStyle="none">
													...
													<Columns>
														<asp:TemplateColumn ItemStyle-Width="20" HeaderText="<input type='checkbox' name='chkSel' onclick='selectAll(document.Form2.chkSelected, document.Form2.chkSel.checked);' title='Selecionar Todos'><img src='imagens/help4.gif' align=absmiddle alt='Selecionar Todos'>">
															<ItemTemplate>
																<input type=checkbox name='chkSelected' value='<%# DataBinder.Eval(Container.DataItem, "cat_Categoria_int_PK")%>' />
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:HyperLinkColumn DataTextField='cat_Categoria_chr' DataNavigateUrlField='cat_Categoria_int_PK' DataNavigateUrlFormatString='Categoriadet.aspx?idCategoria={0}' HeaderText='Categoria' />
														<asp:BoundColumn HeaderText="Criado em" DataFormatString='{0:d}' DataField='cat_Criado_dtm' />
													</Columns>
												</asp:DataGrid>
												<table width="100%">
							...
							<tr valign="top">
								<td height="60">
									<table width="100%" class='fundo'>
										<tr>
											<td class='TextDefault' colspan="3">Nome do Categoria
							...
							<tr>
								<td valign="top">
									<ul class='TextDefault'>
										<li>
											<b>Adicionar:</b>
										Adicione um novo Categoria à Lista de Categorias.
										<li>
											<b>Excluir:</b> Exclua os Categorias selecionados pela caixa de seleção.</li>
									</ul>
								</td>
							</tr>
						</table>
