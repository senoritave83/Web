					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" cellPadding="5" width="730" border="0">
							<tr vAlign="center" height="60">
								<td>
									<uc1:titulo id="Titulo1" runat="server" Titulo="Histórico de Visitas" Descricao="Visualize as visitas enviados pelos seus vendedores" imagem="imagens/historico.gif"></uc1:titulo>
								</td>
							</tr>
												...
												<table width="100%">
													<tr vAlign="top">
														<td colSpan="3"><font face="Verdana"color="#FFFFFF" size="2"><b>Filtrar as Visitas por:</b></font>
															<img src='imagens/help.gif' alt='Filtra as Visitas enviados segundo critérios escolhidos nas caixas de combinação.' align="absBottom">
														</td>
													</tr>
													<tr>
													...
													<tr>
														<td><font class="TextDefault">Data Inicial</font>
															<asp:RequiredFieldValidator Runat="server" ID='valReqInicio' ControlToValidate='txtDataInicio' ErrorMessage='Campo obrigatório' Display="Dynamic" CssClass="TextDefault"  />
															<asp:CompareValidator Runat="server" ID='valCompInicio' ControlToValidate='txtDataInicio' ErrorMessage='Data inválida' Display="Dynamic" CssClass="TextDefault" Type="Date" Operator="DataTypeCheck" />
															<br>
														...
														<td><font class="TextDefault">Data Final</font>
															<asp:RequiredFieldValidator Runat="server" ID="Requiredfieldvalidator1" ControlToValidate='txtDataFinal' ErrorMessage='Campo obrigatório' Display="Dynamic" CssClass="TextDefault" />
															<asp:CompareValidator Runat="server" ID="Comparevalidator1" ControlToValidate='txtDataFinal' ErrorMessage='Data inválida' Display="Dynamic" CssClass="TextDefault" Type="Date" Operator="DataTypeCheck" />
															<br>
