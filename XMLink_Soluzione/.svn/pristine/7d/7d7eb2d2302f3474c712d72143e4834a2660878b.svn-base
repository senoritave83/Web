					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" cellPadding="5" width="730" border="0">
							<tr vAlign="center" height="60">
								<td>
									<uc1:titulo id="Titulo1" runat="server" Titulo="Histórico de Pedidos" Descricao="Visualize os pedidos enviados pelos seus vendedores" imagem="imagens/historico.gif"></uc1:titulo>
								</td>
							</tr>
