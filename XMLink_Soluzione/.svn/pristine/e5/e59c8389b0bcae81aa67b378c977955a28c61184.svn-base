...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ViewState("Sort") = "OS"
            BindGrid()
            btnNovo.Enabled = CheckPermission("Cadastro de Categorias", "Adicionar Categoria")
            btnApagar.Enabled = CheckPermission("Cadastro de Categorias", "Apagar Categoria")
        End If
    End Sub


    Private Sub btnNovo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNovo.Click
        If CheckPermission("Cadastro de Categorias", "Adicionar Categoria") = False Then
            ShowMsg("Permissão Negada")
            Exit Sub
        End If
        cls.Nome = txtNome.Text
        If cls.Existe(0, "", txtNome.Text) Then
            ShowMsg("A categoria já existe! Por favor verifique o nome")
            Exit Sub
        End If
        Try
            cls.Update()
