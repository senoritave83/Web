<%@ Page Language="vb" AutoEventWireup="false" Codebehind="gruposdet.aspx.vb" Inherits="xmlinkwm.gruposdet" %>
					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" width="730">
							<tr vAlign="center" height="60">
								<td>
									<uc1:titulo id="Titulo1" runat="server" Titulo="Cadastro de grupos" Descricao="Cadastre e edite os grupos de trabalho para envio de Recados Digitais" imagem="imagens/group6060.jpg"></uc1:titulo>
								</td>
							</tr>
									...
									<table width="100%" cellpadding="1" bgcolor="dimgray">
										<tr valign="top" bgcolor="white">
											<td>
												<table width="100%">
													<tr>
														<td class='TextDefault' width="35%">Nome do Grupo
							...
							<tr>
								<td valign="top">
									<ul class='TextDefault'>
										<li>
											<b>Novo:</b>
										Crie um novo Grupo de Vendedores.
										<li>
											<b>Excluir:</b>
										Exclua o Grupo selecionado.
										<li>
											<b>Salvar:</b> Salva as alterações efetuadas no Grupo de Vendedores.</li>
									</ul>
								</td>
							</tr>
						</table>
