...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ViewState("Sort") = "OS"
            BindGrid()
            btnNovo.Enabled = CheckPermission("Cadastro de Permissões", "Adicionar permissão")
            btnApagar.Enabled = CheckPermission("Cadastro de Permissões", "Apagar permissão")
        End If
    End Sub
    ...
    Private Sub btnNovo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNovo.Click
        If CheckPermission("Cadastro de Permissões", "Adicionar permissão") = False Then
