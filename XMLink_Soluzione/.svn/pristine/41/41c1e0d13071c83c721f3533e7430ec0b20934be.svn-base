Public Class roteirocli
    ...
    Protected WithEvents btnVoltarRoteiros As Button
...
#End Region
    ...
    Private Sub btnVoltarRoteiros_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnVoltarRoteiros.Click
        BindGrid()
        Response.Redirect("roteiro.aspx?idvendedor=" & ViewState("IDVendedor") & "&idroteiro=" & ViewState("IDRoteiro") & "")
    End Sub
