						...
						<form id="Form1" method="post" runat="server">
							<table height="100%" width="730">
								<tr vAlign="center" height="60">
									<td>
										<uc1:titulo id="Titulo1" runat="server" Titulo="Cadastros do sistema" Descricao="Nesta página você tem acesso a todos os cadastros usados pelo sistema" imagem="imagens/config.gif"></uc1:titulo>
									</td>
								</tr>
									...
									<td colSpan="2">
										<table height="100%" width="100%">
											...
											<tr>
												...
												<td><A class="TextDefaultBold" href="condicoes.aspx">CONDIÇÕES DE PAGAMENTO</A><br>
													<font class="TextDefault">Cadastre e edite as condições de pagamentos</font>
												</td>
											</tr>
											<tr>
