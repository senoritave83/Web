											...
											<TD>
												<table width="100%">
													<tr vAlign="top">
														...
														<img src='imagens/help.gif' alt='Filtra as condições de pagamento segundo critérios escolhidos na caixa texto.' align="absBottom">
														</td>
													</tr>
													<tr>
														<td width="30%"><font class="TextDefault">Código</font><br>
													...
													<tr valign="top" bgcolor="white">
														<td height="100%">
															<asp:DataGrid Runat="server" ID='dtgGrid' Width="100%" AutoGenerateColumns="False" AllowSorting="True" CssClass='TextDefault' BorderStyle="none">
																...
																<Columns>
																	<asp:HyperLinkColumn ItemStyle-Width="15%" DataTextField='cmp_Codigo_chr' DataNavigateUrlField='cmp_Campanha_int_PK' DataNavigateUrlFormatString='Campanhas.aspx?idcampanha={0}' HeaderText='Código' />
																	<asp:BoundColumn DataField='cmp_Descricao_chr' HeaderText='Campanha' />
																	<asp:BoundColumn DataField='cmp_ValidIni_dtm' HeaderText='Início' ItemStyle-Width="75" ItemStyle-HorizontalAlign="center" />
																	<asp:BoundColumn DataField='cmp_ValidFim_dtm' HeaderText='Término' ItemStyle-Width="75" ItemStyle-HorizontalAlign="center" />
																</Columns>
															</asp:DataGrid>
															<table width="100%">
															...
															<table width="100%">
                                                                <tr style="vertical-align: top;">
																	...
																	<td class="TextDefault" runat="server" id="Td1">
                                                                        <font color="white">Código da Campanha:</font><br />
																		<asp:textbox id="txtCodigo" CssClass="Caixa" Width="50%" Runat="server"></asp:textbox>
																	</td>
																	<td class='TextDefault' width='33%'>
                                                                        <font color="white">Descrição:</font>
																		<asp:RequiredFieldValidator Enabled="False" Runat="server" ID="Requiredfieldvalidator8" ControlToValidate='txtNome' ErrorMessage='<img src="imagens/exclam2.gif"> Campo obrigatório!' Display="Dynamic"></asp:RequiredFieldValidator>
																		<br>
																...
																<tr style="vertical-align: top; height: 10px;">
																	<td class="TextDefault" width='33%'>
                                                                        <font color="white">Valor Mínimo por período:</font>
																		<asp:RequiredFieldValidator Enabled="False" Runat="server" ID="Requiredfieldvalidator9" ControlToValidate='txtValor' Display="Dynamic" ErrorMessage='<img src="imagens/exclam2.gif"> Campo obrigatório!'></asp:RequiredFieldValidator>
																		<BR>
																		<asp:TextBox id="txtValor" Width="50%" CssClass="Caixa" Runat="server"></asp:TextBox>
																	</td>
																	<td class='TextDefault'>
                                                                        <font color="white">Nº de Parcelas:	</font> 
																		<asp:RadioButtonList ID="rblParcelas" RepeatDirection="Horizontal" BorderWidth="1" BorderColor="#993300" CssClass="Caixa" Runat="server" AutoPostBack="True">
																			<asp:ListItem Value="1" Selected="True"><font color="white">Única</font></asp:ListItem>
																			<asp:ListItem Value="2" Selected="False"><font color="white">Parcelas</font></asp:ListItem>
																		</asp:RadioButtonList>
																		<asp:requiredfieldvalidator id="Requiredfieldvalidator1" Runat="server" ControlToValidate="rblParcelas" ErrorMessage='<img src="imagens/exclam2.gif"> Campo obrigatório!' Display="Dynamic" />
																...
																<tr style="vertical-align: top;">
																	<td class="TextDefault" width='33%'>
                                                                        <font color="white">Data de Início:</font><br>
																		<asp:requiredfieldvalidator id="Requiredfieldvalidator5" Runat="server" ControlToValidate="txtDataIni" ErrorMessage='<img src="imagens/exclam2.gif"> Campo obrigatório!' Display="Dynamic" />
																		<asp:textbox id="txtDataIni" CssClass="Caixa" Width="50%" Runat="server"></asp:textbox>
																	</td>
																	<td class='TextDefault'>
                                                                        <font color="white">Data de Término:</font><br>
							...
							<tr>
								<td valign="top">
									<ul class='TextDefault'>
										...
										<li>
											<b>Limpar:</b> Limpe o formulário de campanhas. 
              							<li>
