...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            BindGrid()
            btnNovo.Enabled = CheckPermission("Cadastro de Condições", "Adicionar Condição")
            btnApagar.Enabled = CheckPermission("Cadastro de Condições", "Apagar Condição")
        End If
    End Sub
    ...
    Private Sub btnNovo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNovo.Click
        If CheckPermission("Cadastro de Condicoes", "Adicionar Condicao") = False Then
            ShowMsg("Permissão Negada")
            Exit Sub
        End If
        If cls.Existe(0, txtCodigo.Text, txtCondicao.Text) Then
