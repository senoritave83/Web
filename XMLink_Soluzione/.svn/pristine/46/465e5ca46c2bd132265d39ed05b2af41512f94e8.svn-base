																...
																<table width="100%" cellpadding="2" cellspacing="0" bgcolor="white" height=100%>
																	<tr>
																		<td class=TextDefault>
																			Código Interno: <asp:Label Runat="server" ID="lblCodigo" CssClass="TextDefault" Font-Bold=True></asp:Label>
																		</td>
																		<td class=TextDefault>
																	...
																	<tr>
																		<td class=TextDefault>
																			Condição de Pagamento: <asp:Label Runat="server" ID="lblCondicao" CssClass="TextDefault" Font-Bold=True></asp:Label>
																		</td>
																		<td class=TextDefault>
																	...
																	<tr runat=server id='rowObservacao'>
																		<td colspan=2 class='TextDefault'>
																			Observações:<asp:Label Runat=server ID='lblObservacao' CssClass='TextDefault' Font-Bold=True></asp:Label>
																		</td>
																	</tr>
												...
												<td height="100%">
													<asp:DataGrid Runat="server" ID='dtgItens' Width="100%" AutoGenerateColumns="False" AllowSorting="True" CssClass='TextDefault' BorderStyle="none">
														...
														<Columns>
															...
															<asp:BoundColumn DataField='PRD_CODIGO_CHR' HeaderText='Código' />
															<asp:BoundColumn DataField='PRD_Descricao_CHR' HeaderText='Descrição' />
															<asp:BoundColumn DataField='ITP_VALORUNITARIO_CUR' HeaderText='Preço Unit.' DataFormatString='{0:C}' />
