<%@ Page Language="vb" AutoEventWireup="false" Codebehind="distribuidores.aspx.vb" Inherits="xmlinkwm.distribuidores"%>
					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" width="730">
							<tr vAlign="center" height="60">
								<td><uc1:titulo id="Titulo1" runat="server" imagem="imagens/responsavel6060.jpg" Descricao="Cadastre e edite os dados dos distribuidores" Titulo="Lista de distrubuidores"></uc1:titulo></td>
							</tr>
							<tr>
								<td>
									<table width="100%"class='frente'>
										<tr class='fundo'>
											<td>
												<table width="100%">
													<tr vAlign="top">
														<td colSpan="4"><font face="Verdana"color="#FFFFFF" size="2"><b>Filtrar os distrubuidores por:</b></font>
															<IMG alt="Filtra os distrubuidores segundo critérios escolhidos nas caixas de combinação." src="imagens/help.gif" align="absBottom">
														</td>
													</tr>
													<tr>
														...
														<td>&nbsp;</td>
														<td vAlign="bottom"><asp:button id="btnFiltrar" CssClass="Botao" Runat="server" Text="Filtrar" CausesValidation="False" ToolTip="Filtrar distrubuidores"></asp:button></td>
													</tr>
												</table>
											</td>
										</tr>
											...
											<td height="100%"><asp:datagrid id="dtgGrid" BorderStyle="none" CssClass="TextDefault" AllowSorting="True" AutoGenerateColumns="False" Width="100%" Runat="server">
													...
													<Columns>
														<asp:TemplateColumn ItemStyle-Width="20" HeaderText="<input type='checkbox' title='Selecionar Todas' name='chkSel' onclick='selectAll(document.Form1.chkSelected, document.Form1.chkSel.checked);'><img src='imagens/help4.gif' align=absmiddle alt='Selecionar Todos'>">
															<ItemTemplate>
																<input type=checkbox name='chkSelected' value='<%# DataBinder.Eval(Container.DataItem, "dis_Distribuidor_int_PK")%>' />
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:HyperLinkColumn ItemStyle-Width="50%" DataTextField='cli_cliente_chr' DataNavigateUrlField='dis_Distribuidor_int_PK' DataNavigateUrlFormatString='Distribuidoresdet.aspx?IDistribuidor={0}' HeaderText='Distribuidor' />
														<asp:BoundColumn DataField='dis_Pontos_int' HeaderText='Pontos' />
														<asp:BoundColumn DataField='Ativo' HeaderText='Status' ItemStyle-Width="70" ItemStyle-HorizontalAlign="left" />
														<asp:BoundColumn DataField='dis_Criado_dtm' HeaderText='Criado em' DataFormatString='{0:d}' ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center" />
													</Columns>
												</asp:datagrid>
												<table width="100%">
							...
							<tr vAlign="top">
								<td colSpan="2" height="150">
									<table width="100%" class='fundo'>
										<tr>
											<td width="25%"><input type="button" value="Adicionar" onclick='location.href="Distribuidoresdet.aspx?idDistribuidor=0";' Title='Adicionar Distribuidor' class='Botao' runat=server id='btnNovo'></td>
							...
							<tr>
								<td vAlign="top">
									<ul class="TextDefault">
										<li>
											<b>Adicionar:</b>
										Adicione um novo Distribuidor à lista de distrubuidores.
										<li>
											<b>Excluir:</b> Exclua um ou mais distrubuidores selecionados pelas caixas de 
											seleção.
										</li>
									</ul>
								</td>
