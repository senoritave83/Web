<%@ Page Language="vb" AutoEventWireup="false" Codebehind="motivos.aspx.vb" Inherits="xmlinkwm.motivos"%>
					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" width="730">
							<tr vAlign="middle" height="60">
								<td>
									<uc1:titulo id="Titulo1" runat="server" Titulo="Lista de motivos" Descricao="Cadastre e edite os motivos de não venda" imagem="imagens/config.gif"></uc1:titulo>
								</td>
							</tr>
							<tr>
								<td>
									<table width="100%"class='frente'>
										<tr class='fundo'>
											<td>
												<table width="100%">
													<tr vAlign="top">
														<td colSpan="4"><font face="Verdana"color="#FFFFFF" size="2"><b>Filtrar os motivos por:</b></font>
															<img src='imagens/help.gif' alt='Filtra os motivos de não venda segundo critérios escolhidos nas caixas de combinação.' align="absBottom">
														</td>
													</tr>
													<tr>
												...
												<asp:DataGrid Runat="server" ID='dtgGrid' Width="100%" AutoGenerateColumns="False" AllowSorting="True" CssClass='TextDefault' BorderStyle="none">
													...
													<Columns>
														<asp:TemplateColumn ItemStyle-Width="20" HeaderText="<input type='checkbox' name='chkSel' onclick='selectAll(document.Form2.chkSelected, document.Form2.chkSel.checked);' title='Selecionar Todos'><img src='imagens/help4.gif' align=absmiddle alt='Selecionar Todos'>">
															<ItemTemplate>
																<input type=checkbox name='chkSelected' value='<%# DataBinder.Eval(Container.DataItem, "mot_Motivo_int_PK")%>' />
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:HyperLinkColumn DataTextField='mot_Motivo_chr' DataNavigateUrlField='mot_Motivo_int_PK' DataNavigateUrlFormatString='motivodet.aspx?idmotivo={0}' HeaderText='Motivo' />
														<asp:BoundColumn HeaderText="Criado em" DataFormatString='{0:d}' DataField='mot_Criado_dtm' />
													</Columns>
												</asp:DataGrid>
												<table width="100%">
							...
							<tr valign="top">
								<td height="60">
									<table width="100%" class='fundo'>
										<tr>
											<td class='TextDefault' colspan="4">Motivo
												<asp:RequiredFieldValidator Runat="server" ID='valRequired' ControlToValidate='txtMotivo' ErrorMessage='<img src="imagens/exclam2.gif"> Campo obrigatório!' />
												<br>
							...
							<tr>
								<td valign="top">
									<ul class='TextDefault'>
										<li>
											<b>Adicionar:</b> Adicione um novo motivo à Lista de motivos de não venda.</li>
										<li>
											<b>Excluir:</b> Exclua os motivos selecionados pela caixa de seleção.</li>
									</ul>
								</td>
							</tr>
						</table>
