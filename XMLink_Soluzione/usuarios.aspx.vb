...
Public Class usuarios
    ...
    Protected WithEvents valReqLogin As System.Web.UI.WebControls.RequiredFieldValidator
    Protected WithEvents valReqSenha As System.Web.UI.WebControls.RequiredFieldValidator
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ViewState("Desc") = True
            ViewState("Sort") = "OS"
            btnNovo.Enabled = CheckPermission("Cadastro de Usuarios", "Adicionar Usuario")
            btnApagar.Enabled = CheckPermission("Cadastro de Usuarios", "Apagar Usuario")
        End If
    End Sub
    ...
    Private Sub btnNovo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNovo.Click
        If CheckPermission("Cadastro de Usuarios", "Adicionar Usuario") = False Then
            ShowMsg("Permissão Negada")
            Exit Sub
        End If
        If cls.Existe(0, txtNome.Text, txtLogin.Text, txtSenha.Text) Then
            ShowMsg("O login escolhido já existe! Favor escolher outro!")
            Exit Sub
        End If
        cls.Nome = txtNome.Text
        cls.Login = txtLogin.Text
        cls.Administrador = chkAdmin.Checked
        Try
            cls.Update()
