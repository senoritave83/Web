...
<HTML>
	...
	Private Sub BindGrid()
		...
		dtgResumo.DataSource = dtsLista.Tables(2)
		dtgResumo.DataBind
		
		lblSituacao.Text = dtsLista.Tables(3).Rows(0)(0)
	...
	<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
		<form runat="server" ID="Form1">
			...
			<br>
			<asp:DataGrid Runat="server" ID='dtgLista' Width="100%" AutoGenerateColumns="False" AllowSorting="False" ShowFooter="True"
