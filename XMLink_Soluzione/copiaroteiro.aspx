...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="copiaroteiro.aspx.vb" Inherits="xmlinkwm.copiaroteirodet"%>
									...
									<table cellPadding="1" width="100%" bgColor="black">
										...
										<tr vAlign="top" bgColor="white">
											<td>
												<table width="100%">
													<tr>
														<td class="TextDefault" width="15%" runat="server" id="Td1"><b>Código do Roteiro</b><br>
															<asp:label id="lblRoteiro" Runat="server" Width="15%" CssClass="Caixa" />
														</td>
													</tr>
													<tr>
														<td class="TextDefault" width="15%" runat="server" id="Td2"><b>Descrição do Roteiro</b><br>
															<asp:TextBox id="txtNomeRoteiro" MaxLength="50" Runat="server" Width="80%" CssClass="Caixa" ></asp:TextBox>
															<asp:RequiredFieldValidator Runat=server ControlToValidate=txtNomeRoteiro CssClass="TextDefault" ErrorMessage="<b>Obrigatório</b>" Display=Dynamic></asp:RequiredFieldValidator>
														</td>
													</tr>
													<tr>
														<td class="TextDefault" width="15%" runat="server" id='tdCodigo'><b>Vendedor</b><br>
															<asp:label id="lblVendedor" Runat="server" Width="45%" CssClass="Caixa"  Visible=false/>
														</td>
													</tr>
                                                   ...
                                                   <TD class="TextDefault">
                                                    	...
                                                    	<tr>
														<td class='TextDefault'><b>Semana do Mês</b>&nbsp;<asp:RequiredFieldValidator Runat=server ControlToValidate=chlSemana CssClass="TextDefault" ErrorMessage="<b>Obrigatório</b>" Display=Dynamic ID="Requiredfieldvalidator1"></asp:RequiredFieldValidator><br>
															<asp:RadioButtonList ID="chlSemana" Runat="server" CssClass="TextDefault">
																<asp:ListItem Value="1">1ª Semana</asp:ListItem>
																<asp:ListItem Value="2">2ª Semana</asp:ListItem>
																<asp:ListItem Value="3">3ª Semana</asp:ListItem>
																<asp:ListItem Value="4">4ª Semana</asp:ListItem>
																<asp:ListItem Value="5">5ª Semana</asp:ListItem>
															</asp:RadioButtonList>
															
														</td>
													</tr>
													<tr>
														<td class="TextDefault"><b>Dia da Semana</b>&nbsp;<asp:RequiredFieldValidator Runat=server ControlToValidate=chlDiaSemana CssClass="TextDefault" ErrorMessage="<b>Obrigatório</b>" Display=Dynamic ID="Requiredfieldvalidator2"></asp:RequiredFieldValidator><br>
																	...
																	<tr valign="top" bgcolor="white">
																		<td height="100%">
																			<asp:DataGrid Runat="server" ID='dtgGridClientes' Width="100%" DataKeyField="cli_Cliente_int_PK" AutoGenerateColumns="False" AllowSorting="True" CssClass='TextDefault' BorderStyle="none">
																				...
																				<Columns>
																					<asp:BoundColumn DataField='POS' HeaderText='Nº' ItemStyle-HorizontalAlign=Center ItemStyle-Width=10/>
																					<asp:BoundColumn DataField='cli_Cliente_chr' HeaderText='Cliente' />
																					<asp:BoundColumn HeaderText='Código' DataField='cli_Cliente_int_PK' />
												...
												<asp:Button CssClass="botao" ID="btnSalvar" Runat="server" Text="Salvar Cópia" ></asp:Button>
                                                <asp:Button CssClass="botao" ID="btnCancelar" Runat="server" Text="Cancelar Cópia" ></asp:Button>
											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td vAlign="top">
									<ul class="TextDefault">
										<li>
											<b>Novo:</b>
										Adicione um novo roteiro à Lista de roteiros.
										<li>
											<b>Excluir:</b>
										Exclua o roteiro representado pelos dados acima.
										<li>
											<b>Salvar:</b> Grava os dados do roteiro e o coloca disponível na Lista de 
											roteiros.
										</li>
									</ul>
								</td>
