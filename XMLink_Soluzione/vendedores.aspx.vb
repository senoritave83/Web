...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ViewState("Sort") = "OS"
            BindGrid()
            btnNovo.Disabled = Not CheckPermission("Cadastro de Vendedores", "Adicionar Vendedor")
            btnApagar.Enabled = CheckPermission("Cadastro de Vendedores", "Apagar Vendedor")
        End If
    End Sub
