<%@ Page Language="vb" AutoEventWireup="false" Codebehind="categoriadet.aspx.vb" Inherits="xmlinkwm.categoriadet"%>
					...
					<form id="Form1" method="post" runat="server">
						<table height="100%" width="730">
							<tr vAlign="center" height="60">
								<td>
									<uc1:titulo id="Titulo1" runat="server" Titulo="Cadastro de Categorias" Descricao="Cadastre e edite os Categorias de trabalho para envio de Recados Digitais" imagem="imagens/group6060.jpg"></uc1:titulo>
								</td>
							</tr>
									...
									<table width="100%" cellpadding="1" bgcolor="dimgray">
										<tr valign="top" bgcolor="white">
											<td>
												<table width="100%">
													<tr>
														<td class='TextDefault' width="25%" runat=server id='tdCodigo'>Código
															<asp:RequiredFieldValidator Runat="server" ID="Requiredfieldvalidator1" ControlToValidate="txtCodigo" ErrorMessage='<img src="imagens/exclam2.gif"> Campo obrigatório!' />
															<br>
															<asp:TextBox Enabled="False" Runat="server" ID="txtCodigo" CssClass="Caixa" Width="100%" />
														</td>
														<td class='TextDefault' width="75%">Nome da Categoria
							...
							<tr>
								<td valign="top">
									<ul class='TextDefault'>
										<li>
											<b>Novo:</b>
										Crie um novo Categoria de Vendedores.
										<li>
											<b>Excluir:</b>
										Exclua o Categoria selecionado.
										<li>
											<b>Salvar:</b> Salva as alterações efetuadas no Categoria de Vendedores.</li>
									</ul>
								</td>
							</tr>
						</table>
