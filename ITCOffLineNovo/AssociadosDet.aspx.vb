    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If CInt(0 & ViewState("IdAssociado")) > 0 Then
            If CheckPermission("Cadastro de Associados", "Alterar Vendedor") Then
                cboIdVendedor.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Alterar Vendedor"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdStatus.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdEstado.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdAtividade.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboCidadeFaturamento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdEstadoCobranca.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboCidadeCobranca.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboCidade.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboTipoPessoa.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdRamo.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdPosicao.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdFormaPagamento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtFantasia.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtCEP.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtRazaoSocial.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtCEPCobranca.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtCEPFaturamento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtModulo.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtNumFunc.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtCNPJ.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtContrato.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtEmail.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtWebSite.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtInscricaoEstadual.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtSkype.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtObservacoes.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtImagemGuia.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtEndereco.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtComplemento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtComplementoCobranca.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtComplementoFaturamento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtEnderecoCobranca.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtEnderecoFaturamento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtDataInicioPlano.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtDataFimPlano.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtDataAtivacao.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                txtProduto.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboCidadeFaturamento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboCidadeCobranca.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                cboIdEstadoFaturamento.Enabled = (IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), True, False)) + IIf(CheckPermission("Cadastro de Associados", "Gravar Usuário"), True, False) + IIf(CheckPermission("Cadastro de Associados", "Incluir Usuário"), True, False)
                Barra.AtivarBotoes(IIf(CheckPermission("Cadastro de Associados", "Adicionar"), BarraBotoes2.Botoes_Ativos.Incluir, 0) + BarraBotoes2.Botoes_Ativos.Atualizar)
                Barra.AtivarBotoes(IIf(CheckPermission("Cadastro de Associados", "Atualizar"), BarraBotoes2.Botoes_Ativos.Atualizar, 0))
                Barra.AtivarBotoes(IIf(CheckPermission("Cadastro de Associados", "Alterar Vendedor"), BarraBotoes2.Botoes_Ativos.Atualizar, 0) + BarraBotoes2.Botoes_Ativos.Voltar)
            Else
            ...
            End If
            If CheckPermission("Cadastro de Associados", "Incluir Usuário") Then
        ...
        Else
            ...
            Barra.AtivarBotoes(IIf(CheckPermission("Cadastro de Associados", "Adicionar"), BarraBotoes2.Botoes_Ativos.Incluir, 0) + BarraBotoes2.Botoes_Ativos.Atualizar)
            Barra.AtivarBotoes(IIf(CheckPermission("Cadastro de Associados", "Atualizar"), BarraBotoes2.Botoes_Ativos.Atualizar, 0))
            Barra.AtivarBotoes(IIf(CheckPermission("Cadastro de Associados", "Alterar Vendedor"), IIf(CheckPermission("Cadastro de Associados", "ADICIONAR"), BarraBotoes2.Botoes_Ativos.Atualizar, 0), 0))
            btnAdicionarContato.Visible = False
            btnAdicionarUsuario.Visible = False
