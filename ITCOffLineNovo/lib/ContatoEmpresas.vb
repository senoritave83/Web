...
Public Class clsContatoEmpresas
    ...
    Public Function Apagar() As Boolean
        Try
            Dim sql As String
            sql = "SP_DE_CONTATOEMPRESAS " & m_intIdEmpresa & "," & m_intIdContato
            ExecuteNonQuery(sql)
            Return True
    ...
    Public Sub Update()
        ...
        Dim sql As String
        sql = "SP_SV_CONTATOEMPRESAS " & Deflate()
    ...
    Protected Sub Load(ByVal vData As Integer)
        ...
        End If
        Dim myData As DataSet
        myData = GetDataSet("SP_SE_CONTATOSEMPRESAS " & vData)
        If myData.Tables(0).Rows.Count <= 0 Then
    ...
    Public Sub Delete(ByVal vData)
        ExecuteNonQuery("SP_DE_ContatoEmpresas " & vData)
        Clear()
    End Sub
    ...
    Public Function List(ByVal vIDEmpresa As Integer) As DataSet
        Try
            List = GetDataSet("SP_SE_CONTATOSEMPRESAS 0, " & vIDEmpresa)
        Catch e As Exception
