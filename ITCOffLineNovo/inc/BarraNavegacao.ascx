<%@ Control Language="vb" AutoEventWireup="false" Codebehind="BarraNavegacao.ascx.vb" Inherits="ITCOffLine.BarraNavegacao" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table id="tblbarranavegacao" borderColor="#003c6e" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0" runat="server">
	<tr>
		<td align="middle">
	...
	<tr>
		<td align="middle"><asp:Label ID="lblDescricao" CssClass="f8" Runat="server"></asp:Label></td>
	</tr>
</table>
