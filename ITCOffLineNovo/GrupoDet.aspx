...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="GrupoDet.aspx.vb" ValidateRequest="False" Inherits="ITCOffLine.GrupoDet" %>
						...
						<table width="70%" border="0" bgcolor="#efefef">
							...
							<tr>
								<td width="50%" nowrap>
									...
									<asp:textbox id="txtGrupo" CssClass="f8" runat="server" MaxLength="80" Width="75%"></asp:textbox>
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							...
							<tr>
								<td align="middle"><uc1:BarraBotoes id="Barra" runat="server"></uc1:BarraBotoes></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
