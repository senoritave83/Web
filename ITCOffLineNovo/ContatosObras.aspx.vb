...
Public Class ContatosObras
    ...
    Protected WithEvents btnRepetir As Button
    ...
    Protected WithEvents hdRepetir As System.Web.UI.HtmlControls.HtmlInputHidden
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            btnRepetir.Visible = ViewState("IDContato") > 0
    ...
    Private Sub BarraBotoes_Incluir() Handles Barra.Incluir
        ...
        Response.Redirect("ContatosObras.aspx?IDContato=" & CryptographyEncoded("0") & "&IDObra=" & CryptographyEncoded(ViewState("IDObra")) & "&R=1")
    ...
    Private Sub BarraBotoes_Atualizar() Handles Barra.Gravar
        Deflate()
        Contato.Update()
        Gravado("contatosobras.aspx?idcontato=" & CryptographyEncoded(Contato.IdContato) & "&idobra=" & CryptographyEncoded(ViewState("IDObra")))
    End Sub
    ...
    Private Sub Inflate()
        ...
        End With
        Barra.AtivarBotoes(IIf(CheckPermission("Contatos da Obra", "Incluir") = True, BarraBotoes2.Botoes_Ativos.Incluir, 0) + IIf(CheckPermission("Contatos da Obra", "Atualizar") = True, BarraBotoes2.Botoes_Ativos.Atualizar, 0) + IIf(CheckPermission("Contatos da Obra", "Apagar") = True, BarraBotoes2.Botoes_Ativos.Excluir, 0) + BarraBotoes2.Botoes_Ativos.Voltar)
    End Sub
    ...
    Private Sub BarraBotoes_Excluir() Handles Barra.Excluir
        ...
        Contato = New clsContatoObras(Me)
        Contato.Delete(ViewState("IDContato"), ViewState("IDObra"))
        Response.Redirect("obrasdet.aspx?codigo=" & CryptographyEncoded(ViewState("IDObra")))

    End Sub

    Private Sub btnRepetir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRepetir.Click

        ViewState("IDContato") = 0
        txtNome.Text = ""
