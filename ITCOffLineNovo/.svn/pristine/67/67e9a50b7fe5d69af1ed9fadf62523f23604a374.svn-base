...
#Region "Bind Controles"
    ...
    Private Sub BindLogs()
        ...
        If lstLog.Items.Count = 0 Then
            lstLog.Items.Add("Este Pedido não sofreu alterações!")
        End If
    End Sub
...
#End Region
    ...
    Private Sub CamposReadOnly()
        ...
        'SE O PEDIDO NÃO EXISTIR OU SE O STATUS FOR DIFERENTE DE "EM ANDAMENTO" OS CAMPOS NÃO PODERAM SOFRER ALTERAÇÕES
        If ViewState("IdPedido") = 0 Or ViewState("IdStatus") <> 1 Then
            ...
            'SE O STATUS DO PEDIDO FOR DIFERENTE DE "EM ANDAMENTO" O PEDIDO NÃO PODERÁ SOFRER ALTERAÇÕES
            If ViewState("IdStatus") <> 1 And ViewState("IdStatus") <> Nothing Then
                ...
                'SE O PEDIDO ESTIVER CANCELADO, SÓ MOSTRA O BOTÃO VOLTAR
        ...
        Else
            ...
            'SE O STATUS DO PEDIDO FOR "EM ANDAMENTO" OS CAMPOS PODEM SOFRER ALTERAÇÕES
