<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UsuarioPermissao.aspx.vb" ValidateRequest="False" Inherits="ITCOffLine.UsuarioPermissao" %>
									...
									<table width="100%">
										<tr>
											...
											<td width="60%" valign="top" colspan=5>
												...
												<table width="100%" bgColor="#003c6e" border="0">
													<tr>
														<td noWrap align="middle"><font class="f8" color="#ffffff"><b>ESTADOS</b><input type="button" onclick="javascript:MarcaTodosEstados();" class="f8" value="TODOS" id="btnMarcarTodosEstados" NAME="btnMarcarTodosEstados"></td>
													</tr>
												</table>
