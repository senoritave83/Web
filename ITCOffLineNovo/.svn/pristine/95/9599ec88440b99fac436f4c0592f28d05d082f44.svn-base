...
#End Region
    ...
    Private Sub BarraBotoes_Incluir() Handles Barra.Incluir
        Response.Redirect("contatosempresas.aspx?idcontato=" & CryptographyEncoded("0") & "&idempresa=" & CryptographyEncoded(ViewState("IDEmpresa")))
    End Sub
    ...
    Private Sub BarraBotoes_Atualizar() Handles Barra.Gravar
        Deflate()
        Contato.Update()
        Gravado("contatosempresas.aspx?idcontato=" & CryptographyEncoded(Contato.IdContato) & "&idempresa=" & CryptographyEncoded(ViewState("IDEmpresa")))
    End Sub
    ...
    Private Sub Inflate()
        ...
        End With
        Barra.AtivarBotoes(IIf(CheckPermission("Contatos da Empresa", "Adicionar"), BarraBotoes2.Botoes_Ativos.Incluir, 0) + IIf(CheckPermission("Contatos da Empresa", "Atualizar"), BarraBotoes2.Botoes_Ativos.Atualizar, 0) + IIf(CheckPermission("Contatos da Empresa", "Apagar"), BarraBotoes2.Botoes_Ativos.Excluir, 0) + BarraBotoes2.Botoes_Ativos.Voltar)
    End Sub
