<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Associados.aspx.vb" ValidateRequest="False" Inherits="ITCOffLine.Associados" %>
				...
				<td valign="top" align="middle">
					<form id="frmCad" runat="server">
							...
							<tr>
								<td>
									...
									<table width="100%" border="0" bgcolor=#FFFFFF>
										<tr>
											<td nowrap width=50%>
												<asp:label Runat=server CssClass="f8" ID="Label2">Código ITC</asp:Label><br>
												<asp:TextBox CssClass="f8"  ID="txtCodigoITC" Style="width:100%" Runat="server" MaxLength="20"></asp:TextBox>
											</td>
											<td nowrap width=50%>
						...
						<table cellspacing=0 cellpadding=0 width=90% border=1 bordercolor=#003C6E>
							<tr>
								<td>
								<asp:DataGrid id="dtgAssociados" CssClass="f8" runat="server" AllowPaging="True" OnPageIndexChanged="doPaging" AllowSorting="True" PageSize="8" BorderColor="#999999" BorderStyle="None" BackColor="White" CellPadding="3" GridLines="none" AutoGenerateColumns="False" width="100%">
								...
								<Columns>
									<asp:TemplateColumn ItemStyle-Width=25>
										<ItemTemplate>
											<a href="AssociadosDet.aspx?Codigo=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "Codigo"))%>"><img src='imagens/bolaverde.gif' border=0 width="25" height="25" ></a>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn ItemStyle-VerticalAlign=Middle HeaderText="CÓDIGO ITC" ItemStyle-Wrap=False HeaderStyle-Font-Bold=True>
										<ItemTemplate>
											<a href="AssociadosDet.aspx?Codigo=<%# CryptographyEncoded(DataBinder.Eval(Container.DataItem, "Codigo"))%>"><asp:Label ID=lblCodigo Runat=server ><%# Right("000000" & DataBinder.Eval(Container.DataItem, "Codigo"), 6)%></asp:Label></a>
										</ItemTemplate>
									</asp:TemplateColumn>
