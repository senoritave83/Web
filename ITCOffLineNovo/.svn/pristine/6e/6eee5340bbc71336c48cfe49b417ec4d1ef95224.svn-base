<%@ Page Language="vb" AutoEventWireup="false" Codebehind="agradecimento.aspx.vb" ValidateRequest="False" Inherits="ITCOffLine.agradecimento" %>
...
<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" >
    <form id="frmveja" runat="server">
		<Table id="tblMain" runat="server" bgcolor="#efefef" width="400" height="200" align="center" cellpadding="0" cellspacing="0"  border="0">
			<TR bgcolor="#003c6e">
				<TD ColSpan="2" Align="center"><font class="f10" color="#ffffff"><b>Envie um e-mail para o contato</b></font></TD>
			</TR>
			<TR>
				<TD align="right" width='80'>
					<font class="f8h" color="#000000">Código:&nbsp;</font>
				</TD>
				<TD nowrap>
					<asp:TextBox class="f8h" id="txtCod" runat="server" ></asp:TextBox>
				</TD>
			</TR>
			<TR>
				<TD align="right" width='80'>
					<asp:Label class="f8h" id="lblAC" runat="server" text="A/C:&nbsp;"></asp:Label>
				</TD>
				<TD nowrap>
					<asp:TextBox id="txtac" runat="server" Width="280" MaxLength="50" ></asp:TextBox>
				</TD>
			</TR>
			<TR>
				<TD align="right" width='80'>
					<asp:Label class="f8h" id="lblEmail" runat="server" text="E-mail:&nbsp;"></asp:Label>
				</TD>
				<TD nowrap>
		...
		<Table id="tblResult" runat="server" bgcolor="#efefef" width="400" height="200" visible="false" align="center" cellpadding="0" cellspacing="0"  border="0">
			<TR bgcolor="#003c6e">
				<TD Align="center">
