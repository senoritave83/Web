<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EmailProposta.aspx.vb" Inherits="ITCOffLine.EmailProposta"%>
<HTML>
	<HEAD>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="frmveja" runat="server">
			<Table id="tblMain" runat="server" bgcolor="#efefef" width="400" height="200" align="center"
				...
				<TR bgcolor="#003c6e">
					<TD ColSpan="2" Align="center"><font class="f10" color="#ffffff"><b>Envie um e-mail da proposta nº<%= ViewState("IdProp") %></b></font>
					</TD>
				</TR>
				<TR>
