...
Partial Class _Default
    ...
    Protected Sub ReportChart()
        ...
        'EXEMPLO DE ESTRUTURA DO XML RESPONSÁVEL 
        'PELO RELATÓRIO NA PÁGINA HOME/DEFAULT.ASPX
        'DENTRO DO ARQUIVO SETTINGS.XML
        'ALTERAÇÃO FEITA PARA SUPORTAR MÚLTIPLOS RELATÓRIOS
        'AUTOR: MARCELO R
        'DATA : 17/08/2011
        '<ReportViewer visible="true">
        '  <Relatorios>
        '    <Relatorio Nome="Relatório Home" NomeTela="Preço Médio de Produtos por Região"></Relatorio>
        '    <Relatorio Nome="Relatório Home Abastecimento" NomeTela="Abastecimento de Produtos por Região"></Relatorio>
        '  </Relatorios>
        '</ReportViewer> 
