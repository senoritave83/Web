...
Namespace Classes
	...
	#Region "Declarations" 
        ...
        Protected m_lngLongitude As String
        Protected m_lngLatitude As String
...
#Region "Properties"
        ...
        Public Overridable Property Longitude() As String
            Get
                Return m_lngLongitude
            End Get
            Set(ByVal Value As String)
                m_lngLongitude = Value
            End Set
        End Property
...
#Region "Metodos"
        ...
        Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            If dr.IsDBNull(dr.GetOrdinal("Latitude")) Then
                m_lngLatitude = 0
            Else
                m_lngLatitude = dr.Item(dr.GetOrdinal("Latitude"))
            End If

            If dr.IsDBNull(dr.GetOrdinal("Longitude")) Then
                m_lngLongitude = 0
            Else
                m_lngLongitude = dr.Item(dr.GetOrdinal("Longitude"))
            End If
        ...
        Public Sub Update()
            ...
            cmd.Parameters.Add("@LATITUDE", SqlDbType.VarChar, 30).Value = m_lngLatitude
            cmd.Parameters.Add("@LONGITUDE", SqlDbType.VarChar, 30).Value = m_lngLongitude
            ...
            Me.User.Log("Cadastro de Lojas", "Gravar - IDLOJA=" & m_intIDLoja & " IDCLIENTE=" & m_intIDCliente & " CODIGO=" & m_strCodigo & " LOJA=" & m_strLoja & " CNPJ=" & m_strCNPJ & _
                        ...
                        " RAZAOSOCIAL=" & m_strRazaoSocial & " GERENTELOJA=" & m_strGerenteLoja & " IMAGEM=" & m_strImagem & " LATITUDE=" & m_lngLatitude & " LONGITUDE=" & m_lngLongitude)
        ...
        Public Sub Delete()
            ...
            MyBase.LogEvent("User '" & User.Name & "', IDUser=" & User.IDUser & " is deleting on table 'Loja' the following row:  IDLoja=" & m_intIDLoja & " IDEmpresa=" & User.IDEmpresa & "", "Data Writing", 0, System.Diagnostics.TraceEventType.Information)
            Clear()
