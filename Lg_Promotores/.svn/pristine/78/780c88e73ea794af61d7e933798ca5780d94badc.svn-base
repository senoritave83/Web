<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="rptPrecos.aspx.vb" Inherits="reports_rptPrecos" title="XM Promotores - Yes Mobile" %>
    ...
    <script type="text/javascript">
       ...
       /* function XM_RadioButtonValue_Shopping() { 
        ...
        function showReport(){
                    ...
                    /*SegmentoS*/
				    var p_IdCategoria = '';
				    for (var i=0; i<document.aspnetForm.ctl00_ContentPlaceHolder1_lstCategoria.options.length; i++) 
				    { 
					    if(document.aspnetForm.ctl00_ContentPlaceHolder1_lstCategoria.options[i].selected == true)
					    {
						    p_IdCategoria += document.aspnetForm.ctl00_ContentPlaceHolder1_lstCategoria.options[i].value + ',';
					    }
				    }    								
				    if(p_IdCategoria == '')
				    {
					    alert('É NESCESSÁRIO SELECIONAR UM SEGMENTO');
					    return false;
				    }
				    ...
				    { 
					    ...
					    {
						    if(p_IdProduto!='')p_IdProduto += ',';
						    p_IdProduto += document.aspnetForm.ctl00_ContentPlaceHolder1_lstSubCategoria.options[i].value;
					    }
				    }
				    
                    /*ProdutoS*/
                    var p_IdItem = '';
				    for (var i=0; i<document.aspnetForm.ctl00_ContentPlaceHolder1_lstProduto.options.length; i++) 
				    { 
					    if(document.aspnetForm.ctl00_ContentPlaceHolder1_lstProduto.options[i].selected == true)
					    {
						    if(p_IdItem!='')p_IdItem += ',';
						    p_IdItem += document.aspnetForm.ctl00_ContentPlaceHolder1_lstProduto.options[i].value;
					    }
				    }
				    ...
				    var win = window.open('rptprecosdet.aspx?cl=' + p_IdCliente + '&lj=' + p_IdLoja + '&it=' + p_IdItem + 
														    '&ct=' + p_IdCategoria + '&pd=' + p_IdProduto + 
														    '&per=' + p_Periodo + '&pertxt=' + p_PeriodoText + '&est=' + p_Estado + 
														    '&tip=' + p_TipoLoja + '&regs=' + p_Regiao + 
														    '&sta=' + p_Status + '&sp=' + p_IdShopping);
            
            }
    </script>
	<asp:ScriptManager EnableScriptGlobalization="true" EnableScriptLocalization="true" runat="Server" ID="sctRptPrecos"></asp:ScriptManager>
    <div class='ReportArea'>
        <table class="AreaSubTitulo" id='Table1' border="0" width="100%">
		    <tr class='trField'>
			    ...
			    <td>
                    <asp:UpdateProgress ID="updProgressPrecos" runat="Server" AssociatedUpdatePanelID="updrptPrecos">
                        <ProgressTemplate>
        ...
        <asp:UpdatePanel runat="Server" ID="updrptPrecos">
                                ...
                                <table id='tblClientesLojas' cellspacing="2" border="0" width="100%">
			                        <tr>
				                        <td valign="top">
					                        ...
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="Fantasia" DataValueField="IdCliente" style="width:350;" runat="Server" ID="lstClientes"></asp:ListBox>
			                        ...
			                        <tr>
				                        <td valign="top">
				                            Loja<br />
				                            <asp:ListBox SelectionMode="Multiple" DataTextField="Loja" DataValueField="IdLoja" style="width:350;" runat="Server" ID="lstLojas"></asp:ListBox>
				                        </td>
			                        </tr>
				                    <tr>
				                        <td valign="top">
	                                        Shopping:<br />
	                                        <asp:ListBox SelectionMode="Multiple" DataTextField="Shopping" DataValueField="IdShopping" style="width:350;" runat="Server" ID="lstShopping"></asp:ListBox>
				                        </td>
			                        </tr>
		                        </table>
                            </div>
                            <div id='divProdutos'>
                                <table id='tblProdutos'>
                                    <tr>
				                        <td valign="top">
					                        Segmento:<br />
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="Categoria" DataValueField="IdCategoria" style="width:350" runat="Server" ID="lstCategoria"></asp:ListBox>
					                        <asp:Button runat="Server" ID="btnVisSubCat" Text="Visualizar Categorias" />
				                        </td>
                                    </tr>                                
                                    <tr>
				                        <td valign="top">
					                        Categoria:<br />
                                            <asp:ListBox SelectionMode="Multiple" DataTextField="SubCategoria" DataValueField="IdSubCategoria" style="width:350;" runat="Server" ID="lstSubCategoria"></asp:ListBox>
					                        <asp:Button runat="Server" ID="btnVisProd" Text="Visualizar Produtos" />
				                        </td>
                                    </tr>
                                    <tr>
				                        <td valign="top">
					                        Produto:<br />
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="DescricaoResumida" DataValueField="IdProduto" style="width:350;" runat="Server" ID="lstProduto"></asp:ListBox>
				                        </td>
                                    </tr>
                                </table>                             
                            </div>
                            ...
                            <table id='tblRegioes' cellspacing="2" cellpadding="2" border="0" width="100%">
                                <tr >
	                                <td width="50%" valign="top">
	                                    Tipo de Loja:
	                                    <asp:CheckBoxList CssClass='tdFieldHeader' RepeatDirection="Horizontal" RepeatColumns="2" RepeatLayout="Table" DataTextField="TipoLoja" DataValueField="IdTipoLoja" style="width:100%" runat="Server" ID="chkTipoLoja"></asp:CheckBoxList>
	                                    <asp:Literal runat="Server" ID="ltScriptTipoLoja"></asp:Literal>
	                                </td>
	                                <td width="50%">
		                                Regi&atilde;o:
                                        <asp:CheckBoxList CssClass='tdFieldHeader' RepeatDirection="Horizontal" DataTextField="Regiao" RepeatColumns="2" DataValueField="IdRegiao" style="width:100%" runat="Server" ID="chkRegiao"></asp:CheckBoxList>
                                ...
                                <tr class='trField'>
                                    <td width="50%" valign="top">
                                        Status da Loja:<br />
                                        <input checked="true" type="radio" id="rdAtivo0" name="rdAtivo" value="2" />Todas&nbsp;<input type="radio" id="rdAtivo1" name="rdAtivo" value="0" />Inativo&nbsp;<input id="rdAtivo2" type="radio" name="rdAtivo" value="1" />Ativo
                                    </td>
                                    <td width="50%" rowspan="2" valign="bottom">
				                        UF:<br />
				                        <asp:CheckBoxList CSSclass='tdFieldHeader' RepeatColumns="9" RepeatDirection="Horizontal" Runat="server" ID="chkEstado">
                                ...
                                <tr>
                                    <td width="100%" valign="top">
                                        ...
                                        <font class="content_text">&nbsp;até&nbsp;</font>
                                                <asp:TextBox runat="Server" MaxLength="10" CssClass="form_text" id="txtDataFinal" name="txtDataFinal"
													onkeydown="FormataData(this, event);" onblur="VerificaData(this);"></asp:TextBox>
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="btnVisSubCat" EventName="Click" />
                <asp:AsyncPostBackTrigger ControlID="btnVisProd" EventName="Click" />
            </Triggers>
		</asp:UpdatePanel>
	</div>
