<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="Permissoes.aspx.vb" Inherits="Pages.Cadastros.Permissoes" title="XM Promotores - Yes Mobile" %>
