		...
		<table id='tblEditArea'>
			...
			<tr class='trField'>
				...
				<td class='tdField'>
					...
					<asp:RequiredFieldValidator runat='server' ID='valReqCategoriaCombinada' Display='None' ErrorMessage='<%$Settings: RequiredMessage, Categoria.Categoria, "Categoria combinada é um campo obrigat&oacute;rio!"%>' ControlToValidate='txtCategoriaCombinada' />
				</td>
			</tr>
			<tr class='trField'>
				<td class='tdFieldHeader'>
