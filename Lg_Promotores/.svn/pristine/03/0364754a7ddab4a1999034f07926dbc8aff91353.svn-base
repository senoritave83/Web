...
Namespace Classes
    ...
    #Region "Metodos"
        ...
        Public Function GetRotaVisita(ByVal vIDEmpresa As Integer, ByVal vIDVisita As Integer, ByVal vTipoMapa As Integer) As DataSet

            Dim cmd As New SqlCommand()
            cmd.CommandText = PREFIXO & "RPT_ROTA_VISITA"

            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add("@IDEMPRESA", SqlDbType.Int).Value = vIDEmpresa
            cmd.Parameters.Add("@IDVISITA", SqlDbType.Int).Value = vIDVisita
            cmd.Parameters.Add("@SEQUENCIA", SqlDbType.Int).Value = vTipoMapa
