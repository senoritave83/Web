<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="rptResPOP.aspx.vb" Inherits="reports_rptResPOP" title="XM Promotores - Yes Mobile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        ...
        function showReport(){
                    ...
                    var URL = 'rptResPOPDet.aspx?cli=' + p_IdCliente + '&loj=' + p_IdLoja + 
				    ...
				    var win = window.open(URL, 'RPTRESUMOPOP', 'location = no, toolbar = yes, scrollbars = yes, resizable = yes');
                        ...
                        <td>
                            <table id='tblRegioes' cellspacing="2" cellpadding="2" border="0" width="100%">
                                ...
                                <tr>
                                    <td width="50%" valign="top">
                                        Status da Loja:<br />
                                        <input checked="true" type="radio" id="rdAtivo0" name="rdAtivo" value="2" />Todas&nbsp;
                                        <input type="radio" id="rdAtivo1" name="rdAtivo" value="0" />Inativo&nbsp;
                                        <input id="rdAtivo2" type="radio" name="rdAtivo" value="1" />Ativo
                                    </td>
                                ...
                                <tr>
                                    <td width="100%" valign="top"  colspan="2">
                                        Per&iacute;odo:<br />
										De&nbsp;<asp:TextBox runat="server" MaxLength="10" CssClass="form_text" ID="txtDataInicial" 
										name="txtDataInicial" onkeydown="FormataData(this, event);" onblur="VerificaData(this);">
										</asp:TextBox>
										...
										<font class="content_text">&nbsp;até&nbsp;</font><asp:TextBox runat="server" MaxLength="10" CssClass="form_text" ID="txtDataFinal" 
										name="txtDataFinal" onkeydown="FormataData(this, event);" onblur="VerificaData(this);">
										</asp:TextBox>
