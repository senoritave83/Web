...
Namespace Pages.Cadastros.export
    ...
    Partial Public Class TipoJustificativas
        Inherits XMWebPage
        
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
			Dim cls As new clsTipoJustificativa
			...
			Response.AddHeader("Content-Disposition", "inline; filename=EXPORTACAO_TipoJustificativas_" & Now.ToString("ddMMyyyyhhmmss") & ".xls")
