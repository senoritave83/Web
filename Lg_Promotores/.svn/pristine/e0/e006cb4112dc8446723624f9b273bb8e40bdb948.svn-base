<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="Lideres.aspx.vb" Inherits="Pages.Cadastros.Lideres" title="XM Promotores - Yes Mobile" %>
...
<script>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting="true">
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDCoordenador,IDLider" DataNavigateUrlFormatString="Lider.aspx?IDCoordenador={0}&IDLider={1}" DataTextField="Lider" HeaderText='<%$Settings: caption, Promotor.FiltroLider, "Lider" %>' SortExpression="Lider"  />
					...
					<EmptyDataTemplate>
					    <div class='divEmptyRow'>
					        N&atilde;o h&aacute; lideres com o filtro selecionado!
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
    ...
    <div class='AreaBotoes'>
        ...
        <uc3:ExportButton ID="ExportButton1" runat="server" visible='<%$Settings: visible, Lider.Exportar, false %>' />
    </div>
    <div class='AreaAjuda'>
