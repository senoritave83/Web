                    ...
                    <tr>
                        <td style="width:300px;">
                            <div style="width:300px;">
		                        <asp:Literal ID="ltrCoordenador" runat="server" Text='<%$Settings: caption, Promotor.FiltroCoordenador, "Coordenadores" %>' /><br>			
		                        <asp:ListBox SelectionMode=Multiple style="width:300px;HEIGHT:150PX;" runat="server" ID="lstCoordenador" DataTextField="Coordenador" DataValueField="IdCoordenador"></asp:ListBox>
                                <asp:Button id="btlVerLideres" Runat="server" Text="Visualizar Líderes" CssClass="Botao"></asp:Button>
		                    </div>
                        </td>
                        <td>
                            <div style="width:300px;">
		                        <asp:Literal ID="ltrLider" runat="server" Text='<%$Settings: caption, Promotor.FiltroLider, "Lideres" %>' /><br>			
                                <asp:ListBox SelectionMode=Multiple style="width:300px;HEIGHT:150PX;" runat="server" ID="lstLider" DataTextField="Lider" DataValueField="IdLider"></asp:ListBox>
		                        <asp:Button style="width:200px;" id="btnVerPromotor" Runat="server" Text="Visualizar Promotores" CssClass="Botao"></asp:Button>
		                    </div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan='2'>
                            <div style="width:600px;">
                                ...
                                <asp:ListBox SelectionMode=Multiple style="width:600px;HEIGHT:150PX;" runat="server" ID="LstPromotor" DataTextField="Promotor" DataValueField="IdPromotorTelefone"></asp:ListBox>
		                    </div>
                        </td>
                    </tr>
                </table>
