    ...
    <div class='EditArea'>
		<table id='tblEditArea'>
			...
			<tr class='trField'>
				...
				<td class='tdField'>
					<asp:TextBox runat='server' ID='txtTipoLoja' MaxLength='50' />
					<asp:RequiredFieldValidator runat='server' ID='valReqTipoLoja' Display='None' ErrorMessage='Tipo de Loja &eacute; um campo obrigat&oacute;rio!' ControlToValidate='txtTipoLoja' />
				</td>
			</tr>
			<tr class='trField'>
				<td class='tdFieldHeader'>
