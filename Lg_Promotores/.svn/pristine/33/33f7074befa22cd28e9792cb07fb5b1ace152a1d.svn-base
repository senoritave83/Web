<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="Resolucoes.aspx.vb" Inherits="Pages.Cadastros.Resolucoes" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDResolucao" DataNavigateUrlFormatString="Resolucao.aspx?IDResolucao={0}" DataTextField="Resolucao" HeaderText="Resolução" SortExpression="Resolucao"  />
					</columns>
					<EmptyDataTemplate>
    ...
    <div class='AreaBotoes'>
        ...
        <input type="button" class="Botao" value=" Voltar " onclick="location.href='Resolucoes.aspx'" />
    </div>
    <div class='AreaAjuda'>
