...
Namespace Classes
	...
	#Region "Declarations" 
        ...
        Protected m_varPoliticaPrecoMinimo As Decimal
        Protected m_varPoliticaPrecoMaximo As Decimal
	...
	#Region "Properties" 
        ...
        Public Overridable Property PoliticaPrecoMinimo As Decimal
            Get
                Return m_varPoliticaPrecoMinimo
            End Get
            Set(ByVal Value As Decimal)
                m_varPoliticaPrecoMinimo = Value
            End Set
        End Property

        Public Overridable Property PoliticaPrecoMaximo As Decimal
            Get
                Return m_varPoliticaPrecoMaximo
            End Get
            Set(ByVal Value As Decimal)
                m_varPoliticaPrecoMaximo = Value
            End Set
        End Property
...
#Region "Metodos"
        ...
        Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            If dr.IsDBNull(dr.GetOrdinal("PoliticaPrecoMinimo")) Then
                m_varPoliticaPrecoMinimo = Nothing
            Else
                m_varPoliticaPrecoMinimo = dr.GetDecimal(dr.GetOrdinal("PoliticaPrecoMinimo"))
            End If

            If dr.IsDBNull(dr.GetOrdinal("PoliticoPrecoMaximo")) Then
                m_varPoliticaPrecoMaximo = Nothing
            Else
                m_varPoliticaPrecoMaximo = dr.GetDecimal(dr.GetOrdinal("PoliticoPrecoMaximo"))
            End If
        ...
        Public Sub Update()
            ...
            cmd.Parameters.Add("@POLITICAPRECOMINIMO", SqlDbType.Money).Value = m_varPoliticaPrecoMinimo
            cmd.Parameters.Add("@POLITICAPRECOMAXIMO", SqlDbType.Money).Value = m_varPoliticaPrecoMaximo
            ...
            Me.User.Log("Cadastro de Produtos", "Gravar - IDPRODUTO=" & m_intIDProduto & " CODIGO=" & m_strCodigo & " DESCRICAO=" & m_strDescricao & _
                        ...
                        " PRECOMINIMO=" & m_varPrecoMinimo & " PRECOMAXIMO=" & m_varPrecoMaximo & " POLITICAPRECOMINIMO=" & m_varPoliticaPrecoMinimo & " POLITICAPRECOMAXIMO=" & m_varPoliticaPrecoMaximo & " PRECOSUGERIDO=" & m_varPrecoSugerido & _
                        " STATUSCOMERCIO=" & m_indStatusComercio & " STATUSPESQUISA=" & m_indStatusPesquisa)
