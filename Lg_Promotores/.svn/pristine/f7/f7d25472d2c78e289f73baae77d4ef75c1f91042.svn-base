...
Partial Class formulario_produtos
    Inherits XMWebPage
    ...
    Protected Sub BindGrid()
        ...
        Paginate1.DataBind()
        xmProdutos.RowDataSource = ret.Data.Tables(1).Rows
        xmProdutos.ColDataSource = ret.Data.Tables(2).Rows
        xmProdutos.DataSource = ret.Data.Tables(3).Rows
    ...
    Protected Sub xmProdutos_ItemDataBound(ByVal sender As Object, ByVal e As XMSistemas.Web.UI.WebControls.XMCrossRepeaterItemEventArgs) Handles xmProdutos.ItemDataBound
        If e.Item.ItemType = XMSistemas.Web.UI.WebControls.XMCrossRepeater.CrossItemType.DataItem Then
            Dim ctr As formulario_pergunta = e.Item.FindControl("pergunta1")
            If (e.Item.DataItem("Acao") And 4) <> 0 Then
                ...
                If e.Item.DataItem("TipoCampo") = 0 Then
                    dr = prds.ListarRespostas(e.Item.DataItem("IDProduto"), ViewState("IDVISITA"), e.Item.DataItem("IDPergunta"), DataClass.enReturnType.DataSet)
                End If
