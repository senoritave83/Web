...
Namespace Classes
    ...
    Public Class clsFormVisita
        ...
        Public Function ListarProdutos(ByVal vIDCategoria As Integer, ByVal vIDFornecedor As Integer, Optional ByVal vReturnType As enReturnType = enReturnType.DataReader) As Object
