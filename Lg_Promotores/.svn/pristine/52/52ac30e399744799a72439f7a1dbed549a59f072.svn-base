...
#Region "Declarations"
        ...
        Protected m_indAtivo As Boolean
#End Region
...
#Region "Metodos"
        ...
        Protected Overridable Sub Inflate(ByVal dr As IDataReader)
            ...
            m_indAtivo = IIf(dr.GetByte(dr.GetOrdinal("Ativo")) = 0, False, True)
        ...
        Public Sub Update()
            ...
            cmd.Parameters.Add("@Ativo", SqlDbType.TinyInt).Value = IIf(m_indAtivo = False, 0, 1)
