...
Partial Class reports_Relatorio
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Response.Write("<!-- PERIODO DE DATAS: " & PossuiPeriodoDatas & "-->")
    ...
    Protected Sub btnGravar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGravar.Click
        ...
        '----------------------------------------------------------------
        'Verificando se existe o parametro TIPODATAS no relatório
        'se existir, será excluído da tela antes de gravar o agendamento
        '30/10/2012 - Marcelo e Wilson
        '----------------------------------------------------------------
        'Dim prmDel As XMReportParameter = Nothing
        'For Each prm In XMReportFilters1.Parameters

        '    If prm.Name.ToUpper = "TIPODATAS" Then
        '        prmDel = prm
        '    End If

        'Next
        'If Not prmDel Is Nothing Then
        '    XMReportFilters1.Parameters.Remove(prmDel)
        'End If
