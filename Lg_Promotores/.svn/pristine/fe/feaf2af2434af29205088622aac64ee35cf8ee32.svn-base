<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Roteiro.ascx.vb" Inherits="Controls.Roteiro" %>
        <asp:Panel runat='server' ID='pnlRoteiro'>
		    ...
		    <asp:Panel runat='server' ID='pnlMes' Width="25%">
		    ...
		    <asp:Panel runat='server' ID='pnlDiaSemana' Width="20%">
            ...
            <asp:Panel runat='server' ID='pnlSemanaMes' Width="150px">
		        <asp:label ID="Label1" Runat="server">Número da Semana:</asp:label><a href='javascript:fncLimparChecks("<%=chkSemanaMes.ClientID%>_");' class='LinkLimpar'>Limpar</a><br />
			    <asp:checkboxlist id="chkSemanaMes" Runat="server" Width="100%" RepeatDirection="Horizontal" RepeatColumns="1">
				    <asp:ListItem Value="1">Primeira Semana</asp:ListItem>
				    <asp:ListItem Value="2">Segunda Semana</asp:ListItem>
				    <asp:ListItem Value="4">Terceira Semana</asp:ListItem>
				    <asp:ListItem Value="8">Quarta Semana</asp:ListItem>
				    <asp:ListItem Value="16">Quinta Semana</asp:ListItem>
                    <asp:ListItem Value="32">Sexta Semana</asp:ListItem>
			    </asp:checkboxlist>			    
		    </asp:Panel>
        </asp:Panel>            
