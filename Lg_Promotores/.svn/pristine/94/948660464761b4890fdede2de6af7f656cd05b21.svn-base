...
Namespace Pages.Cadastros
    ...
    Partial Public Class SubCategorias
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDCategoria.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE)
