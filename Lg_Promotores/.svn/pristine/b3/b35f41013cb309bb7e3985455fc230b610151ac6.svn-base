<%@ Page Language="VB" MasterPageFile="~/Cadastros\/export/export.master" AutoEventWireup="false" CodeFile="Operadoras.aspx.vb" Inherits="Pages.Cadastros.export.Operadoras" title="XM Promotores - Yes Mobile" %>
