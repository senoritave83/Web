<%@ Control Language="VB" AutoEventWireup="false" CodeFile="pergunta.ascx.vb" Inherits="formulario_pergunta" %>
...
<asp:Panel runat='server' id='divControl' class='ControlPergunta'>
    ...
    <asp:DropDownList runat='server' ID='cboLista' DataTextField='Resposta' DataValueField='Resposta'></asp:DropDownList>
    <asp:TextBox runat='server' ID='txtResposta' />
