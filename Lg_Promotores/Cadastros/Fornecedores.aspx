		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting="true">
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDFornecedor" DataNavigateUrlFormatString="Fornecedor.aspx?IDFornecedor={0}" DataTextField="Fornecedor" HeaderText="Marca" SortExpression="Fornecedor"  />
