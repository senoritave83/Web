    ...
    Partial Public Class MensagemDias
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                If Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, txtDataInicioInicial, txtDataInicioFinal, cboIDCategoria) = False Then
                    'txtDataInicioInicial.Text = Now.ToString("dd/MM/yyyy")
                    'txtDataInicioFinal.Text = Now.ToString("dd/MM/yyyy")
                End If
        ...
        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, txtDataInicioInicial.Text, txtDataInicioFinal.Text, cboIDCategoria.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, txtDataInicioInicial, txtDataInicioFinal, cboIDCategoria)
