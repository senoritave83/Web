<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="MotivoUsoFormularios.aspx.vb" Inherits="Pages.Cadastros.MotivoUsoFormularios" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDMotivoUsoForm" DataNavigateUrlFormatString="MotivoUsoFormulario.aspx?IDMotivoUsoForm={0}" DataTextField="MotivoUsoForm" HeaderText="MotivoUsoForm" SortExpression="MotivoUsoForm"  />
					</columns>
					<EmptyDataTemplate>
				        <div class='GridHeader'>&nbsp;</div>					    
					    <div class='divEmptyRow'>
							<asp:Label runat='server' ID='lblNaoEncontrados'>
								N&atilde;o h&aacute; MotivoUsoFormularios com o filtro selecionado!
							</asp:Label>
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
