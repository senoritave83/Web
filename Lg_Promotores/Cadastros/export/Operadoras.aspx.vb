...
Namespace Pages.Cadastros.export
    ...
    Partial Public Class Operadoras
        Inherits XMWebPage
        
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
			Dim cls As new clsOperadora
			...
			Response.AddHeader("Content-Disposition", "inline; filename=EXPORTACAO_Operadoras_" & Now.ToString("ddMMyyyyhhmmss") & ".xls")
