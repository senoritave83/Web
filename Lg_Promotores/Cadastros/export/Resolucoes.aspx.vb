...
Namespace Pages.Cadastros.export
    ...
    Partial Public Class Resolucoes
        Inherits XMWebPage
        
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
			Dim cls As new clsResolucao
			...
			Response.AddHeader("Content-Disposition", "inline; filename=EXPORTACAO_Resolucoes_" & Now.ToString("ddMMyyyyhhmmss") & ".xls")
