...
Namespace Pages.Cadastros.export
    ...
    Partial Public Class ScreenSizes
        Inherits XMWebPage
        
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
			Dim cls As new clsScreenSize
			...
			Response.AddHeader("Content-Disposition", "inline; filename=EXPORTACAO_ScreenSizes_" & Now.ToString("ddMMyyyyhhmmss") & ".xls")
