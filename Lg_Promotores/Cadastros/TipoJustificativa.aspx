    ...
    <div class='EditArea'>
		<table id='tblEditArea'>
			...
			<tr class='trField'>
				...
				<td class='tdField'>
					<asp:TextBox runat='server' ID='txtTipoJustificativa' MaxLength='50' Width="60%" />
			...
			<tr class='trField'>
				...
				<td class='tdField'>
					<asp:RadioButtonList runat="server" ID="rdAbono" RepeatColumns="2" RepeatDirection="Horizontal" CssClass='tblAbono' RepeatLayout='Flow'>
