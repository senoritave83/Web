...
Namespace Pages.Cadastros
    ...
    Partial Public Class Produtos
        ...
        Public Sub BindGrid()
            ...
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDCategoria.SelectedValue, cboIDSubCategoria.SelectedValue, cboIDFornecedor.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE, rdStatusProduto.SelectedItem.Value)
