<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="rptResumoMostruario.aspx.vb" Inherits="reports_rptResumoMostruario" title="XM Promotores - Yes Mobile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function showReport(){
                    ...
                    var URL = 'rptResumoMostruariodet.aspx?pi=' + document.aspnetForm.ctl00_ContentPlaceHolder1_txtDataInicial.value + '&pf=' + document.aspnetForm.ctl00_ContentPlaceHolder1_txtDataFinal.value + '&rg=' + p_Regiao + 
                            '&est=' + p_Estado + '&tp=' + p_TipoLoja + '&sh=' + p_IdShopping + '&lj=' + p_IdLoja;
