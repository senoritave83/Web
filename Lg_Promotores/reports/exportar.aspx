    ...
    <div class='ExportArea'>
        <table class="AreaSubTitulo" id='Table1' border="0" width="100%">
            <tr class='trField'>
	            ...
	            <td>
                    ...
                    <asp:UpdateProgress ID="updProgBotoes" runat="Server" DisplayAfter="0" AssociatedUpdatePanelID="updBotoes">
                        <ProgressTemplate>
        ...
        <asp:UpdatePanel runat="Server" ID="updrptPrecos">
            <ContentTemplate>
		                        ...
		                        <table>
			                        <tr>
				                        <td valign="top">
					                        ...
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="Fantasia" DataValueField="IdCliente" runat="Server" ID="lstClientes"></asp:ListBox>				                        
					                        <asp:Button runat="Server" ID="btnVisLojas" Text="Listar Lojas" />
				                        </td>
				                    </tr>
			                        <tr>
				                        <td valign="top">
				                            Loja<br />
				                            <asp:ListBox SelectionMode="Multiple" DataTextField="Loja" DataValueField="IdLoja" runat="Server" ID="lstLojas"></asp:ListBox>
				                        </td>
                                    </tr>
                                    <tr>
				                        <td valign="top">
	                                        Shopping:<br />
	                                        <asp:ListBox SelectionMode="Multiple" DataTextField="Shopping" DataValueField="IdShopping" runat="Server" ID="lstShopping"></asp:ListBox>
				                        </td>
				                    </tr>
				                </table>
                            </div>
                                ...
                                <table>
                                    <tr>
				                        <td valign="top">
					                        ...
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="Coordenador" DataValueField="IdCoordenador" runat="Server" ID="lstCoordenador"></asp:ListBox>
					                        <asp:Button runat="Server" ID="btnLideres" Text="Listar L&iacute;deres" />
				                        </td>
			                        </tr>
			                        <tr>
				                        <td valign="top">
					                        <asp:Literal ID="ltrLider" runat="server" Text='<%$Settings: caption, Promotor.FiltroLider, "Lider" %>' />:<br />
                                            <asp:ListBox SelectionMode="Multiple" DataTextField="Lider" DataValueField="IdLider" runat="Server" ID="lstLider"></asp:ListBox>
					                        <asp:Button runat="Server" ID="btnPromotores" Text="Listar Promotores" />
				                        </td>
			                        </tr>
                                    <tr>
				                        <td valign="top">
					                        Promotor:<br />
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="Promotor" DataValueField="IdPromotor" runat="Server" ID="lstPromotor"></asp:ListBox>
				                        </td>
			                        </tr>
		                        </table>
                            </div>
                            <div id='divProdutos'>
                                <table id='tblProdutos'>
                                    <tr>
				                        <td valign="top">
					                        Segmento:<br />
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="Categoria" DataValueField="IdCategoria" runat="Server" ID="lstCategoria"></asp:ListBox>
					                        <asp:Button runat="Server" ID="btnVisSubCat" Text="Listar Categorias" />
				                        </td>
                                    </tr>                                
                                    <tr>
				                        <td valign="top">
					                        Categoria:<br />
                                            <asp:ListBox SelectionMode="Multiple" DataTextField="SubCategoria" DataValueField="IdSubCategoria" runat="Server" ID="lstSubCategoria"></asp:ListBox>
					                        <asp:Button runat="Server" ID="btnVisProd" Text="Listar Produtos" />
				                        </td>
                                    </tr>
                                    <tr>
				                        <td valign="top">
					                        Produto:<br />
					                        <asp:ListBox SelectionMode="Multiple" DataTextField="DescricaoResumida" DataValueField="IdProduto" runat="Server" ID="lstProduto"></asp:ListBox>
				                        </td>
                                    </tr>
                                </table>                             
                            </div>
                ...
                <asp:UpdatePanel runat="Server" ID="updPainelBaixo">
                <ContentTemplate>
                            <table class="tblExportFilterArea" border="0">
                                    ...
                                    <td style="width: 100%">
                                        <table id='tblRegioes' border="0">
                                            <tr>
	                                            <td valign="top" style="width: 35%">
                                                 ...
                                                 <td rowspan = "4" valign="top" style="width: 30%">
				                                    ...
				                                    <asp:ListBox SelectionMode="Multiple" DataTextField="CamposExportar" DataValueField="IdCamposExportar" height="350" width="100%" runat="Server" ID="lstCampExp"></asp:ListBox>
                                                 </td>
                                            ...
                                            <tr>
                                                <td valign="top" style="width: 35%">
                                                    Per&iacute;odo:<br />
										            De&nbsp;<asp:TextBox runat="Server" MaxLength="10" CssClass="form_text" id="txtDataInicial" name="txtDataInicial" onkeydown="FormataData(this, event);" onblur="VerificaData(this);"></asp:TextBox>
                                                    ...
                                                    <font class="content_text">&nbsp;até&nbsp;</font><asp:TextBox runat="Server" MaxLength="10" CssClass="form_text" id="txtDataFinal" name="txtDataFinal" onkeydown="FormataData(this, event);" onblur="VerificaData(this);"></asp:TextBox>
                                                    <cc1:CalendarExtender 
                                                        ID="cal_txtDataFinal" 
										                runat="server" 
                             ...
                             <asp:UpdatePanel runat="Server" ID="updBotoes">
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="btnBuildReport" EventName="Click" />
                                        <asp:AsyncPostBackTrigger ControlID="txtDataInicial" EventName="TextChanged" />
                                    </Triggers>
                             </asp:UpdatePanel>
                        </ContentTemplate>
                    </asp:UpdatePanel>
        ...
        function XM_RadioButtonValue_Estados() { 
			    ...
			    function Export() {
                    ...
                    var p_IdCoordenador = XM_GetValues(document.getElementById('<%=lstCoordenador.ClientID%>'));
                    var p_IdLider = XM_GetValues(document.getElementById('<%=lstLider.ClientID%>'));
                    var p_IdPromotor = XM_GetValues(document.getElementById('<%=lstPromotor.ClientID%>'));
