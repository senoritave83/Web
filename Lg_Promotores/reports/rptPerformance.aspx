<%@ Page Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="rptPerformance.aspx.vb" Inherits="reports_rptPerformance" title="XM Promotores - Yes Mobile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function XM_RadioButtonValue_TipoPesquisa() { 
			    var m_Value = '';
			    if(document.aspnetForm.rdTodas.checked==true) 
			        m_Value='0';
			    else 
			        m_Value='1';
			    return m_Value;
        ...
        function showReport(){
				    ...
				    var p_TipoPes       = XM_RadioButtonValue_TipoPesquisa();
                    ...
                    var URL = 'rptperformancedet.aspx?cli=' + p_IdCliente + '&loj=' + p_IdLoja + '&pro=' + p_IdPromotor + 
														    '&crd=' + p_IdCoordenador + '&lid=' + p_IdLider + 
														    '&per=' + p_Periodo + '&pertxt=' + p_PeriodoText +
														    '&tiploj=' + p_TipoLoja + '&regiao=' + p_Regiao + 
														    '&tippes=' + p_TipoPes + '&sta=' + p_Status + 
														    '&est=' + p_Estado + '&shop=' + p_IdShopping
														    
                    //alert(URL);
														    
				    var win = window.open(URL, 'RPTPERFORMANCE', 'resizable = yes, location = no, toolbar = yes, scrollbars = yes, width=850, height=650');
                            ...
                            <table id='tblRegioes' cellspacing="2" cellpadding="2" border="0" width="100%">
                                ...
                                <tr>
                                    <td width="25%" valign="top">
                                        Status da Loja:<br />
                                        <input checked="true" type="radio" id="rdAtivo0" name="rdAtivo" value="2" />Todas<br /><input type="radio" id="rdAtivo1" name="rdAtivo" value="0" />Inativo<br /><input id="rdAtivo2" type="radio" name="rdAtivo" value="1" />Ativo
                                    </td>
                                    <td width="25%" valign="top">
                                        Tipo de Pesquisa:<br />
										<input checked="true" type="radio" id="rdTodas" name="rdTipoPesquisa" value="0" />Todas<br /><input type="radio" id="rdColeta" name="rdTipoPesquisa" value="1" />Somente com Coleta
                                    </td>
