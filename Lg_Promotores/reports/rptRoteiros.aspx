<%@ Page Title="" Language="VB" MasterPageFile="~/XMPromotores.master" AutoEventWireup="false" CodeFile="rptRoteiros.aspx.vb" Inherits="reports_rptRoteiros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        ...
        function showReport() {
            ...
            var URL = 'rptRoteirosDet.aspx?cli=' + p_IdCliente + '&loj=' + p_IdLoja + '&pro=' + p_IdPromotor +
