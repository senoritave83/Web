...
Partial Class reports_rptLojasPromotoresDet
    Inherits XMWebPage
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Try
                ...
                Response.AddHeader("Content-Disposition", "inline; filename=RELATORIO_ROTEIROS_" & Now.ToString("ddMMyyyyhhmmss") & ".xls")
    ...
    Private Sub OpenReport()
        ...
        rpt = New clsReports()
        Dim ds As DataSet = rpt.getRelatorioRoteiros(Me.User.IDEmpresa, _
                                                ...
                                                ViewState("stap"), ViewState("est"), ViewState("pi"), ViewState("pn"), ViewState("seg"))

        With xmCrossRptRoteiros
            .ColDataSource = ds.Tables(0).Rows
            .RowDataSource = ds.Tables(1).Rows
            .DataSource = ds.Tables(2).Rows
            .DataKeyNames = "IDLoja,IdPromotor,Data"
            .RowKeyNames = "IDLoja,IdPromotor"
            .ColKeyNames = "Data"
            .DataBind()
        End With
