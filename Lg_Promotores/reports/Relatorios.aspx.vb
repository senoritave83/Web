    ...
    Partial Public Class Relatorios
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, cboIDUsuario, cboAtivo, txtDataInicial, txtDataFinal)
                BindGrid()
            End If			
        End Sub

        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDUsuario.SelectedValue, cboAtivo.SelectedValue, txtDataInicial.Text, txtDataFinal.Text, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, cboIDUsuario, cboAtivo, txtDataInicial, txtDataFinal)
		End Sub
