<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Vendedores.aspx.vb" Inherits="Pages.Cadastros.Vendedores" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDVendedor" DataNavigateUrlFormatString="Vendedor.aspx?IDVendedor={0}" DataTextField="IDVendedor" HeaderText="C&oacute;digo" SortExpression="IDVendedor"  />
						<asp:HyperLinkField DataNavigateUrlFields="IDVendedor" DataNavigateUrlFormatString="Vendedor.aspx?IDVendedor={0}" DataTextField="Vendedor" HeaderText="Vendedor" SortExpression="Vendedor"  />
						<asp:BoundField DataField='IDNivel' HeaderText='N&iacute;vel' SortExpression='IDNivel' />
					...
					<EmptyDataTemplate>
					    ...
					    <div class='divEmptyRow'>
							<asp:Label runat='server' ID='lblNaoEncontrados'>
								N&atilde;o h&aacute; Vendedores com o filtro selecionado!
							</asp:Label>
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
