...
Partial Class Relatorios_justificado_det
    Inherits XMWebPage
    ...
    Private Sub showData(ByVal vIdEmpresa As Integer, ByVal vIdGerente As Integer, ByVal vIdSupervisor As Integer, ByVal vIdVendedor As Integer, ByVal vDataInicial As String, ByVal vDataFinal As String)
        ...
        Dim dt As Data.DataSet = rep.GetRelatorioJustificativa(vIdEmpresa, vIdGerente, vIdSupervisor, vIdVendedor, vDataInicial, vDataFinal)
        ...
        XMCrossRepeater1.DataKeyNames = "IDVendedor,IDJustificativa"
        XMCrossRepeater1.RowKeyNames = "IDVendedor"
        XMCrossRepeater1.ColKeyNames = "IDJustificativa"
