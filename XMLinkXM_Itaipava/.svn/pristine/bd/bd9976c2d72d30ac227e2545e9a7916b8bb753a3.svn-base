<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Bloqueio.aspx.vb" Inherits="Pages.Cadastros.Bloqueio"  %>
		...
		<div class='divEditArea'>
			...
			<div class='trField cb' runat='server'  id='trBloqueio' visible='<%$Settings: visible, Bloqueio.Bloqueio, true %>' >
				...
				<div class='tdField fl'>
					<asp:TextBox runat='server' ID='txtBloqueio' MaxLength='30' ReadOnly='<%$Settings: ReadOnly, Bloqueio.Bloqueio, false %>' />
