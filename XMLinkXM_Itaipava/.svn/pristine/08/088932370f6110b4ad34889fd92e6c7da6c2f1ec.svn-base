<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="EvolucaoPesquisas.aspx.vb" Inherits="Pesquisas_EvolucaoPesquisas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <uc1:Filtro ID="Filtro1" runat="server" PermitirTodasPesquisas="false" PermitirTodasEmpresas="false" ShowPesquisas="2" ModoExibicaoGrafico="true" ShowGerenteVendas="true" ShowSupervisor="true" ShowVendedor="true"
            ShowFiltro="false" FiltroSize="300" ShowDataInicial="false" ShowDataFinal="false" StatusClass='FiltroItem'  DataInicialClass='FiltroItem' />
	<div class='ListArea'>
