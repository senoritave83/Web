...
Partial Class Enquetes_SegmentacaoPDV
    Inherits XMWebPage
    ...
    Private Sub BindGrid(ByVal vIdEmpresa As Integer, ByVal vIdGerente As Integer, ByVal vIdSupervisor As Integer, ByVal vIdVendedor As Integer, ByVal vDataInicio As String, ByVal vDataFinal As String)
        ...
        Dim ds As System.Data.DataSet = rep.GetRelatorio_SegmentacaoPDV(vIdEmpresa, vIdGerente, vIdSupervisor, vIdVendedor, vDataInicio, vDataFinal)

        Try

            With grdSegmentacaoPDV
