...
{
    var wh = window.open("http://www.xmwap.com.br/xmlinkwm/mapa.aspx?lat=" + Lat + "&lon=" + Lon + "&Title=" + Title + "&Description=" + Description, "mapa", "width=600, height=500, toolbars=no, resizable=no");
    /*try {
        wh.focus();
    }
    catch (err) {
