<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Categorias.aspx.vb" Inherits="Pages.Cadastros.Categorias" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDCategoria" DataNavigateUrlFormatString="Categoria.aspx?IDCategoria={0}" DataTextField="Categoria" HeaderText="Categoria" SortExpression="Categoria"  />
					</columns>
					<EmptyDataTemplate>
