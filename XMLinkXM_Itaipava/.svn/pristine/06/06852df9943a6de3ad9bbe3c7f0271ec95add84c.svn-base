		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDCliente" DataNavigateUrlFormatString="Cliente.aspx?IDCliente={0}" DataTextField="Cliente" HeaderText="Cliente" SortExpression="Cliente"  />
						...
						<asp:BoundField HeaderText="Pasta" DataField="IDPasta" SortExpression="Pasta" />
						<asp:BoundField HeaderText="Bloqueio" DataField="Bloqueio" SortExpression="Bloqueio" />
					</columns>
					<EmptyDataTemplate>
