...
Namespace Pages.Cadastros
    ...
    Partial Public Class TipoVendedores
        Inherits XMWebPage

        Protected Const Secao As String = "Cadastro de Tipos de Vendedor"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, txtFusoInteger)
                BindGrid()
            End If
        End Sub

        Public Sub BindGrid()
            If String.IsNullOrEmpty(txtFusoInteger.Text) Then
                txtFusoInteger.Text = "0"
            End If

            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, txtFusoInteger.Text, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, txtFusoInteger)
        End Sub
