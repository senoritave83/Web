...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class='EditArea'>
		<div class='divEditArea'>
			...
			<div class='trField fr' runat='server' style="width:40%"  id='divRegional'  >
				<div class='tdFieldHeader fl'>
					Regional:
				</div>
				<div class='tdField fl'>
					<asp:DropDownList runat='server' ID='cboRegional' DataTextField='Regional' DataValueField='IDRegional'></asp:DropDownList>
				</div>
			</div>
