<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Bloqueios.aspx.vb" Inherits="Pages.Cadastros.Bloqueios"  %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDBloqueio" DataNavigateUrlFormatString="Bloqueio.aspx?IDBloqueio={0}" DataTextField="Bloqueio" HeaderText="Bloqueio" SortExpression="Bloqueio"  />
						<asp:TemplateField HeaderText='Permite pedido'>
						    <ItemTemplate>
						        <%# IIf(Eval("PermitePedido"), "Sim", "N&atilde;o") %>
						    </ItemTemplate>
						</asp:TemplateField>
					</columns>
					<EmptyDataTemplate>
