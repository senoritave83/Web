...
Namespace Pages.Cadastros
    ...
    Partial Public Class Permissao
        ...
        Protected Const SECAO As String = "Cadastro de Permissão"
        ...
        Protected Sub BindSelectedUsers()
            ...
            Else
                ...
                grdUsersInRole.DataSource = usu.ListarUsuariosPermissao(cls.IDPermissao)
        ...
        Protected Sub grdUsersInRole_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdUsersInRole.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                Try
                    CType(e.Row.FindControl("chk"), CheckBox).Checked = Roles.IsUserInRole(grdUsersInRole.DataKeys(e.Row.DataItemIndex).Value, cls.Permissao)
        ...
        Protected Sub BindUsers(ByVal vFiltro As String, ByVal vTipo As String)
            ...
            Else
                Dim usu As New clsUsuario
                If vFiltro = "" Then
                    grdUsersInRole.DataSource = usu.Listar("", DataClass.enReturnType.DataReader)
                Else
                    grdUsersInRole.DataSource = usu.Listar(vFiltro, DataClass.enReturnType.DataReader)
                End If
                grdUsersInRole.DataBind()
            End If
        End Sub
