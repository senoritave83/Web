    ...
    Partial Public Class Pesquisas
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, txtDataInicio, txtDataFim)
                BindGrid()
            End If			
        End Sub
        ...
        Public Sub BindGrid()
            ...
            Dim strDataFim As String = "01/" & txtDataFim.Text
            If IsDate(strDataFim) Then strDataFim = CDate(txtDataFim.Text).AddMonths(1).AddSeconds(-1)

            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, txtDataInicio.Text, strDataFim, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, txtDataInicio, txtDataFim)
        End Sub
