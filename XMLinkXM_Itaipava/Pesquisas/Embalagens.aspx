<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Embalagens.aspx.vb" Inherits="Pages.Pesquisas.Embalagemes" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDEmbalagem" DataNavigateUrlFormatString="Embalagem.aspx?IDEmbalagem={0}" DataTextField="Codigo" HeaderText="Código" SortExpression="Codigo"  />
                        <asp:BoundField DataField="Embalagem" HeaderText="Embalagem" SortExpression="Embalagem"  />
					</columns>
					<EmptyDataTemplate>
				        <div class='GridHeader'>&nbsp;</div>					    
					    <div class='divEmptyRow'>
							<asp:Label runat='server' ID='lblNaoEncontrados'>
								N&atilde;o h&aacute; Embalagens com o filtro selecionado!
							</asp:Label>
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
