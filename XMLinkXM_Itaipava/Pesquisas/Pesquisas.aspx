<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Pesquisas.aspx.vb" Inherits="Pages.Pesquisas.Pesquisas" title="Untitled Page" %>
	...
	<asp:UpdatePanel ID="updFiltro" runat="server">
	    <ContentTemplate>
			<div class='Filtro'>
		        ...
		        <div class='FiltroItem'>Data Inicio<br>
						<asp:TextBox runat='server' ID='txtDataInicio' MaxLength="7" />
		        </div>
		        <div class='FiltroItem'>Data Fim<br>
						<asp:TextBox runat='server' ID='txtDataFim' MaxLength="7" />
		        </div>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDPesquisa" DataNavigateUrlFormatString="Pesquisa.aspx?IDPesquisa={0}" DataTextField="Pesquisa" HeaderText="Pesquisa" SortExpression="Pesquisa"  />
						<asp:BoundField HeaderText="Data Inicio" DataField="DataInicio" SortExpression="DataInicio" DataFormatString="{0:MM/yyyy}" />
						<asp:BoundField HeaderText="Data Fim" DataField="DataFim" SortExpression="DataFim" DataFormatString="{0:MM/yyyy}" />
					</columns>
					<EmptyDataTemplate>
