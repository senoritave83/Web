...
<div class="container-default">
    <asp:Repeater runat='server' ID='rptItens' DataSourceID='SiteMapDataSource1'>
        <ItemTemplate>
            <div id="Div1" style="width:40%;float:left; padding-left:70px; padding-top:30px;" runat='server' visible='<%# VerificaPermissao(Container.DataItem.Item("Secao"), "Visualizar") %>' >
                <table>
                    <tr>
						<td valign=top><A href="<%#Eval("url") %>"><img id="Img1" src='<%#Container.DataItem.item("imgCZ") %>' width='48' runat='server' border='0' /></A>
						</td>
						<td valign=top>
