...
Namespace Pages.Pedidos
    ...
    Partial Public Class Pedidos
        ...
        Protected Sub btnConfirmar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfirmar.Click
            Dim idPedidos As String = String.Empty
            For i As Integer = 0 To GridView1.Rows.Count - 1
                Dim hdn As HiddenField = DirectCast(GridView1.Rows(i).FindControl("hdnIdPedido"), HiddenField)
                idPedidos += String.Format("{0}{1}", hdn.Value, IIf(i = GridView1.Rows.Count - 1, String.Empty, ","))
            Next

            Dim ret As clsPedido.stTotalAprovados = cls.AprovarTodosPendentes(txtMotivo.Text, idPedidos)
