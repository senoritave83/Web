<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="recados.aspx.vb" Inherits="home_recados" title="Untitled Page" %>
	        ...
	        <asp:UpdatePanel runat='server' ID='updEnvio'>
	            <ContentTemplate>
	                ...
	                <div id='divNovoRecado'>
                        <div id='divRegionais' runat='server' class='Destinatario' style='width:50%'>
                            Selecione a(s) Regionais(s) <a href="javascript:selAll('<% = cboRegional.clientId %>');">Selecionar todos</a>
                            <br />
			                <asp:ListBox CssClass=formulario id="cboRegional" Rows='6' DataTextField='Regional' DataValueField="IdRegional" runat="server" AutoPostBack="False" SelectionMode='Multiple' Width="95%" />
			                <asp:Button runat='server' ID='btnCarregaRevendas' Text="Carrega Revendas" />
                        </div>
                        <div class='Destinatario'  style='width:50%;'>
                            <div style='width:100%;height:100%;'>
                            <span style="font-weight:bold">Nível</span>
                            <br />
			                <asp:CheckBoxList RepeatDirection="Vertical" RepeatColumns="1" ForeColor='#898989' CssClass='formulario' id="chkTipo" DataTextField='Tipo' DataValueField="IdTipo" runat="server" AutoPostBack="False" Width="95%"></asp:CheckBoxList>
			                </div>
			                <asp:Button runat='server' ID='btnCarregaDestinatarios' ValidationGroup="RevendaRegional" Text="Carrega Destinatários" style="width:180px;" /><br class='cb' />
                        </div>
                        
                        <div id='divRevendas' runat='server' class='Destinatario' style='width:50%'>
                            Selecione a(s) Revendas(s)<a href="javascript:selAll('<% = cboRevendas.clientId %>');">Selecionar todos</a>
			                <asp:ListBox CssClass=formulario id="cboRevendas" Rows='6' DataTextField='Revenda' DataValueField="IdEmpresa" runat="server" AutoPostBack="False" SelectionMode='Multiple' Width="95%" />
                        </div>
                        <div class='Destinatario'  style='width:50%'>
