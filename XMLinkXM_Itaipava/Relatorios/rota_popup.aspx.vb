...
Partial Class Relatorios_rota_popup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            Dim ds As System.Data.DataSet = rep.GetRelatorioRotaVendedor(CInt(Request("IDEmpresa")), CInt(Request("IDVendedor")), CInt(Request("IDCliente")), Request("Data"))
