<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="MensagensDiarias.aspx.vb" Inherits="Pages.Cadastros.MensagensDiarias" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDMensagemDiaria" DataNavigateUrlFormatString="MensagemDiaria.aspx?IDMensagemDiaria={0}" DataTextField="Mensagem" HeaderText="Mensagem" SortExpression="Mensagem"  />
					</columns>
					<EmptyDataTemplate>
