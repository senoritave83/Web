<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Usuarios.aspx.vb" Inherits="Pages.Cadastros.Usuarios" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDUsuario" DataNavigateUrlFormatString="Usuario.aspx?IDUsuario={0}" DataTextField="Usuario" HeaderText="Usuario" SortExpression="Usuario"  />
    ...
    <div class='AreaBotoes'>
        ...
        <input type="button" class="Botao" value=" Voltar " onclick="location.href='../sistema/default.aspx'" />
    </div>
    <div class='AreaAjuda'>
