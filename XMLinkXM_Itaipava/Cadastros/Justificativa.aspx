...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class='EditArea'>
		<div class='divEditArea'>
			...
			<div class='trField cb' runat='server'  id='Div1' visible='<%$Settings: visible, Justificativa.Justificativa, true %>' >
				<div class='tdFieldHeader cb fl'>
					N&iacute;veis:
				</div>
				<div class='tdField fl'>
					<asp:CheckBoxList runat="server" ID="chklNiveisJust" DataValueField="IDNivel" DataTextField="Nivel" />
				</div>
			</div>
