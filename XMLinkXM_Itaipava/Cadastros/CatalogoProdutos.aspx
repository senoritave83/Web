<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="CatalogoProdutos.aspx.vb" Inherits="Pages.Cadastros.CatalogoProdutos" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDProduto" DataNavigateUrlFormatString="CatalogoProduto.aspx?IDProduto={0}" DataTextField="IDProduto" HeaderText="Código Produto" SortExpression="IDProduto"  />
