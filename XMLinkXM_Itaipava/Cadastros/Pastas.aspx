<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Pastas.aspx.vb" Inherits="Pages.Cadastros.Pastas" title="Untitled Page" %>
	...
	<asp:UpdatePanel ID="updFiltro" runat="server">
	    <ContentTemplate>
			<div class='Filtro'>
		        ...
		        <br class='cb' />
		        <div class='FiltroItem' style="width:50%">Dias<br>
		                <asp:CheckBoxList runat='server' ID='chkDias' RepeatDirection='Horizontal'>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDPasta" DataNavigateUrlFormatString="Pasta.aspx?IDPasta={0}" DataTextField="Descricao" HeaderText="Descricao" SortExpression="Descricao"  />
					...
					<EmptyDataTemplate>
					    ...
					    <div class='divEmptyRow'>
							<asp:Label runat='server' ID='lblNaoEncontrados'>
								N&atilde;o h&aacute; Pastas com o filtro selecionado!
							</asp:Label>
					    </div>
					</EmptyDataTemplate>
				</asp:GridView>
