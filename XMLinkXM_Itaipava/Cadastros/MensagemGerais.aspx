<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="MensagemGerais.aspx.vb" Inherits="Pages.Cadastros.MensagemGerais" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
						<asp:HyperLinkField DataNavigateUrlFields="IDMensagemGeral" DataNavigateUrlFormatString="MensagemGeral.aspx?IDMensagemGeral={0}" DataTextField="Titulo" HeaderText="Titulo" SortExpression="Titulo"  />
					</columns>
					<EmptyDataTemplate>
