<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Produtos.aspx.vb" Inherits="Pages.Cadastros.Produtos" title="Untitled Page" %>
		...
		<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
				<asp:GridView runat='server' id='GridView1' AutoGenerateColumns='false' AllowSorting='true'>
					...
					<columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IDProduto" DataNavigateUrlFormatString="Produto.aspx?IDProduto={0}" DataTextField="IdProduto" HeaderText="Codigo" SortExpression="IdProduto"  />
						<asp:HyperLinkField DataNavigateUrlFields="IDProduto" DataNavigateUrlFormatString="Produto.aspx?IDProduto={0}" DataTextField="Descricao" HeaderText="Descricao" SortExpression="Descricao"  />
						<asp:BoundField HeaderText="Categoria" DataField="Categoria" SortExpression="Categoria" />
						<asp:BoundField HeaderText="Linha" DataField="Linha" SortExpression="Linha" />
					</columns>
					<EmptyDataTemplate>
