    ...
    Partial Public Class Produtos
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                ...
                Me.RecuperaFiltro(txtFiltro, Paginate1, Letras1, cboIDCategoria, cboIDLinha)
                BindGrid()
            End If			
        End Sub

        Public Sub BindGrid()
            Dim ret As IPaginaResult = cls.Listar(Paginate1.Filtro, cboIDCategoria.SelectedValue, cboIDLinha.SelectedValue, Paginate1.SortExpression, Paginate1.SortDirection, Paginate1.CurrentPage, Profile.Settings.PAGESIZE)
            ...
            Me.GravaFiltro(txtFiltro, Letras1, Paginate1, cboIDCategoria, cboIDLinha)
		End Sub
